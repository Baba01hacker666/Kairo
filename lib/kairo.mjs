...
import { ACESFilmicToneMapping as Pr, AdditiveBlending as ps, AgXToneMapping as kr, BufferGeometry as Er, CineonToneMapping as zr, Color as he, ColorManagement as Vr, CustomToneMapping as Dr, DepthTexture as Rr, DoubleSide as Bi, Float32BufferAttribute as Pi, HalfFloatType as se, LinearToneMapping as Fr, Matrix4 as Ir, Mesh as Nr, MeshBasicMaterial as Or, MeshDepthMaterial as Ur, MeshNormalMaterial as Lr, NearestFilter as pt, NeutralToneMapping as Wr, NoBlending as Dt, OrthographicCamera as Gr, RGBADepthPacking as $r, RawShaderMaterial as Kr, ReinhardToneMapping as Hr, SRGBTransfer as jr, ShaderMaterial as Z, Timer as qr, UniformsUtils as Fe, Vector2 as U, Vector3 as Te, Vector4 as Xr, WebGLRenderTarget as Q } from "three";
...
var ft = class Rt {
  ...
  multiplyMatrices(t, i) {
    const s = t.elements, r = i.elements, n = this.elements, a = s[0], o = s[4], l = s[8], c = s[12], h = s[1], d = s[5], u = s[9], y = s[13], p = s[2], g = s[6], m = s[10], v = s[14], _ = s[3], S = s[7], w = s[11], A = s[15], b = r[0], x = r[4], C = r[8], M = r[12], P = r[1], T = r[5], V = r[9], z = r[13], D = r[2], L = r[6], E = r[10], G = r[14], R = r[3], j = r[7], q = r[11], X = r[15];
    return n[0] = a * b + o * P + l * D + c * R, n[4] = a * x + o * T + l * L + c * j, n[8] = a * C + o * V + l * E + c * q, n[12] = a * M + o * z + l * G + c * X, n[1] = h * b + d * P + u * D + y * R, n[5] = h * x + d * T + u * L + y * j, n[9] = h * C + d * V + u * E + y * q, n[13] = h * M + d * z + u * G + y * X, n[2] = p * b + g * P + m * D + v * R, n[6] = p * x + g * T + m * L + v * j, n[10] = p * C + g * V + m * E + v * q, n[14] = p * M + g * z + m * G + v * X, n[3] = _ * b + S * P + w * D + A * R, n[7] = _ * x + S * T + w * L + A * j, n[11] = _ * C + S * V + w * E + A * q, n[15] = _ * M + S * z + w * G + A * X, this;
  }
  multiply(t) {
  ...
  intersectSphere(t, i) {
    ...
    let p = h - y, g = h + y;
    if (p < 0 && (p = g), p < 0) return Qe._missResult;
  ...
  loop = (e) => {
    if (this.state === ye.Running) {
      for (Pe.update(e), this.fixedUpdateAccumulator += Pe.deltaTime; this.fixedUpdateAccumulator >= Pe.fixedDeltaTime; )
        this.fixedUpdate(Pe.fixedDeltaTime), this.fixedUpdateAccumulator -= Pe.fixedDeltaTime;
      this.update(Pe.deltaTime), this.render(), typeof requestAnimationFrame < "u" && (this.animationFrameId = requestAnimationFrame(this.loop));
    }
  };
  fixedUpdate(e) {
  ...
  update(t, i = 60) {
    ...
    for (let b = 0; b < s; b++) {
      ...
      const P = x * y | 0, T = C * y | 0, V = M * y | 0, z = (P * 73856093 ^ T * 19349663 ^ V * 83492791) & p;
    ...
    for (let b = 0; b < s; b++) {
      if (d[b] === 0) continue;
      const x = r[b], C = n[b], M = a[b], P = h[b], T = x * y | 0, V = C * y | 0, z = M * y | 0;
      for (let D = 0; D < 14; D++) {
        ...
        for (; E !== -1; ) {
          if ((!G || E > b) && d[E] !== 0) {
            ...
            if (Be < R * R && Be > 1e-4) {
              _++;
              const we = Math.sqrt(Be), me = j / we, te = q / we, ie = X / we, re = 0.5 * (R - we);
              r[b] -= me * re, n[b] -= te * re, a[b] -= ie * re, r[E] += me * re, n[E] += te * re, a[E] += ie * re;
              const Se = o[b] - o[E], ut = l[b] - l[E], dt = c[b] - c[E], le = me * Se + te * ut + ie * dt;
...
${s}
  ...
  constructor() {
    super(), this.setAttribute("position", new Pi([
      -1,
      3,
      0,
      -1,
  ...
  constructor(e, t = "tDiffuse") {
    super(), this.textureID = t, this.uniforms = null, this.material = null, e instanceof Z ? (this.uniforms = e.uniforms, this.material = e) : e && (this.uniforms = Fe.clone(e.uniforms), this.material = new Z({
  ...
  constructor(e, t) {
    ...
    this.renderTarget1 = t, this.renderTarget2 = t.clone(), this.renderTarget2.texture.name = "EffectComposer.rt2", this.writeBuffer = this.renderTarget1, this.readBuffer = this.renderTarget2, this.renderToScreen = !0, this.passes = [], this.copyPass = new ln(st), this.copyPass.material.blending = Dt, this.timer = new qr();
  }
  swapBuffers() {
  ...
  constructor(t, i = 1, s, r) {
    ...
    const o = dn;
    this.highPassUniforms = Fe.clone(o.uniforms), this.highPassUniforms.luminosityThreshold.value = r, this.highPassUniforms.smoothWidth.value = 0.01, this.materialHighPassFilter = new Z({
    ...
    this.compositeMaterial.uniforms.bloomFactors.value = c, this.bloomTintColors = [
      ...
      new Te(1, 1, 1),
      new Te(1, 1, 1)
    ], this.compositeMaterial.uniforms.bloomTintColors.value = this.bloomTintColors, this.copyUniforms = Fe.clone(st.uniforms), this.blendMaterial = new Z({
...
var ai = class et extends pe {
  constructor(t, i, s, r) {
    ...
    const c = st;
    this.copyUniforms = Fe.clone(c.uniforms), this.materialCopy = new Z({
      uniforms: this.copyUniforms,
...
var pn = {
  ...
  constructor(e = 0.5, t = !1) {
    super();
    const i = pn;
    this.uniforms = Fe.clone(i.uniforms), this.material = new Z({
      name: i.name,
      uniforms: this.uniforms,
  ...
  constructor(e, t, i, s = {}) {
    super(), this.pixelSize = e, this.scene = t, this.camera = i, this.normalEdgeStrength = s.normalEdgeStrength || 0.3, this.depthEdgeStrength = s.depthEdgeStrength || 0.4, this.pixelatedMaterial = this._createPixelatedMaterial(), this._resolution = new U(), this._renderResolution = new U(), this._normalMaterial = new Lr(), this._beautyRenderTarget = new Q(), this._beautyRenderTarget.texture.minFilter = pt, this._beautyRenderTarget.texture.magFilter = pt, this._beautyRenderTarget.texture.type = se, this._beautyRenderTarget.depthTexture = new Rr(), this._normalRenderTarget = new Q(), this._normalRenderTarget.texture.minFilter = pt, this._normalRenderTarget.texture.magFilter = pt, this._normalRenderTarget.texture.type = se, this._fsQuad = new Ue(this.pixelatedMaterial);
  }
  dispose() {
  ...
  constructor() {
    super(), this.isOutputPass = !0, this.uniforms = Fe.clone(mt.uniforms), this.material = new Kr({
      name: mt.name,
      uniforms: this.uniforms,
...
function Cc(e = {}) {
  const t = e.count ?? 2e3, i = e.area ?? 40, [s, r] = e.height ?? [0.5, 1.2], n = e.width ?? 0.12, a = e.seed ?? 1, o = e.position ?? [
    ...
    0,
    0
  ], l = e.heightAt ?? null, c = new ht(a), h = new f.PlaneGeometry(n, 1, 1, 1);
  h.translate(0, 0.5, 0);
...
function Ac(e = {}) {
  const t = e.position ?? [
    ...
    0,
    0
  ], i = e.scale ?? 1, s = (e.trunkHeight ?? 2.2) * i, r = (e.trunkRadius ?? 0.25) * i, n = (e.canopyRadius ?? 1.5) * i, a = new ht(e.seed ?? Math.floor(Math.random() * 99999)), o = new f.Group();
  o.position.set(...t);
...
function _c(e = {}) {
  const t = e.position ?? [
    ...
    0,
    0
  ], i = e.scale ?? 1, s = (e.radius ?? 0.6) * i, r = new ht(e.seed ?? Math.floor(Math.random() * 99999)), n = new f.DodecahedronGeometry(s, 1), a = n.attributes.position;
...
var Pc = /* @__PURE__ */ (function(e) {
  ...
  static compileGame(e, t = {}) {
    ...
    e.forEach((h) => {
      ...
      const p = JSON.stringify(h), g = Ie.createSaveEnvelope(JSON.parse(p)), m = JSON.stringify(g), v = i.compressBinaryLevels ? Ie.compressToBase64(m) : m, _ = new TextEncoder().encode(v).length;
      n += _, a.push({
        id: h.id,
        name: h.name,
        world: h.world,
...
typeof process < "u" && process.env.NODE_ENV !== "production" && (Le = (e, t, i) => {
  !e && typeof console < "u" && console.warn(Ot(t, i));
}, de = (e, t, i) => {
  if (!e) throw new Error(Ot(t, i));
});
var xe = {}, bs = (e) => /^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(e), Nn = (e) => typeof e == "object" && e !== null, xs = (e) => /^0[^.\s]+$/u.test(e);
// @__NO_SIDE_EFFECTS__
function ws(e) {
  let t;
  return () => (t === void 0 && (t = e()), t);
}
var We = /* @__NO_SIDE_EFFECTS__ */ (e) => e, li = (...e) => e.reduce((t, i) => (s) => i(t(s))), ci = /* @__NO_SIDE_EFFECTS__ */ (e, t, i) => {
  const s = t - e;
  return s ? (i - e) / s : 1;
}, Ss = class {
  constructor() {
...
var On = (e, t, i) => {
  const s = t - e;
  return ((i - e) % s + s) % s + e;
}, Cs = (e, t, i) => (((1 - 3 * i + 3 * t) * e + (3 * i - 6 * t)) * e + 3 * t) * e, Un = 1e-7, Ln = 12;
function Wn(e, t, i, s, r) {
  let n, a, o = 0;
  do
    a = t + (i - t) / 2, n = Cs(a, s, r) - e, n > 0 ? i = a : t = a;
  while (Math.abs(n) > Un && ++o < Ln);
  return a;
}
// @__NO_SIDE_EFFECTS__
function lt(e, t, i, s) {
...
var As = /* @__NO_SIDE_EFFECTS__ */ (e) => (t) => t <= 0.5 ? e(2 * t) / 2 : (2 - e(2 * (1 - t))) / 2, hi = /* @__NO_SIDE_EFFECTS__ */ (e) => (t) => 1 - e(1 - t), _s = /* @__PURE__ */ lt(0.33, 1.53, 0.69, 0.99), ui = /* @__PURE__ */ hi(_s), Bs = /* @__PURE__ */ As(ui), Ps = (e) => e >= 1 ? 1 : (e *= 2) < 1 ? 0.5 * ui(e) : 0.5 * (2 - Math.pow(2, -10 * (e - 1))), di = (e) => 1 - Math.sin(Math.acos(e)), Gn = hi(di), ks = As(di), $n = /* @__PURE__ */ lt(0.42, 0, 1, 1), Kn = /* @__PURE__ */ lt(0, 0, 0.58, 1), Es = /* @__PURE__ */ lt(0.42, 0, 0.58, 1), zs = /* @__NO_SIDE_EFFECTS__ */ (e) => Array.isArray(e) && typeof e[0] != "number";
// @__NO_SIDE_EFFECTS__
function Vs(e, t) {
...
function Rs(e, t) {
  ...
  const r = {
    ...
    timestamp: 0,
    isProcessing: !1
  }, n = () => i = !0, a = gt.reduce((S, w) => (S[w] = jn(n), S), {}), { setup: o, read: l, resolveKeyframes: c, preUpdate: h, update: d, preRender: u, render: y, postRender: p } = a, g = () => {
    const S = xe.useManualTiming, w = S ? r.timestamp : performance.now();
    i = !1, S || (r.delta = s ? 1e3 / 60 : Math.max(Math.min(w - r.timestamp, qn), 1)), r.timestamp = w, r.isProcessing = !0, o.process(r), l.process(r), c.process(r), h.process(r), d.process(r), u.process(r), y.process(r), p.process(r), r.isProcessing = !1, i && t && (s = !1, e(g));
  }, m = () => {
...
var { schedule: oe, cancel: Ut, state: wt, steps: Ec } = /* @__PURE__ */ Rs(typeof requestAnimationFrame < "u" ? requestAnimationFrame : We, !0), vt;
function Xn() {
  vt = void 0;
}
var J = {
  ...
  set: (e) => {
    vt = e, queueMicrotask(Xn);
  }
}, Fs = (e) => (t) => typeof t == "string" && t.startsWith(e), Is = /* @__PURE__ */ Fs("--"), Yn = /* @__PURE__ */ Fs("var(--"), pi = (e) => Yn(e) ? Qn.test(e.split("/*")[0].trim()) : !1, Qn = /var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu;
function Ui(e) {
...
var Ge = {
  ...
  ...Ge,
  default: 1
}, rt = (e) => Math.round(e * 1e5) / 1e5, fi = /-?(?:\d+(?:\.\d+)?|\.\d+)/gu;
function Zn(e) {
  return e == null;
}
var Jn = /^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu, mi = (e, t) => (i) => !!(typeof i == "string" && Jn.test(i) && i.startsWith(e) || t && !Zn(i) && Object.prototype.hasOwnProperty.call(i, t)), Ns = (e, t, i) => (s) => {
  ...
  transform: ({ red: e, green: t, blue: i, alpha: s = 1 }) => "rgba(" + Bt.transform(e) + ", " + Bt.transform(t) + ", " + Bt.transform(i) + ", " + rt(nt.transform(s)) + ")"
};
function ta(e) {
  let t = "", i = "", s = "", r = "";
...
var Lt = {
  ...
  parse: parseFloat,
  transform: (t) => `${t}${e}`
}), ce = /* @__PURE__ */ ct("deg"), Re = /* @__PURE__ */ ct("%"), B = /* @__PURE__ */ ct("px"), ia = /* @__PURE__ */ ct("vh"), sa = /* @__PURE__ */ ct("vw"), Li = {
  ...Re,
  ...
  transform: ({ hue: e, saturation: t, lightness: i, alpha: s = 1 }) => "hsla(" + Math.round(e) + ", " + Re.transform(rt(t)) + ", " + Re.transform(rt(i)) + ", " + rt(nt.transform(s)) + ")"
}, O = {
  test: (e) => Ce.test(e) || Lt.test(e) || Ve.test(e),
  parse: (e) => Ce.test(e) ? Ce.parse(e) : Ve.test(e) ? Ve.parse(e) : Lt.parse(e),
  transform: (e) => typeof e == "string" ? e : e.hasOwnProperty("red") ? Ce.transform(e) : Ve.transform(e),
  getAnimatableNone: (e) => {
    const t = O.parse(e);
...
var Os = "number", Us = "color", aa = "var", oa = "var(", Wi = "${}", la = /var\s*\(\s*--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)|#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\)|-?(?:\d+(?:\.\d+)?|\.\d+)/giu;
function Ne(e) {
  ...
  return {
    values: i,
    split: t.replace(la, (a) => (O.test(a) ? (s.color.push(n), r.push(Us), i.push(O.parse(a))) : a.startsWith(oa) ? (s.var.push(n), r.push(aa), i.push(a)) : (s.number.push(n), r.push(Os), i.push(parseFloat(a))), ++n, Wi)).split(Wi),
    indexes: s,
    types: r
  };
}
...
function Ls({ split: e, types: t }) {
  ...
  return (s) => {
    ...
    for (let n = 0; n < i; n++)
      if (r += e[n], s[n] !== void 0) {
        const a = t[n];
        a === Os ? r += rt(s[n]) : a === Us ? r += O.transform(s[n]) : r += s[n];
      }
    return r;
  };
}
...
function pa(e) {
  const t = Ne(e);
  return Ls(t)(t.values.map((i, s) => da(i, t.split[s])));
}
var ae = {
  test: na,
  parse: ca,
...
function fa({ hue: e, saturation: t, lightness: i, alpha: s }) {
  ...
  if (!t) r = n = a = i;
    ...
    r = Pt(l, o, e + 1 / 3), n = Pt(l, o, e), a = Pt(l, o, e - 1 / 3);
  }
  return {
...
function Gi(e) {
  ...
  let i = t.parse(e);
  return t === Ve && (i = fa(i)), i;
}
var $i = (e, t) => {
  const i = Gi(e), s = Gi(t);
  if (!i || !s) return St(e, t);
  const r = { ...i };
  return (n) => (r.red = kt(i.red, s.red, n), r.green = kt(i.green, s.green, n), r.blue = kt(i.blue, s.blue, n), r.alpha = $e(i.alpha, s.alpha, n), Ce.transform(r));
...
function gi(e) {
  return typeof e == "number" ? va : typeof e == "string" ? pi(e) ? St : O.test(e) ? $i : wa : Array.isArray(e) ? Ws : typeof e == "object" ? O.test(e) ? $i : ba : St;
}
function Ws(e, t) {
...
var wa = (e, t) => {
  const i = ae.createTransformer(t), s = Ne(e), r = Ne(t);
  return s.indexes.var.length === r.indexes.var.length && s.indexes.color.length === r.indexes.color.length && s.indexes.number.length >= r.indexes.number.length ? Wt.has(e) && !r.values.length || Wt.has(t) && !s.values.length ? ya(e, t) : li(Ws(xa(s, r), r.values), i) : (Le(!0, `Complex values '${e}' and '${t}' too different to mix. Ensure all colors are of the same type, and that each contains the same quantity of number and color values. Falling back to instant transition.`, "complex-values-different"), St(e, t));
};
function Gs(e, t, i) {
  return typeof e == "number" && typeof t == "number" && typeof i == "number" ? $e(e, t, i) : gi(e)(e, t);
}
var Sa = (e) => {
...
function Ca({ duration: e = N.duration, bounce: t = N.bounce, velocity: i = N.velocity, mass: s = N.mass }) {
  let r, n;
  Le(e <= ee(N.maxDuration), "Spring duration must be 10 seconds or less", "spring-duration-limit");
  let a = 1 - t;
...
function at(e = N.visualDuration, t = N.bounce) {
  ...
  const n = i.keyframes[0], a = i.keyframes[i.keyframes.length - 1], o = {
    ...
    value: n
  }, { stiffness: l, damping: c, mass: h, duration: d, velocity: u, isResolvedFromDuration: y } = Ba({
    ...i,
  ...
  let S, w, A, b, x, C;
  if (g < 1)
    A = Gt(v, g), b = (p + g * v * m) / A, S = (P) => {
      const T = Math.exp(-g * v * P);
      return a - T * (b * Math.sin(A * P) + m * Math.cos(A * P));
    }, x = g * v * b + m * A, C = g * v * m - b * A, w = (P) => Math.exp(-g * v * P) * (x * Math.sin(A * P) + C * Math.cos(A * P));
  else if (g === 1) {
    S = (T) => a - Math.exp(-v * T) * (m + (p + v * m) * T);
    const P = p + v * m;
    w = (T) => Math.exp(-v * T) * (v * P * T - p);
  } else {
    const P = v * Math.sqrt(g * g - 1);
    S = (D) => {
      const L = Math.exp(-g * v * D), E = Math.min(P * D, 300);
      return a - L * ((p + g * v * m) * Math.sinh(E) + P * m * Math.cosh(E)) / P;
    };
    const T = (p + g * v * m) / P, V = g * v * T - m * P, z = g * v * m - T * P;
    w = (D) => {
      const L = Math.exp(-g * v * D), E = Math.min(P * D, 300);
  ...
  const M = {
    ...
    next: (P) => {
      if (!y && g < 1) {
        const V = Math.exp(-g * v * P), z = Math.sin(A * P), D = Math.cos(A * P), L = a - V * (b * z + m * D), E = ee(V * (x * z + C * D));
    ...
    toString: () => {
      const P = Math.min(yi(M), Ks), T = $s((V) => M.next(P * V).value, P, 30);
      return P + "ms " + T;
    },
    toTransition: () => {
    }
...
function $t({ keyframes: e, velocity: t = 0, power: i = 0.8, timeConstant: s = 325, bounceDamping: r = 10, bounceStiffness: n = 500, modifyTarget: a, min: o, max: l, restDelta: c = 0.5, restSpeed: h }) {
  ...
  const _ = (C) => -g * Math.exp(-C / s), S = (C) => v + _(C), w = (C) => {
    const M = _(C), P = S(C);
    u.done = Math.abs(M) <= c, u.value = u.done ? v : P;
  };
  let A, b;
  const x = (C) => {
    y(u.value) && (A = C, b = at({
      keyframes: [u.value, p(u.value)],
      velocity: js(S, C, u.value),
      damping: r,
      stiffness: n,
      restDelta: c,
      restSpeed: h
...
function ka(e, t, i) {
  const s = [], r = i || xe.mix || Gs, n = e.length - 1;
  for (let a = 0; a < n; a++) {
    let o = r(e[a], e[a + 1]);
    t && (o = li(Array.isArray(t) ? t[a] || We : t, o)), s.push(o);
  }
  return s;
}
...
var vi = class {
...
}, Fa = (e) => e / 100, Mt = class extends vi {
  constructor(e) {
  ...
  initAnimation() {
    ...
    let { keyframes: a } = e;
    const o = t || De;
    process.env.NODE_ENV !== "production" && o !== De && de(a.length <= 2, `Only two keyframes currently supported with spring and inertia animations. Trying to animate ${a}`, "spring-two-frames"), o !== De && typeof a[0] != "number" && (this.mixKeyframes = li(Fa, Gs(a[0], a[1])), a = [0, 100]);
    const l = o({
      ...e,
      keyframes: a
    });
...
}, Ht = (e) => (e = e % 360, e < 0 && (e += 360), e), ji = Kt, qi = (e) => Math.sqrt(e[0] * e[0] + e[1] * e[1]), Xi = (e) => Math.sqrt(e[4] * e[4] + e[5] * e[5]), Oa = {
  x: 12,
  y: 13,
  z: 14,
  translateX: 12,
...
function qt(e, t) {
  ...
  if (!r) return jt(t);
  const n = s[t], a = r[1].split(",").map(La);
...
var Ke = [
  ...
  "skewX",
  "skewY"
], He = /* @__PURE__ */ new Set([...Ke, "pathRotation"]), Yi = (e) => e === Ge || e === B, Wa = /* @__PURE__ */ new Set([
  "x",
  "y",
  "z"
]), Ga = Ke.filter((e) => !Wa.has(e));
function $a(e) {
  const t = [];
  return Ga.forEach((i) => {
...
var bi = class {
  ...
  scheduleResolve() {
    this.state = "scheduled", this.isAsync ? (_e.add(this), Xt || (Xt = !0, oe.read(Zs), oe.resolveKeyframes(Qs))) : (this.readKeyframes(), this.complete());
  }
  readKeyframes() {
...
var qa = /* @__PURE__ */ er(() => window.ScrollTimeline !== void 0, "scrollTimeline"), tr = /* @__PURE__ */ er(() => {
  ...
  return !0;
}, "linearEasing"), it = ([e, t, i, s]) => `cubic-bezier(${e}, ${t}, ${i}, ${s})`, Qi = {
  linear: "linear",
  ease: "ease",
  easeIn: "ease-in",
  easeOut: "ease-out",
...
function ir(e, t) {
  if (e) return typeof e == "function" ? tr() ? $s(e, t) : "ease-out" : Ds(e) ? it(e) : Array.isArray(e) ? e.map((i) => ir(i, t) || Qi.easeOut) : Qi[e];
}
...
var sr = class extends vi {
  ...
  attachTimeline({ timeline: e, rangeStart: t, rangeEnd: i, observe: s }) {
    return this.allowFlatten && this.animation.effect?.updateTiming({ easing: "linear" }), this.animation.onfinish = null, e && qa() ? (this.animation.timeline = e, t && (this.animation.rangeStart = t), i && (this.animation.rangeEnd = i), We) : s(this);
  }
}, rr = {
  anticipate: Ps,
  backInOut: Bs,
...
function Za(e) {
  typeof e.ease == "string" && Qa(e.ease) && (e.ease = rr[e.ease]);
}
var Et = 10, Ja = class extends sr {
  constructor(e) {
    Za(e), Ys(e), super(e), e.startTime !== void 0 && e.autoplay !== !1 && (this.startTime = e.startTime), this.options = e;
  }
  updateMotionValue(e) {
...
function to(e, t, i, s) {
  ...
  return Le(a === o, `You are trying to animate ${t} from "${r}" to "${n}". "${a ? n : r}" is not an animatable value.`, "value-not-animatable"), !a || !o ? !1 : eo(e) || (i === "spring" || xi(i)) && s;
}
function Zt(e) {
...
var oo = 40, lo = class extends vi {
  ...
  onKeyframesResolved(e, t, i, s) {
    ...
    let h = !0;
    to(e, r, n, a) || (h = !1, (xe.instantAnimations || !o) && c?.(At(e, i, t)), e[0] = e[e.length - 1], Zt(i), i.repeat = 0);
    const d = {
      startTime: s ? this.resolvedAt ? this.resolvedAt - this.createdAt > oo ? this.resolvedAt : this.createdAt : this.createdAt : void 0,
      finalKeyframe: t,
      ...i,
      keyframes: e
    }, u = h && !l && ao(d), y = d.motionValue?.owner?.current;
    let p;
    if (u) try {
      p = new Ja({
        ...d,
...
var fo = {
  ...
  duration: 0.3
}, vo = (e, { keyframes: t }) => t.length > 2 ? go : He.has(e) ? e.startsWith("scale") ? mo(t[1]) : fo : yo, bo = /* @__PURE__ */ new Set([
  "when",
  "delay",
  "delayChildren",
  "staggerChildren",
...
var lr = (e, t, i, s = {}, r, n) => (a) => {
  ...
  return o.isSync ? new Mt(h) : new lo(h);
...
function Bo(e, t) {
  ...
  for (const n in r) Ao(e, n, _o(r[n]));
}
...
function Ro(e, t, { delay: i = 0, transitionOverride: s, type: r } = {}) {
  ...
  for (const p in o) {
    ...
    g.start(lr(p, g, m, w && ur.has(p) ? { type: !1 } : v, e, S));
    const A = g.animation;
    A && d.push(A);
  }
  if (a) {
...
var Uo = /\b([a-z-]*)\(.*?\)/gu, Jt = {
  ...
  mask: ei,
  WebkitMask: ei
}, fr = (e) => Wo[e], Go = /* @__PURE__ */ new Set([Jt, ei]);
function mr(e, t) {
  let i = fr(e);
...
function Ko(e, t, i) {
  ...
  for (; s < e.length && !r; ) {
    const n = e[s];
    typeof n == "string" && !$o.has(n) && Ne(n).values.length && (r = e[s]), s++;
  }
...
var ti = (e, t) => t && typeof e == "number" ? t.transform(e) : e, { schedule: Xo, cancel: zc } = /* @__PURE__ */ Rs(queueMicrotask, !1);
function gr(e) {
...
var ii = { current: null }, vr = { current: !1 }, nl = typeof window < "u";
function al() {
  if (vr.current = !0, !!nl)
...
var as = [
  ...
  mount(e) {
    ...
    this.current = e, ot.set(e, this), this.projection && !this.projection.instance && this.projection.mount(e), this.parent && this.isVariantNode && !this.isControllingVariants && (this.removeFromVariantTree = this.parent.addVariantChild(this)), this.values.forEach((t, i) => this.bindToMotionValue(i, t)), this.reducedMotionConfig === "never" ? this.shouldReduceMotion = !1 : this.reducedMotionConfig === "always" ? this.shouldReduceMotion = !0 : (vr.current || al(), this.shouldReduceMotion = ii.current), process.env.NODE_ENV !== "production" && Ts(this.shouldReduceMotion !== !0, "You have Reduced Motion enabled on your device. Animations may not appear as expected.", "reduced-motion-disabled"), this.shouldSkipAnimations = this.skipAnimationsConfig ?? !1, this.parent?.addChild(this), this.update(this.props, this.presenceContext), this.hasBeenMounted = !0;
  }
  unmount() {
  ...
  readValue(e, t) {
    ...
    return i != null && (typeof i == "string" && (bs(i) || xs(i)) ? i = parseFloat(i) : !Zo(i) && ae.test(t) && (i = mr(e, t)), this.setBaseTarget(e, H(i) ? i.get() : i)), H(i) ? i.get() : i;
  }
  setBaseTarget(e, t) {
    this.baseTarget[e] = t;
  }
...
function ml(e, { layout: t, layoutId: i }) {
  return He.has(e) || e.startsWith("origin") || (t || i !== void 0) && (!!fl[e] || e === "opacity");
}
function Mr(e, t, i) {
...
var yl = class extends xr {
  ...
  readValueFromInstance(e, t) {
    if (He.has(t)) return this.projection?.isProjecting ? jt(t) : Ua(e, t);
    {
...
function Tl(e, { attrX: t, attrY: i, attrScale: s, pathLength: r, pathSpacing: n = 1, pathOffset: a = 0, ...o }, l, c, h) {
  ...
  for (const y of Ml) d[y] !== void 0 && (u[y] = d[y], delete d[y]);
...
function Fl(e, { defaultTransition: t = {}, ...i } = {}, s, r) {
  ...
  for (let y = 0; y < e.length; y++) {
    ...
    const S = (w, A, b, x = 0, C = 0) => {
      const M = Il(w), { delay: P = 0, times: T = Xs(M), type: V = t.type || "keyframes", repeat: z, repeatType: D, repeatDelay: L = 0, ...E } = A;
      let { ease: G = t.ease || "easeOut", duration: R } = A;
      const j = typeof P == "function" ? P(x, C) : P, q = M.length, X = xi(V) ? V : r?.[V || "keyframes"];
      if (q <= 2 && X) {
        let te = 100;
        if (q === 2 && Ul(M)) {
          const Se = M[1] - M[0];
      ...
      if (we > 0 && qs(T, we), M.length === 1 && M.unshift(null), z && Le(z < zt, `Sequence segments can't repeat ${z} times — ignoring repeat option. Use a value below ${zt} or apply repeat at the sequence level instead.`), z && z < zt) {
        const te = R > 0 ? L / R : 0;
        R = kl(R, z, L);
        const ie = [...M], re = [...T];
        G = Array.isArray(G) ? [...G] : [G];
        const Se = [...G], ut = D === "reverse" || D === "mirror";
        let dt = ie, le = Se;
        ut && (dt = [...ie].reverse(), D === "reverse" && (le = [...Se].reverse().map((ge) => typeof ge == "function" ? hi(ge) : ge)));
        for (let ge = 0; ge < z; ge++) {
          const Ci = ut && ge % 2 === 0, Ai = Ci ? dt : ie, Br = Ci ? le : Se, _i = (ge + 1) * (1 + te);
          te > 0 && (M.push(M[M.length - 1]), T.push(_i), G.push("linear")), M.push(...Ai);
          for (let je = 0; je < Ai.length; je++)
            T.push(re[je] + _i), G.push(je === 0 ? "linear" : /* @__PURE__ */ Vs(Br, je - 1));
        }
        Vl(T, z, te);
      }
      const me = Be + R;
      zl(b, M, G, T, Be, me), _ = Math.max(j + R, _), u = Math.max(me, u);
    };
    if (H(g)) {
      const w = hs(g, o);
      S(m, v, us("default", w));
    } else {
      const w = Cr(g, m, s, l), A = w.length;
      for (let b = 0; b < A; b++) {
        m = m, v = v;
        const x = w[b], C = hs(x, o);
        for (const M in m) S(m[M], Nl(v, M), us(M, C), b, A);
      }
    }
    h = d, d += _;
  }
  return o.forEach((y, p) => {
    for (const g in y) {
      ...
      for (let x = 0; x < m.length; x++) {
        const { at: C, value: M, easing: P } = m[x];
        v.push(M), _.push(ci(0, u, C)), S.push(P || "easeOut");
      }
      _[0] !== 0 && (_.unshift(0), v.unshift(v[0]), S.unshift(Rl)), _[_.length - 1] !== 1 && (_.push(1), v.push(null)), a.has(p) || a.set(p, {
        keyframes: {},
        transition: {}
      });
      const w = a.get(p);
...
var Ol = (e) => typeof e == "number", Ul = (e) => e.every(Ol);
function Ll(e) {
  const t = {
  ...
  }, i = gr(e) && !Yo(e) ? new Bl(t) : new yl(t);
  i.mount(e), ot.set(e, i);
}
function Wl(e) {
  const t = new bl({
    presenceContext: null,
...
function Ar(e, t, i, s) {
  const r = [];
  if (Gl(e, t)) r.push(Pl(e, Mi(t) && t.default || t, i && (i.default || i)));
  else {
    if (e == null) return r;
    const n = Cr(e, t, s), a = n.length;
    de(!!a, "No valid elements provided.", "no-valid-elements");
    for (let o = 0; o < a; o++) {
      const l = n[o], c = l instanceof Element ? Ll : Wl;
      ot.has(l) || c(l);
      const h = ot.get(l), d = { ...i };
...
function $l(e, t, i) {
  ...
  return Fl(e.map((r) => {
    ...
    return r;
  }), t, i, { spring: at }).forEach(({ keyframes: r, transition: n }, a) => {
    s.push(...Ar(a, r, n));
  }), s;
}
function Kl(e) {
...
function Hl(e = {}) {
  ...
  function r(n, a, o) {
    ...
    if (i !== void 0 && (h.reduceMotion = i), s !== void 0 && (h.skipAnimations = s), Kl(n)) {
      ...
      typeof u == "function" && (c = u), l = Ar(n, a, {
        ...h,
        ...y
      }, t);
    }
...
var jl = Hl(), Vc = class {
  ...
  sceneObstacles = [];
  constructor(e = {}) {
    this.config = e, this.save = new Vn(e.gameId || "default"), this.scenes = new Dn(this), this.cutscene = new Fn(this), this.videoTimeline = new Fi(this), this.debugRenderer = new zn(this), this.engine = new Qr(), this.world = new en(), this.physics = new tn(), this.physics.gravity = e.gravity ? new k(...e.gravity) : new k(0, -9.81, 0), this.scene = new f.Scene();
    ...
    return e.billboard && (w = this.engine.events.on("update", () => {
      ...
      setText: (A) => {
        ...
        if (n.fillText(A, M, r.height / 2), y.needsUpdate = !0, C) {
          ...
          S.geometry.dispose(), S.geometry = new f.PlaneGeometry(m * P, m);
        }
      },
      dispose: () => {
  ...
  addRigidBody(e = {}) {
    ...
    this.rigidBody = new Ze(), this.rigidBody.type = t ? W.Static : W.Dynamic, this.rigidBody.mass = e.mass ?? (t ? 0 : 1), this.collider = new ze(), this.collider.type = K.Box;
  ...
  noise2D(e, t) {
    ...
    let M = 0.5 - p * p - g * g, P = 0;
    M >= 0 && (M *= M, P = M * M * this.dot(Vt[A], p, g));
    let T = 0.5 - m * m - v * v, V = 0;
    return T >= 0 && (T *= T, V = T * T * this.dot(Vt[b], m, v)), 70 * (C + P + V);
  }
}, Vt = [
  [
    1,
  ...
  constructor(e, t, i = 0.45, s) {
    this.width = e, this.height = t, this.map = [], this.prng = new ht(s ?? Date.now());
    for (let r = 0; r < e; r++) {
      this.map[r] = [];
  ...
  findPathBidirectionalInternal(e, t, i, s) {
    ...
    for (; c.length > 0 && p.length > 0; ) {
      ...
      const P = this.getNeighbors(M, s);
      for (const { node: T, moveCost: V } of P) {
