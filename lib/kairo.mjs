...
var ft = class Rt {
  ...
  multiplyMatrices(t, i) {
    const s = t.elements, r = i.elements, n = this.elements, a = s[0], o = s[4], l = s[8], c = s[12], h = s[1], d = s[5], u = s[9], y = s[13], p = s[2], g = s[6], m = s[10], v = s[14], _ = s[3], S = s[7], w = s[11], A = s[15], b = r[0], x = r[4], T = r[8], M = r[12], P = r[1], C = r[5], V = r[9], z = r[13], D = r[2], U = r[6], E = r[10], G = r[14], R = r[3], j = r[7], q = r[11], X = r[15];
    return n[0] = a * b + o * P + l * D + c * R, n[4] = a * x + o * C + l * U + c * j, n[8] = a * T + o * V + l * E + c * q, n[12] = a * M + o * z + l * G + c * X, n[1] = h * b + d * P + u * D + y * R, n[5] = h * x + d * C + u * U + y * j, n[9] = h * T + d * V + u * E + y * q, n[13] = h * M + d * z + u * G + y * X, n[2] = p * b + g * P + m * D + v * R, n[6] = p * x + g * C + m * U + v * j, n[10] = p * T + g * V + m * E + v * q, n[14] = p * M + g * z + m * G + v * X, n[3] = _ * b + S * P + w * D + A * R, n[7] = _ * x + S * C + w * U + A * j, n[11] = _ * T + S * V + w * E + A * q, n[15] = _ * M + S * z + w * G + A * X, this;
  }
  multiply(t) {
  ...
  intersectSphere(t, i) {
    ...
    if (d > u) return Ze._missResult;
    const y = Math.sqrt(u - d);
    let p = h - y, g = h + y;
    if (p < 0 && (p = g), p < 0) return Ze._missResult;
  ...
  update(t, i = 60) {
    ...
    for (let b = 0; b < s; b++) {
      ...
      const P = x * y | 0, C = T * y | 0, V = M * y | 0, z = (P * 73856093 ^ C * 19349663 ^ V * 83492791) & p;
    ...
    for (let b = 0; b < s; b++) {
      if (d[b] === 0) continue;
      const x = r[b], T = n[b], M = a[b], P = h[b], C = x * y | 0, V = T * y | 0, z = M * y | 0;
      for (let D = 0; D < 14; D++) {
        const U = ((C + S[D]) * 73856093 ^ (V + w[D]) * 19349663 ^ (z + A[D]) * 83492791) & p;
        if (m[U] !== u) continue;
        let E = g[U];
        const G = D === 0;
        for (; E !== -1; ) {
...
${s}
  ...
  constructor(e, t = "tDiffuse") {
    super(), this.textureID = t, this.uniforms = null, this.material = null, e instanceof Q ? (this.uniforms = e.uniforms, this.material = e) : e && (this.uniforms = Fe.clone(e.uniforms), this.material = new Q({
  ...
  constructor(t, i = 1, s, r) {
    ...
    const o = dn;
    this.highPassUniforms = Fe.clone(o.uniforms), this.highPassUniforms.luminosityThreshold.value = r, this.highPassUniforms.smoothWidth.value = 0.01, this.materialHighPassFilter = new Q({
    ...
    this.compositeMaterial.uniforms.bloomFactors.value = c, this.bloomTintColors = [
      ...
      new Te(1, 1, 1),
      new Te(1, 1, 1)
    ], this.compositeMaterial.uniforms.bloomTintColors.value = this.bloomTintColors, this.copyUniforms = Fe.clone(st.uniforms), this.blendMaterial = new Q({
      ...
      depthWrite: !1,
      transparent: !0
    }), this._oldClearColor = new he(), this._oldClearAlpha = 1, this._basic = new Or(), this._fsQuad = new Le(null);
  }
  dispose() {
...
var ai = class et extends pe {
  constructor(t, i, s, r) {
    ...
    const c = st;
    this.copyUniforms = Fe.clone(c.uniforms), this.materialCopy = new Q({
      uniforms: this.copyUniforms,
      ...
      depthTest: !1,
      depthWrite: !1
    }), this.enabled = !0, this.needsSwap = !1, this._oldClearColor = new he(), this.oldClearAlpha = 1, this._fsQuad = new Le(null), this.tempPulseColor1 = new he(), this.tempPulseColor2 = new he(), this.textureMatrix = new Ir();
    function h(d, u) {
...
var pn = {
  ...
  constructor(e = 0.5, t = !1) {
    super();
    const i = pn;
    this.uniforms = Fe.clone(i.uniforms), this.material = new Q({
      name: i.name,
      uniforms: this.uniforms,
...
function bn(e = {}) {
  ...
  for (let S = 0; S < d.count; S++) {
    ...
    const T = p.clone().lerp(g, b);
    y[S * 3] = T.r, y[S * 3 + 1] = T.g, y[S * 3 + 2] = T.b;
  }
...
function Rs(e, t) {
  ...
  return {
    schedule: gt.reduce((S, w) => {
      const A = a[w];
      return S[w] = (b, x = !1, T = !1) => (i || m(), A.schedule(b, x, T)), S;
    }, {}),
    cancel: (S) => {
...
var { schedule: oe, cancel: Lt, state: wt, steps: Ec } = /* @__PURE__ */ Rs(typeof requestAnimationFrame < "u" ? requestAnimationFrame : We, !0), vt;
function Xn() {
  vt = void 0;
}
var J = {
...
var Ut = {
  ...
  parse: parseFloat,
  transform: (t) => `${t}${e}`
}), ce = /* @__PURE__ */ ct("deg"), Re = /* @__PURE__ */ ct("%"), B = /* @__PURE__ */ ct("px"), ia = /* @__PURE__ */ ct("vh"), sa = /* @__PURE__ */ ct("vw"), Ui = {
  ...Re,
  ...
  test: (e) => Ce.test(e) || Ut.test(e) || Ve.test(e),
  parse: (e) => Ce.test(e) ? Ce.parse(e) : Ve.test(e) ? Ve.parse(e) : Ut.parse(e),
...
function Us({ split: e, types: t }) {
  ...
  return (s) => {
    ...
    for (let n = 0; n < i; n++)
      if (r += e[n], s[n] !== void 0) {
        const a = t[n];
        a === Os ? r += rt(s[n]) : a === Ls ? r += O.transform(s[n]) : r += s[n];
      }
    return r;
  };
}
...
var wa = (e, t) => {
  ...
  return s.indexes.var.length === r.indexes.var.length && s.indexes.color.length === r.indexes.color.length && s.indexes.number.length >= r.indexes.number.length ? Wt.has(e) && !r.values.length || Wt.has(t) && !s.values.length ? ya(e, t) : li(Ws(xa(s, r), r.values), i) : (Ue(!0, `Complex values '${e}' and '${t}' too different to mix. Ensure all colors are of the same type, and that each contains the same quantity of number and color values. Falling back to instant transition.`, "complex-values-different"), St(e, t));
};
function Gs(e, t, i) {
...
function at(e = N.visualDuration, t = N.bounce) {
  ...
  if (g < 1)
    A = Gt(v, g), b = (p + g * v * m) / A, S = (P) => {
      ...
      return a - C * (b * Math.sin(A * P) + m * Math.cos(A * P));
    }, x = g * v * b + m * A, T = g * v * m - b * A, w = (P) => Math.exp(-g * v * P) * (x * Math.sin(A * P) + T * Math.cos(A * P));
  else if (g === 1) {
    S = (C) => a - Math.exp(-v * C) * (m + (p + v * m) * C);
    const P = p + v * m;
    w = (C) => Math.exp(-v * C) * (v * P * C - p);
  } else {
    const P = v * Math.sqrt(g * g - 1);
    S = (D) => {
      const U = Math.exp(-g * v * D), E = Math.min(P * D, 300);
      return a - U * ((p + g * v * m) * Math.sinh(E) + P * m * Math.cosh(E)) / P;
    };
    const C = (p + g * v * m) / P, V = g * v * C - m * P, z = g * v * m - C * P;
    w = (D) => {
      const U = Math.exp(-g * v * D), E = Math.min(P * D, 300);
  ...
  const M = {
    ...
    next: (P) => {
      if (!y && g < 1) {
        const V = Math.exp(-g * v * P), z = Math.sin(A * P), D = Math.cos(A * P), U = a - V * (b * z + m * D), E = ee(V * (x * z + T * D));
    ...
    toString: () => {
      const P = Math.min(yi(M), Ks), C = $s((V) => M.next(P * V).value, P, 30);
      return P + "ms " + C;
    },
    toTransition: () => {
    }
...
function $t({ keyframes: e, velocity: t = 0, power: i = 0.8, timeConstant: s = 325, bounceDamping: r = 10, bounceStiffness: n = 500, modifyTarget: a, min: o, max: l, restDelta: c = 0.5, restSpeed: h }) {
  const d = e[0], u = {
    ...
    value: d
  }, y = (T) => o !== void 0 && T < o || l !== void 0 && T > l, p = (T) => o === void 0 ? l : l === void 0 || Math.abs(o - T) < Math.abs(l - T) ? o : l;
  let g = i * t;
  const m = d + g, v = a === void 0 ? m : a(m);
  v !== m && (g = v - d);
  const _ = (T) => -g * Math.exp(-T / s), S = (T) => v + _(T), w = (T) => {
    const M = _(T), P = S(T);
  ...
  return x(0), {
    ...
    next: (T) => {
      let M = !1;
      return !b && A === void 0 && (M = !0, w(T), x(T)), A !== void 0 && T >= A ? b.next(T - A) : (!M && w(T), u);
    }
  };
}
function ka(e, t, i) {
...
var vi = class {
  ...
  tick(e, t = !1) {
    ...
    if (h) {
      ...
      !M && x >= 1 && (M = 1), M === 1 && T--, T = Math.min(T, h + 1), T % 2 && (d === "reverse" ? (M = 1 - M, u && (M -= u / a)) : d === "mirror" && (S = n)), _ = be(0, 1, M) * a;
    }
    let w;
...
ve.translateX = ve.x;
ve.translateY = ve.y;
var _e = /* @__PURE__ */ new Set(), Xt = !1, Yt = !1, Zt = !1;
function Zs() {
  if (Yt) {
  ...
  Yt = !1, Xt = !1, _e.forEach((e) => e.complete(Zt)), _e.clear();
}
function Qs() {
  _e.forEach((e) => {
...
var bi = class {
  ...
  scheduleResolve() {
    this.state = "scheduled", this.isAsync ? (_e.add(this), Xt || (Xt = !0, oe.read(Qs), oe.resolveKeyframes(Zs))) : (this.readKeyframes(), this.complete());
  }
  readKeyframes() {
...
function to(e, t, i, s) {
  ...
  return Ue(a === o, `You are trying to animate ${t} from "${r}" to "${n}". "${a ? n : r}" is not an animatable value.`, "value-not-animatable"), !a || !o ? !1 : eo(e) || (i === "spring" || xi(i)) && s;
}
function Qt(e) {
...
var oo = 40, lo = class extends vi {
  ...
  onKeyframesResolved(e, t, i, s) {
    ...
    let h = !0;
    to(e, r, n, a) || (h = !1, (xe.instantAnimations || !o) && c?.(At(e, i, t)), e[0] = e[e.length - 1], Qt(i), i.repeat = 0);
    const d = {
...
var lr = (e, t, i, s = {}, r, n) => (a) => {
  ...
  let d = !1;
  if ((h.type === !1 || h.duration === 0 && !h.repeatDelay) && (Qt(h), h.delay === 0 && (d = !0)), (xe.instantAnimations || xe.skipAnimations || r?.shouldSkipAnimations || o.skipAnimations) && (d = !0, Qt(h), h.delay = 0), h.allowFlatten = !o.type && !o.ease, d && !n && t.get() !== void 0) {
...
var yl = class extends xr {
  ...
  readValueFromInstance(e, t) {
    if (He.has(t)) return this.projection?.isProjecting ? jt(t) : La(e, t);
    {
...
function Fl(e, { defaultTransition: t = {}, ...i } = {}, s, r) {
  ...
  for (let y = 0; y < e.length; y++) {
    ...
    let _ = 0;
    const S = (w, A, b, x = 0, T = 0) => {
      const M = Il(w), { delay: P = 0, times: C = Xs(M), type: V = t.type || "keyframes", repeat: z, repeatType: D, repeatDelay: U = 0, ...E } = A;
      let { ease: G = t.ease || "easeOut", duration: R } = A;
      const j = typeof P == "function" ? P(x, T) : P, q = M.length, X = xi(V) ? V : r?.[V || "keyframes"];
      if (q <= 2 && X) {
        let te = 100;
        if (q === 2 && Ll(M)) {
          const Se = M[1] - M[0];
      ...
      const we = C.length - M.length;
      if (we > 0 && qs(C, we), M.length === 1 && M.unshift(null), z && Ue(z < zt, `Sequence segments can't repeat ${z} times — ignoring repeat option. Use a value below ${zt} or apply repeat at the sequence level instead.`), z && z < zt) {
        const te = R > 0 ? U / R : 0;
        R = kl(R, z, U);
        const ie = [...M], re = [...C];
        ...
        for (let ge = 0; ge < z; ge++) {
          ...
          te > 0 && (M.push(M[M.length - 1]), C.push(_i), G.push("linear")), M.push(...Ai);
          for (let je = 0; je < Ai.length; je++)
            C.push(re[je] + _i), G.push(je === 0 ? "linear" : /* @__PURE__ */ Vs(Br, je - 1));
        }
        Vl(C, z, te);
      }
      const me = Be + R;
      zl(b, M, G, C, Be, me), _ = Math.max(j + R, _), u = Math.max(me, u);
    };
    if (H(g)) {
      const w = hs(g, o);
      S(m, v, us("default", w));
      ...
      for (let b = 0; b < A; b++) {
        ...
        for (const M in m) S(m[M], Nl(v, M), us(M, T), b, A);
      }
    }
    h = d, d += _;
  }
  return o.forEach((y, p) => {
    for (const g in y) {
      ...
      for (let x = 0; x < m.length; x++) {
        const { at: T, value: M, easing: P } = m[x];
        v.push(M), _.push(ci(0, u, T)), S.push(P || "easeOut");
      }
...
var jl = Hl(), Vc = class {
  ...
  createText3D(e) {
    ...
    return e.billboard && (w = this.engine.events.on("update", () => {
      ...
      setText: (A) => {
        ...
        if (n.fillText(A, M, r.height / 2), y.needsUpdate = !0, T) {
  ...
  addRigidBody(e = {}) {
    ...
    this.rigidBody = new Qe(), this.rigidBody.type = t ? W.Static : W.Dynamic, this.rigidBody.mass = e.mass ?? (t ? 0 : 1), this.collider = new ze(), this.collider.type = K.Box;
  ...
  noise2D(e, t) {
    ...
    x >= 0 && (x *= x, T = x * x * this.dot(Vt[w], h, d));
    let M = 0.5 - p * p - g * g, P = 0;
    M >= 0 && (M *= M, P = M * M * this.dot(Vt[A], p, g));
    let C = 0.5 - m * m - v * v, V = 0;
    return C >= 0 && (C *= C, V = C * C * this.dot(Vt[b], m, v)), 70 * (T + P + V);
  }
}, Vt = [
  [
    1,
  ...
  findPathBidirectionalInternal(e, t, i, s) {
    ...
    for (; c.length > 0 && p.length > 0; ) {
      ...
      for (const { node: C, moveCost: V } of P) {
        if (!C.walkable || m.has(C)) continue;
        const z = (u.get(M) ?? 0) + V;
        if (z < (u.get(C) ?? 1 / 0) && (u.set(C, z), y.set(C, M), g.has(C) || (p.push(C), g.add(C)), o.has(C))) {
          const D = z + o.get(C);
          D < A && (A = D, b = C);
        }
      }
  ...
  static solveTwoBone(e, t, i, s, r) {
    const n = i.x - e.x, a = i.y - e.y, o = i.z - e.z, l = Math.sqrt(n * n + a * a + o * o), c = bt.clamp(l, 1e-3, s + r - 1e-3), h = (s * s + c * c - r * r) / (2 * s * c), d = Math.acos(bt.clamp(h, -1, 1)), u = l > 0 ? 1 / l : 0, y = n * u, p = a * u, g = o * u;
    let m = 0, v = 0, _ = 0;
    const S = y * y + g * g;
    if (S >= 1e-6) {
      const b = Math.sqrt(S);
      ...
      if (b >= 1e-6) {
        ...
        const x = p * p + y * y, T = Math.sqrt(x), M = T > 0 ? 1 / T : 0;
        m = p * M, v = -y * M, _ = 0;
      }
    }
    const w = Math.cos(d) * s, A = Math.sin(d) * s;
    return {
      jointPos: new k(e.x + y * w + m * A, e.y + p * w + v * A, e.z + g * w + _ * A),
