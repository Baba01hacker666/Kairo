      ...
      for (let D = 0; D < 14; D++) {
        ...
        for (; E !== -1; ) {
          if ((!G || E > b) && d[E] !== 0) {
            ...
            if (Pe < R * R && Pe > 1e-4) {
              _++;
              const Se = Math.sqrt(Pe), me = j / Se, te = q / Se, ie = X / Se, re = 0.5 * (R - Se);
  ...
  overlapSphere(t, i) {
    ...
    for (let r = 0; r < this.bodies.length; r++) {
      ...
      if (a.type === K.Sphere) {
        ...
        const l = a.size.x * 0.5, c = a.size.y * 0.5, h = a.size.z * 0.5, d = Bt(t.x, o.x - l, o.x + l), u = Bt(t.y, o.y - c, o.y + c), y = Bt(t.z, o.z - h, o.z + h), p = t.x - d, g = t.y - u, m = t.z - y;
...
var Pc = /* @__PURE__ */ (function(e) {
  ...
  static compileGame(e, t = {}) {
    ...
    e.forEach((h) => {
      ...
      const p = JSON.stringify(h), g = Ne.createSaveEnvelope(JSON.parse(p)), m = JSON.stringify(g), v = i.compressBinaryLevels ? Ne.compressToBase64(m) : m, _ = new TextEncoder().encode(v).length;
      n += _, a.push({
        id: h.id,
        name: h.name,
        world: h.world,
...
var As = /* @__NO_SIDE_EFFECTS__ */ (e) => (t) => t <= 0.5 ? e(2 * t) / 2 : (2 - e(2 * (1 - t))) / 2, hi = /* @__NO_SIDE_EFFECTS__ */ (e) => (t) => 1 - e(1 - t), _s = /* @__PURE__ */ ht(0.33, 1.53, 0.69, 0.99), ui = /* @__PURE__ */ hi(_s), Bs = /* @__PURE__ */ As(ui), Ps = (e) => e >= 1 ? 1 : (e *= 2) < 1 ? 0.5 * ui(e) : 0.5 * (2 - Math.pow(2, -10 * (e - 1))), di = (e) => 1 - Math.sin(Math.acos(e)), Gn = hi(di), ks = As(di), $n = /* @__PURE__ */ ht(0.42, 0, 1, 1), Kn = /* @__PURE__ */ ht(0, 0, 0.58, 1), Es = /* @__PURE__ */ ht(0.42, 0, 0.58, 1), zs = /* @__NO_SIDE_EFFECTS__ */ (e) => Array.isArray(e) && typeof e[0] != "number";
// @__NO_SIDE_EFFECTS__
function Vs(e, t) {
...
function Rs(e, t) {
  ...
  const r = {
    ...
    timestamp: 0,
    isProcessing: !1
  }, n = () => i = !0, a = vt.reduce((S, w) => (S[w] = jn(n), S), {}), { setup: o, read: l, resolveKeyframes: c, preUpdate: h, update: d, preRender: u, render: y, postRender: p } = a, g = () => {
...
var Jn = /^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu, mi = (e, t) => (i) => !!(typeof i == "string" && Jn.test(i) && i.startsWith(e) || t && !Qn(i) && Object.prototype.hasOwnProperty.call(i, t)), Ns = (e, t, i) => (s) => {
  ...
  transform: ({ red: e, green: t, blue: i, alpha: s = 1 }) => "rgba(" + Pt.transform(e) + ", " + Pt.transform(t) + ", " + Pt.transform(i) + ", " + at(ot.transform(s)) + ")"
};
function ta(e) {
  let t = "", i = "", s = "", r = "";
...
var Wt = {
  ...
  parse: parseFloat,
  transform: (t) => `${t}${e}`
}), ce = /* @__PURE__ */ ut("deg"), Fe = /* @__PURE__ */ ut("%"), B = /* @__PURE__ */ ut("px"), ia = /* @__PURE__ */ ut("vh"), sa = /* @__PURE__ */ ut("vw"), Ui = {
  ...Fe,
  ...
  test: (e) => Ae.test(e) || Wt.test(e) || De.test(e),
  parse: (e) => Ae.test(e) ? Ae.parse(e) : De.test(e) ? De.parse(e) : Wt.parse(e),
  transform: (e) => typeof e == "string" ? e : e.hasOwnProperty("red") ? Ae.transform(e) : De.transform(e),
  getAnimatableNone: (e) => {
    const t = O.parse(e);
...
var $i = (e, t) => {
  ...
  const r = { ...i };
  return (n) => (r.red = Et(i.red, s.red, n), r.green = Et(i.green, s.green, n), r.blue = Et(i.blue, s.blue, n), r.alpha = Ke(i.alpha, s.alpha, n), Ae.transform(r));
...
function Ca({ duration: e = N.duration, bounce: t = N.bounce, velocity: i = N.velocity, mass: s = N.mass }) {
  ...
  a = xe(N.minDamping, N.maxDamping, a), e = xe(N.minDuration, N.maxDuration, ne(e)), a < 1 ? (r = (c) => {
    const h = c * a, d = h * e, u = h - i, y = $t(c, a), p = Math.exp(-d);
    return Ki - u / y * p;
  }, n = (c) => {
    const h = c * a * e, d = h * i + i, u = Math.pow(a, 2) * Math.pow(c, 2) * e, y = Math.exp(-h), p = $t(Math.pow(c, 2), a);
...
var Da = (e) => e !== null;
function _t(e, { repeat: t, repeatType: i = "loop" }, s, r = 1) {
...
var vi = class {
  ...
  tick(e, t = !1) {
    ...
    if (h) {
      ...
      !M && x >= 1 && (M = 1), M === 1 && T--, T = Math.min(T, h + 1), T % 2 && (d === "reverse" ? (M = 1 - M, u && (M -= u / a)) : d === "mirror" && (S = n)), _ = xe(0, 1, M) * a;
    }
    let w;
    ...
    return b && y !== Kt && (w.value = _t(c, this.options, g, this.speed)), p && p(w.value), b && this.finish(), w;
  }
  then(e, t) {
    return this.finished.then(e, t);
  }
...
var _e = (e) => e * 180 / Math.PI, Ht = (e) => {
  ...
  scaleY: Xi,
  scale: (e) => (qi(e) + Xi(e)) / 2,
  rotateX: (e) => jt(_e(Math.atan2(e[6], e[5]))),
  rotateY: (e) => jt(_e(Math.atan2(-e[2], e[0]))),
  rotateZ: ji,
  rotate: ji,
...
var He = [
  ...
  "skewX",
  "skewY"
], je = /* @__PURE__ */ new Set([...He, "pathRotation"]), Yi = (e) => e === $e || e === B, Wa = /* @__PURE__ */ new Set([
  "x",
  "y",
  "z"
...
be.translateX = be.x;
be.translateY = be.y;
var Be = /* @__PURE__ */ new Set(), Yt = !1, Zt = !1, Qt = !1;
function Zs() {
  if (Zt) {
    const e = Array.from(Be).filter((s) => s.needsMeasurement), t = new Set(e.map((s) => s.element)), i = /* @__PURE__ */ new Map();
    t.forEach((s) => {
      const r = $a(s);
  ...
  Zt = !1, Yt = !1, Be.forEach((e) => e.complete(Qt)), Be.clear();
}
function Qs() {
  Be.forEach((e) => {
...
var bi = class {
  ...
  scheduleResolve() {
    this.state = "scheduled", this.isAsync ? (Be.add(this), Yt || (Yt = !0, oe.read(Qs), oe.resolveKeyframes(Zs))) : (this.readKeyframes(), this.complete());
  }
  readKeyframes() {
  ...
  constructor(e) {
    ...
    this.animation = Xa(t, i, s, l, r), l.autoplay === !1 && this.animation.pause(), this.animation.onfinish = () => {
      if (this.finishedTime = this.time, !r) {
        const c = _t(s, this.options, a, this.speed);
...
var oo = 40, lo = class extends vi {
  ...
  onKeyframesResolved(e, t, i, s) {
    ...
    let h = !0;
    to(e, r, n, a) || (h = !1, (we.instantAnimations || !o) && c?.(_t(e, i, t)), e[0] = e[e.length - 1], Jt(i), i.repeat = 0);
    const d = {
    ...
    const S = (w, A, b, x = 0, T = 0) => {
      ...
      if (Se > 0 && qs(C, Se), M.length === 1 && M.unshift(null), z && We(z < Vt, `Sequence segments can't repeat ${z} times — ignoring repeat option. Use a value below ${Vt} or apply repeat at the sequence level instead.`), z && z < Vt) {
        ...
        for (let ge = 0; ge < z; ge++) {
          const Ci = pt && ge % 2 === 0, Ai = Ci ? ft : ie, Br = Ci ? le : Me, _i = (ge + 1) * (1 + te);
          te > 0 && (M.push(M[M.length - 1]), C.push(_i), G.push("linear")), M.push(...Ai);
          for (let qe = 0; qe < Ai.length; qe++)
            C.push(re[qe] + _i), G.push(qe === 0 ? "linear" : /* @__PURE__ */ Vs(Br, qe - 1));
        }
        Vl(C, z, te);
      }
      const me = Pe + R;
      zl(b, M, G, C, Pe, me), _ = Math.max(j + R, _), u = Math.max(me, u);
    };
    if (H(g)) {
      const w = hs(g, o);
      S(m, v, us("default", w));
...
var jl = Hl(), Vc = class {
  ...
  noise2D(e, t) {
    ...
    M >= 0 && (M *= M, P = M * M * this.dot(Dt[A], p, g));
    let C = 0.5 - m * m - v * v, V = 0;
    return C >= 0 && (C *= C, V = C * C * this.dot(Dt[b], m, v)), 70 * (T + P + V);
  }
}, Dt = [
  [
    1,
  ...
  static solveTwoBone(e, t, i, s, r) {
    const n = i.x - e.x, a = i.y - e.y, o = i.z - e.z, l = Math.sqrt(n * n + a * a + o * o), c = ve.clamp(l, 1e-3, s + r - 1e-3), h = (s * s + c * c - r * r) / (2 * s * c), d = Math.acos(ve.clamp(h, -1, 1)), u = l > 0 ? 1 / l : 0, y = n * u, p = a * u, g = o * u;
    let m = 0, v = 0, _ = 0;
    const S = y * y + g * g;
    if (S >= 1e-6) {
      const b = Math.sqrt(S);
