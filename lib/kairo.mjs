...
function vn(e = {}) {
  const t = e.size ?? 100, i = e.segments ?? 128, s = e.seed ?? 1337, r = e.amplitude ?? 6, n = e.frequency ?? 0.08, a = e.octaves ?? 5, o = e.persistence ?? 0.5, l = e.position ?? [
    ...
    0,
    0
  ], c = new jl(s), h = new f.PlaneGeometry(t, t, i, i);
  h.rotateX(-Math.PI / 2);
...
<body>
  ...
  async play(e) {
    this.stop(), this.activeContext = new Dn(this.app);
    try {
...
var xe = {}, ys = (e) => /^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(e), In = (e) => typeof e == "object" && e !== null, vs = (e) => /^0[^.\s]+$/u.test(e);
// @__NO_SIDE_EFFECTS__
function bs(e) {
  let t;
...
var Le = /* @__NO_SIDE_EFFECTS__ */ (e) => e, li = (...e) => e.reduce((t, i) => (s) => i(t(s))), ci = /* @__NO_SIDE_EFFECTS__ */ (e, t, i) => {
  ...
  add(e) {
    return Fn(this.subscriptions, e), () => oi(this.subscriptions, e);
  }
  notify(e, t, i) {
...
function Vs(e, t) {
  ...
  const r = {
    ...
    timestamp: 0,
    isProcessing: !1
  }, n = () => i = !0, a = gt.reduce((S, w) => (S[w] = Hn(n), S), {}), { setup: o, read: l, resolveKeyframes: c, preUpdate: h, update: d, preRender: u, render: y, postRender: p } = a, g = () => {
    const S = xe.useManualTiming, w = S ? r.timestamp : performance.now();
    i = !1, S || (r.delta = s ? 1e3 / 60 : Math.max(Math.min(w - r.timestamp, jn), 1)), r.timestamp = w, r.isProcessing = !0, o.process(r), l.process(r), c.process(r), h.process(r), d.process(r), u.process(r), y.process(r), p.process(r), r.isProcessing = !1, i && t && (s = !1, e(g));
  }, m = () => {
...
var J = {
  ...
  set: (e) => {
    vt = e, queueMicrotask(qn);
  }
}, Ds = (e) => (t) => typeof t == "string" && t.startsWith(e), Rs = /* @__PURE__ */ Ds("--"), Xn = /* @__PURE__ */ Ds("var(--"), pi = (e) => Xn(e) ? Yn.test(e.split("/*")[0].trim()) : !1, Yn = /var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu;
function Ui(e) {
...
var Zn = /^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu, mi = (e, t) => (i) => !!(typeof i == "string" && Zn.test(i) && i.startsWith(e) || t && !Qn(i) && Object.prototype.hasOwnProperty.call(i, t)), Fs = (e, t, i) => (s) => {
...
var Lt = {
  ...
  parse: parseFloat,
  transform: (t) => `${t}${e}`
}), ce = /* @__PURE__ */ lt("deg"), De = /* @__PURE__ */ lt("%"), P = /* @__PURE__ */ lt("px"), ta = /* @__PURE__ */ lt("vh"), ia = /* @__PURE__ */ lt("vw"), Li = {
  ...De,
...
function ra(e) {
  return isNaN(e) && typeof e == "string" && (e.match(fi)?.length || 0) + (e.match(sa)?.length || 0) > 0;
}
var Is = "number", Ns = "color", na = "var", aa = "var(", Wi = "${}", oa = /var\s*\(\s*--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)|#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\)|-?(?:\d+(?:\.\d+)?|\.\d+)/giu;
function Ie(e) {
  ...
  return {
    values: i,
    split: t.replace(oa, (a) => (O.test(a) ? (s.color.push(n), r.push(Ns), i.push(O.parse(a))) : a.startsWith(aa) ? (s.var.push(n), r.push(na), i.push(a)) : (s.number.push(n), r.push(Is), i.push(parseFloat(a))), ++n, Wi)).split(Wi),
    indexes: s,
    types: r
  };
}
...
var ha = (e) => typeof e == "number" ? 0 : O.test(e) ? O.getAnimatableNone(e) : e, ua = (e, t) => typeof e == "number" ? t?.trim().endsWith("/") ? e : 0 : ha(e);
function da(e) {
  const t = Ie(e);
  return Os(t)(t.values.map((i, s) => ua(i, t.split[s])));
}
var ae = {
  test: ra,
  parse: la,
...
function pa({ hue: e, saturation: t, lightness: i, alpha: s }) {
  e /= 360, t /= 100, i /= 100;
  let r = 0, n = 0, a = 0;
  if (!t) r = n = a = i;
  else {
...
function gi(e) {
  return typeof e == "number" ? ya : typeof e == "string" ? pi(e) ? St : O.test(e) ? $i : xa : Array.isArray(e) ? Us : typeof e == "object" ? O.test(e) ? $i : va : St;
}
function Us(e, t) {
...
var xa = (e, t) => {
  ...
  return s.indexes.var.length === r.indexes.var.length && s.indexes.color.length === r.indexes.color.length && s.indexes.number.length >= r.indexes.number.length ? Wt.has(e) && !r.values.length || Wt.has(t) && !s.values.length ? ga(e, t) : li(Us(ba(s, r), r.values), i) : (Ue(!0, `Complex values '${e}' and '${t}' too different to mix. Ensure all colors are of the same type, and that each contains the same quantity of number and color values. Falling back to instant transition.`, "complex-values-different"), St(e, t));
};
function Ls(e, t, i) {
...
function Ma(e, t, i) {
  let s = i;
  for (let r = 1; r < Sa; r++) s = s - e(s) / t(s);
  return s;
}
var Ki = 1e-3;
function Ta({ duration: e = N.duration, bounce: t = N.bounce, velocity: i = N.velocity, mass: s = N.mass }) {
  let r, n;
...
function nt(e = N.visualDuration, t = N.bounce) {
  ...
  const n = i.keyframes[0], a = i.keyframes[i.keyframes.length - 1], o = {
    ...
    value: n
  }, { stiffness: l, damping: c, mass: h, duration: d, velocity: u, isResolvedFromDuration: y } = _a({
    ...i,
...
function ka(e, t, { clamp: i = !0, ease: s, mixer: r } = {}) {
  const n = e.length;
  ...
  const o = Ba(t, s, r), l = o.length, c = (h) => {
...
function Ve({ duration: e = 300, keyframes: t, times: i, ease: s = "easeInOut" }) {
  const r = ks(s) ? s.map(Oi) : Oi(s), n = {
    ...
    value: t[0]
  }, a = ka(Ea(i && i.length === t.length ? i : js(t), e), t, { ease: Array.isArray(r) ? r : za(t, r) });
  return {
...
function At(e, { repeat: t, repeatType: i = "loop" }, s, r = 1) {
  const n = e.filter(Va), a = r < 0 || t && i !== "loop" && t % 2 === 1 ? 0 : n.length - 1;
...
var vi = class {
...
}, Ra = (e) => e / 100, Mt = class extends vi {
  constructor(e) {
  ...
  initAnimation() {
    ...
    let { keyframes: a } = e;
    const o = t || Ve;
    process.env.NODE_ENV !== "production" && o !== Ve && de(a.length <= 2, `Only two keyframes currently supported with spring and inertia animations. Trying to animate ${a}`, "spring-two-frames"), o !== Ve && typeof a[0] != "number" && (this.mixKeyframes = li(Ra, Ls(a[0], a[1])), a = [0, 100]);
    const l = o({
      ...e,
      keyframes: a
    });
...
}, Ht = (e) => (e = e % 360, e < 0 && (e += 360), e), ji = Kt, qi = (e) => Math.sqrt(e[0] * e[0] + e[1] * e[1]), Xi = (e) => Math.sqrt(e[4] * e[4] + e[5] * e[5]), Na = {
  x: 12,
  y: 13,
  z: 14,
  translateX: 12,
...
var $e = [
  ...
  "skewX",
  "skewY"
], Ke = /* @__PURE__ */ new Set([...$e, "pathRotation"]), Yi = (e) => e === We || e === P, La = /* @__PURE__ */ new Set([
  "x",
  "y",
  "z"
]), Wa = $e.filter((e) => !La.has(e));
function Ga(e) {
  const t = [];
  return Wa.forEach((i) => {
...
function Qs(e, t, i) {
  Ka(t) ? e.style.setProperty(t, i) : e.style[t] = i;
}
var Ha = {};
function Zs(e, t) {
...
var ja = /* @__PURE__ */ Zs(() => window.ScrollTimeline !== void 0, "scrollTimeline"), Js = /* @__PURE__ */ Zs(() => {
  try {
...
var tr = class extends vi {
  ...
  attachTimeline({ timeline: e, rangeStart: t, rangeEnd: i, observe: s }) {
    return this.allowFlatten && this.animation.effect?.updateTiming({ easing: "linear" }), this.animation.onfinish = null, e && ja() ? (this.animation.timeline = e, t && (this.animation.rangeStart = t), i && (this.animation.rangeEnd = i), Le) : s(this);
  }
}, ir = {
  anticipate: _s,
  backInOut: As,
...
function Qa(e) {
  typeof e.ease == "string" && Ya(e.ease) && (e.ease = ir[e.ease]);
}
var Et = 10, Za = class extends tr {
  constructor(e) {
    Qa(e), qs(e), super(e), e.startTime !== void 0 && e.autoplay !== !1 && (this.startTime = e.startTime), this.options = e;
  }
  updateMotionValue(e) {
...
function eo(e, t, i, s) {
  ...
  return Ue(a === o, `You are trying to animate ${t} from "${r}" to "${n}". "${a ? n : r}" is not an animatable value.`, "value-not-animatable"), !a || !o ? !1 : Ja(e) || (i === "spring" || xi(i)) && s;
}
function Zt(e) {
...
function io(e) {
  for (let t = 0; t < e.length; t++) if (typeof e[t] == "string" && to.test(e[t])) return !0;
  return !1;
}
var so = /* @__PURE__ */ new Set([
  ...
  "borderBottomColor",
  "borderLeftColor"
]), ro = /* @__PURE__ */ bs(() => Object.hasOwnProperty.call(Element.prototype, "animate"));
function no(e) {
  ...
  return ro() && i && (sr.has(i) || so.has(i) && io(o)) && (i !== "transform" || !h) && !c && !s && r !== "mirror" && n !== 0 && a !== "inertia";
}
var ao = 40, oo = class extends vi {
  ...
  onKeyframesResolved(e, t, i, s) {
    ...
    let h = !0;
    eo(e, r, n, a) || (h = !1, (xe.instantAnimations || !o) && c?.(At(e, i, t)), e[0] = e[e.length - 1], Zt(i), i.repeat = 0);
    const d = {
      startTime: s ? this.resolvedAt ? this.resolvedAt - this.createdAt > ao ? this.resolvedAt : this.createdAt : this.createdAt : void 0,
      finalKeyframe: t,
      ...i,
      keyframes: e
    }, u = h && !l && no(d), y = d.motionValue?.owner?.current;
    let p;
    if (u) try {
      p = new Za({
        ...d,
  ...
  get animation() {
    return this._animation || (this.keyframeResolver?.resume(), $a()), this._animation;
  }
  get duration() {
...
var co = class extends lo {
...
}, es = 30, ho = (e) => !isNaN(parseFloat(e)), ts = { current: void 0 }, uo = class {
  constructor(e, t = {}) {
  ...
  setCurrent(e) {
    this.current = e, this.updatedAt = J.now(), this.canTrackVelocity === null && e !== void 0 && (this.canTrackVelocity = ho(this.current));
  }
...
var po = {
  ...
  duration: 0.3
}, yo = (e, { keyframes: t }) => t.length > 2 ? mo : Ke.has(e) ? e.startsWith("scale") ? fo(t[1]) : po : go, vo = /* @__PURE__ */ new Set([
  "when",
  "delay",
  "delayChildren",
  "staggerChildren",
...
function bo(e) {
  for (const t in e) if (!vo.has(t)) return !0;
  return !1;
}
var ar = (e, t, i, s = {}, r, n) => (a) => {
  ...
  bo(o) || Object.assign(h, yo(e, h)), h.duration && (h.duration = ee(h.duration)), h.repeatDelay && (h.repeatDelay = ee(h.repeatDelay)), h.from !== void 0 && (h.keyframes[0] = h.from);
  let d = !1;
  ...
  return o.isSync ? new Mt(h) : new oo(h);
...
var So = 4;
function or(e, t, i = 1) {
  de(i <= So, `Max CSS variable fallback depth detected in property "${e}". This may indicate a circular fallback dependency.`, "max-css-var-depth");
  const [s, r] = wo(e);
  if (!s) return;
...
function _o(e, t) {
  let { transitionEnd: i = {}, transition: s = {}, ...r } = Mo(e, t) || {};
  r = {
    ...r,
    ...i
  };
  for (const n in r) Co(e, n, Ao(r[n]));
}
...
var ko = "framerAppearId", Eo = "data-" + wi(ko);
function zo(e) {
  return e.props[Eo];
}
function Vo({ protectedKeys: e, needsAnimating: t }, i) {
  const s = e.hasOwnProperty(i) && t[i] !== !0;
  return t[i] = !1, s;
}
function Do(e, t, { delay: i = 0, transitionOverride: s, type: r } = {}) {
...
var Oo = /\b([a-z-]*)\(.*?\)/gu, Jt = {
  ...
  mask: ei,
  WebkitMask: ei
}, dr = (e) => Lo[e], Wo = /* @__PURE__ */ new Set([Jt, ei]);
function pr(e, t) {
  let i = dr(e);
  return Wo.has(i) || (i = ae), i.getAnimatableNone ? i.getAnimatableNone(t) : void 0;
}
...
function $o(e, t, i) {
  ...
  for (; s < e.length && !r; ) {
    const n = e[s];
    typeof n == "string" && !Go.has(n) && Ie(n).values.length && (r = e[s]), s++;
  }
  if (r && i) for (const n of t) e[n] = pr(i, r);
}
var Ko = class extends bi {
  ...
  resolveNoneKeyframes() {
    ...
    for (let s = 0; s < e.length; s++) (e[s] === null || Fo(e[s])) && i.push(s);
    i.length && $o(e, i, t);
  }
  measureInitialState() {
...
var ti = (e, t) => t && typeof e == "number" ? t.transform(e) : e, { schedule: qo, cancel: Ec } = /* @__PURE__ */ Vs(queueMicrotask, !1);
function fr(e) {
  return In(e) && "ownerSVGElement" in e;
}
function Xo(e) {
...
function mr(e) {
  return Zo(e.animate) || tl.some((t) => Jo(e[t]));
}
function il(e) {
...
var ii = { current: null }, gr = { current: !1 }, rl = typeof window < "u";
function nl() {
  if (gr.current = !0, !!rl)
...
var as = [
  ...
  constructor({ parent: e, props: t, presenceContext: i, reducedMotionConfig: s, skipAnimations: r, blockInitialAnimation: n, visualState: a }, o = {}) {
    ...
    this.latestValues = l, this.baseTarget = { ...l }, this.initialValues = t.initial ? { ...l } : {}, this.renderState = c, this.parent = e, this.props = t, this.presenceContext = i, this.depth = e ? e.depth + 1 : 0, this.reducedMotionConfig = s, this.skipAnimationsConfig = r, this.options = o, this.blockInitialAnimation = !!n, this.isControllingVariants = mr(t), this.isVariantNode = il(t), this.isVariantNode && (this.variantChildren = /* @__PURE__ */ new Set()), this.manuallyAnimateOnMount = !!(e && e.current);
  ...
  update(e, t) {
    ...
    this.prevMotionValues = sl(this, this.scrapeMotionValuesFromProps(e, this.prevProps || {}, this), this.prevMotionValues), this.handleChildMotionValue && this.handleChildMotionValue();
  }
  getProps() {
    return this.props;
  }
  ...
  readValue(e, t) {
    ...
    return i != null && (typeof i == "string" && (ys(i) || vs(i)) ? i = parseFloat(i) : !Qo(i) && ae.test(t) && (i = pr(e, t)), this.setBaseTarget(e, H(i) ? i.get() : i)), H(i) ? i.get() : i;
  }
  setBaseTarget(e, t) {
    this.baseTarget[e] = t;
  }
...
function al({ top: e, left: t, right: i, bottom: s }) {
  return {
    x: {
      min: t,
      max: i
...
function ll(e, t) {
  return al(ol(e.getBoundingClientRect(), t));
}
var cl = {
  x: "translateX",
  y: "translateY",
...
function br(e, t, i) {
  ...
  if (t.transform || (a || i ? s.transform = ul(t, e.transform, i) : s.transform && (s.transform = "none")), o) {
...
} }, dl = { correct: (e, { treeScale: t, projectionDelta: i }) => {
...
function fl(e, { layout: t, layoutId: i }) {
  return Ke.has(e) || e.startsWith("origin") || (t || i !== void 0) && (!!pl[e] || e === "opacity");
}
function wr(e, t, i) {
  const s = e.style, r = t?.style, n = {};
  if (!s) return n;
  for (const a in s) (H(s[a]) || r && H(r[a]) || fl(a, e) || i?.getValue(a)?.liveStyle !== void 0) && (n[a] = s[a]);
  return n;
}
function ml(e) {
  return window.getComputedStyle(e);
}
var gl = class extends vr {
  constructor() {
  ...
  readValueFromInstance(e, t) {
    if (Ke.has(t)) return this.projection?.isProjecting ? jt(t) : Oa(e, t);
    {
      const i = ml(e), s = (Rs(t) ? i.getPropertyValue(t) : i[t]) || 0;
...
function Ml(e, { attrX: t, attrY: i, attrScale: s, pathLength: r, pathSpacing: n = 1, pathOffset: a = 0, ...o }, l, c, h) {
  if (br(e, o, c), l) {
  ...
  for (const y of Sl) d[y] !== void 0 && (u[y] = d[y], delete d[y]);
  t !== void 0 && (d.x = t), i !== void 0 && (d.y = i), s !== void 0 && (d.scale = s), r !== void 0 && wl(d, r, n, a, !1);
}
var Sr = /* @__PURE__ */ new Set([
  "baseFrequency",
  "diffuseConstant",
...
var _l = class extends vr {
  ...
  build(e, t, i) {
    Ml(e, t, this.isSVGTag, i.transformTemplate, i.style);
  }
...
function Mr(e, t, i, s) {
  return e == null ? [] : typeof e == "string" && Mi(t) ? jo(e, i, s) : e instanceof NodeList ? Array.from(e) : Array.isArray(e) ? e.filter((r) => r != null) : [e];
}
function Bl(e, t, i) {
  return e * (t + 1) + i * t;
}
...
var Dl = "easeInOut", zt = 20;
function Rl(e, { defaultTransition: t = {}, ...i } = {}, s, r) {
  ...
  for (let y = 0; y < e.length; y++) {
    ...
    const S = (w, A, b, x = 0, C = 0) => {
      const M = Fl(w), { delay: B = 0, times: T = js(M), type: V = t.type || "keyframes", repeat: z, repeatType: D, repeatDelay: L = 0, ...E } = A;
      ...
      const me = Pe + R;
      El(b, M, W, T, Pe, me), _ = Math.max(j + R, _), u = Math.max(me, u);
    };
    if (H(g)) {
      const w = hs(g, o);
      S(m, v, us("default", w));
      ...
      for (let b = 0; b < A; b++) {
        ...
        for (const M in m) S(m[M], Il(v, M), us(M, C), b, A);
      }
    }
    h = d, d += _;
  }
  return o.forEach((y, p) => {
    for (const g in y) {
      ...
      _[0] !== 0 && (_.unshift(0), v.unshift(v[0]), S.unshift(Dl)), _[_.length - 1] !== 1 && (_.push(1), v.push(null)), a.has(p) || a.set(p, {
        keyframes: {},
        transition: {}
      });
      const w = a.get(p);
...
var Nl = (e) => typeof e == "number", Ol = (e) => e.every(Nl);
function Ul(e) {
  const t = {
...
function Tr(e, t, i, s) {
  const r = [];
  if (Wl(e, t)) r.push(Pl(e, Mi(t) && t.default || t, i && (i.default || i)));
  else {
    if (e == null) return r;
    const n = Mr(e, t, s), a = n.length;
    de(!!a, "No valid elements provided.", "no-valid-elements");
    for (let o = 0; o < a; o++) {
      const l = n[o], c = l instanceof Element ? Ul : Ll;
      at.has(l) || c(l);
      const h = at.get(l), d = { ...i };
      "delay" in d && typeof d.delay == "function" && (d.delay = d.delay(o, a)), r.push(...Do(h, {
        ...t,
        transition: d
      }, {}));
    }
...
function Kl(e = {}) {
  ...
  function r(n, a, o) {
    let l = [], c;
    const h = {};
    if (i !== void 0 && (h.reduceMotion = i), s !== void 0 && (h.skipAnimations = s), $l(n)) {
      const { onComplete: u, ...y } = a || {};
      typeof u == "function" && (c = u), l = Gl(n, {
        ...h,
        ...y
      }, t);
    } else {
...
var Hl = Kl(), zc = class {
  ...
  sceneObstacles = [];
  constructor(e = {}) {
    this.config = e, this.save = new zn(e.gameId || "default"), this.scenes = new Vn(this), this.cutscene = new Rn(this), this.videoTimeline = new Fi(this), this.debugRenderer = new En(this), this.engine = new Xr(), this.world = new Zr(), this.physics = new Jr(), this.physics.gravity = e.gravity ? new k(...e.gravity) : new k(0, -9.81, 0), this.scene = new f.Scene();
...
export {
  ...
  Tn as CinematicOverlayManager,
  Qe as Collider,
  K as ColliderType,
  F as Color,
  Ee as CustomShaderMaterial,
  et as CutsceneAbortError,
  Dn as CutsceneContext,
  Rn as CutsceneManager,
  Pn as DebugInspector,
  En as DebugRenderer,
  Cn as DefaultTheme,
  Rc as EasyScript,
  Xr as Engine,
  ...
  Kc as EventPriority,
  rc as FastSoAWorld,
  fc as FrustumCulling,
  Mn as GlobalAudio,
  je as GlobalCinematicOverlay,
  Bn as GlobalDebugInspector,
  Jl as GlobalEventBus,
  Cr as GlobalEvents,
  wn as GlobalInput,
  _n as GlobalUI,
  xn as InputManager,
  ...
  sc as Query,
  Ei as Ray,
  ac as RaycastVehicle,
  yn as RenderPipeline,
  lc as RenderQueue,
  ft as RigidBody,
  $ as RigidBodyType,
  oc as SHADER_PRESETS,
  zn as SaveSystem,
  qr as Scene,
  Vn as SceneManager,
  zi as SceneNode,
  kn as ScreenRecorder,
  ql as ScriptBehavior,
  Dc as ScriptRunner,
  Ic as SelectorNode,
  Fc as SequenceNode,
  Fe as Serializer,
  hc as ShaderGraphCompiler,
  tn as ShaderPresets,
  Yr as SharedEntityContext,
  Qr as SharedEntityContextManager,
  jl as SimplexNoise,
  dc as SkyboxSettings,
  nc as SpatialHashGrid3D,
  ...
  _c as createCloud,
  bc as createCone,
  vc as createCylinder,
  Mc as createDodecahedron,
  Tc as createGrassField,
  Sc as createIcosahedron,
  yc as createPlane,
  Ac as createRock,
  gc as createSphere,
  vn as createTerrain,
