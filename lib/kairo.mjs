...
var ec = class {
  ...
  setShaderPreset(t) {
    return this.customShaderMaterial = Zr.getPreset(t), this.isShaderMaterial = !0, this.name = `${this.customShaderMaterial.name}`, this.transparent = this.customShaderMaterial.transparent, this.wireframe = this.customShaderMaterial.wireframe, this.customShaderMaterial;
  }
  setCustomShader(t) {
...
${s}
...
}, en = new Lr(-1, 1, 1, -1, 0, 1), tn = class extends Br {
  constructor() {
  ...
  constructor(e) {
    this._mesh = new Fr(sn, e);
  }
  dispose() {
    this._mesh.geometry.dispose();
  }
  render(e) {
    e.render(this._mesh, en);
  }
  get material() {
  ...
  constructor(e, t) {
    ...
    this.renderTarget1 = t, this.renderTarget2 = t.clone(), this.renderTarget2.texture.name = "EffectComposer.rt2", this.writeBuffer = this.renderTarget1, this.readBuffer = this.renderTarget2, this.renderToScreen = !0, this.passes = [], this.copyPass = new rn(it), this.copyPass.material.blending = Dt, this.timer = new Hr();
  }
  swapBuffers() {
  ...
  render(e) {
    ...
    for (let s = 0, r = this.passes.length; s < r; s++) {
      ...
      if (n.enabled !== !1) {
        ...
        Di !== void 0 && (n instanceof Di ? i = !0 : n instanceof nn && (i = !1));
      }
    }
...
var cn = {
  ...
  enabled = !1;
  constructor(e, t, i) {
    this.renderer = e, this.scene = t, this.camera = i, this.composer = new an(e), this.renderPass = new on(t, i), this.composer.addPass(this.renderPass), this.pixelatedPass = new un(6, t, i), this.pixelatedPass.enabled = !1, this.composer.addPass(this.pixelatedPass), this.outlinePass = new ai(new f.Vector2(window.innerWidth, window.innerHeight), t, i), this.outlinePass.edgeStrength = 3, this.outlinePass.edgeGlow = 0.5, this.outlinePass.edgeThickness = 1, this.outlinePass.visibleEdgeColor.set("#ffffff"), this.outlinePass.hiddenEdgeColor.set("#222222"), this.outlinePass.enabled = !1, this.composer.addPass(this.outlinePass), this.bloomPass = new ni(new f.Vector2(window.innerWidth, window.innerHeight), 1.5, 0.4, 0.85), this.bloomPass.enabled = !1, this.composer.addPass(this.bloomPass), this.filmPass = new hn(), this.filmPass.enabled = !1, this.composer.addPass(this.filmPass), this.outputPass = new dn(), this.composer.addPass(this.outputPass), window.addEventListener("resize", () => {
  ...
  fpsTimer = 0;
  constructor(e, t, i) {
    this.renderer = e, this.scene = t, this.camera = i, this.postProcessing = new pn(this.renderer, this.scene, this.camera), this.setupRendererDefaults();
  }
...
function vc(e = {}) {
  const t = e.size ?? 100, i = e.segments ?? 128, s = e.seed ?? 1337, r = e.amplitude ?? 6, n = e.frequency ?? 0.08, a = e.octaves ?? 5, o = e.persistence ?? 0.5, l = e.position ?? [
    ...
    0,
    0
  ], c = new Gl(s), h = new f.PlaneGeometry(t, t, i, i);
  h.rotateX(-Math.PI / 2);
...
<body>
  ...
  async play(e) {
    this.stop(), this.activeContext = new kn(this.app);
    try {
...
var xe = {}, ys = (e) => /^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(e), Vn = (e) => typeof e == "object" && e !== null, vs = (e) => /^0[^.\s]+$/u.test(e);
// @__NO_SIDE_EFFECTS__
function bs(e) {
  let t;
...
var Le = /* @__NO_SIDE_EFFECTS__ */ (e) => e, li = (...e) => e.reduce((t, i) => (s) => i(t(s))), ci = /* @__NO_SIDE_EFFECTS__ */ (e, t, i) => {
  ...
  add(e) {
    return zn(this.subscriptions, e), () => oi(this.subscriptions, e);
  }
  notify(e, t, i) {
...
function Vs(e, t) {
  ...
  const r = {
    ...
    timestamp: 0,
    isProcessing: !1
  }, n = () => i = !0, a = gt.reduce((S, w) => (S[w] = Wn(n), S), {}), { setup: o, read: l, resolveKeyframes: c, preUpdate: h, update: d, preRender: u, render: y, postRender: p } = a, g = () => {
    const S = xe.useManualTiming, w = S ? r.timestamp : performance.now();
    i = !1, S || (r.delta = s ? 1e3 / 60 : Math.max(Math.min(w - r.timestamp, Gn), 1)), r.timestamp = w, r.isProcessing = !0, o.process(r), l.process(r), c.process(r), h.process(r), d.process(r), u.process(r), y.process(r), p.process(r), r.isProcessing = !1, i && t && (s = !1, e(g));
  }, m = () => {
...
var { schedule: oe, cancel: Ut, state: wt, steps: Cc } = /* @__PURE__ */ Vs(typeof requestAnimationFrame < "u" ? requestAnimationFrame : Le, !0), vt;
function $n() {
  vt = void 0;
}
var J = {
  ...
  set: (e) => {
    vt = e, queueMicrotask($n);
  }
}, Ds = (e) => (t) => typeof t == "string" && t.startsWith(e), Rs = /* @__PURE__ */ Ds("--"), Kn = /* @__PURE__ */ Ds("var(--"), pi = (e) => Kn(e) ? Hn.test(e.split("/*")[0].trim()) : !1, Hn = /var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu;
function Ui(e) {
...
var qn = /^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu, mi = (e, t) => (i) => !!(typeof i == "string" && qn.test(i) && i.startsWith(e) || t && !jn(i) && Object.prototype.hasOwnProperty.call(i, t)), Fs = (e, t, i) => (s) => {
...
var Lt = {
  ...
  parse: parseFloat,
  transform: (t) => `${t}${e}`
}), ce = /* @__PURE__ */ lt("deg"), De = /* @__PURE__ */ lt("%"), P = /* @__PURE__ */ lt("px"), Qn = /* @__PURE__ */ lt("vh"), Zn = /* @__PURE__ */ lt("vw"), Li = {
  ...De,
...
function ea(e) {
  return isNaN(e) && typeof e == "string" && (e.match(fi)?.length || 0) + (e.match(Jn)?.length || 0) > 0;
}
var Is = "number", Ns = "color", ta = "var", ia = "var(", Wi = "${}", sa = /var\s*\(\s*--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)|#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\)|-?(?:\d+(?:\.\d+)?|\.\d+)/giu;
function Ie(e) {
  ...
  return {
    values: i,
    split: t.replace(sa, (a) => (O.test(a) ? (s.color.push(n), r.push(Ns), i.push(O.parse(a))) : a.startsWith(ia) ? (s.var.push(n), r.push(ta), i.push(a)) : (s.number.push(n), r.push(Is), i.push(parseFloat(a))), ++n, Wi)).split(Wi),
    indexes: s,
    types: r
  };
}
...
var aa = (e) => typeof e == "number" ? 0 : O.test(e) ? O.getAnimatableNone(e) : e, oa = (e, t) => typeof e == "number" ? t?.trim().endsWith("/") ? e : 0 : aa(e);
function la(e) {
  const t = Ie(e);
  return Os(t)(t.values.map((i, s) => oa(i, t.split[s])));
}
var ae = {
  test: ea,
  parse: ra,
...
function ca({ hue: e, saturation: t, lightness: i, alpha: s }) {
  e /= 360, t /= 100, i /= 100;
  let r = 0, n = 0, a = 0;
  if (!t) r = n = a = i;
  else {
...
function gi(e) {
  return typeof e == "number" ? pa : typeof e == "string" ? pi(e) ? St : O.test(e) ? $i : ga : Array.isArray(e) ? Us : typeof e == "object" ? O.test(e) ? $i : fa : St;
}
function Us(e, t) {
...
var ga = (e, t) => {
  ...
  return s.indexes.var.length === r.indexes.var.length && s.indexes.color.length === r.indexes.color.length && s.indexes.number.length >= r.indexes.number.length ? Wt.has(e) && !r.values.length || Wt.has(t) && !s.values.length ? da(e, t) : li(Us(ma(s, r), r.values), i) : (Ue(!0, `Complex values '${e}' and '${t}' too different to mix. Ensure all colors are of the same type, and that each contains the same quantity of number and color values. Falling back to instant transition.`, "complex-values-different"), St(e, t));
};
function Ls(e, t, i) {
...
function ba(e, t, i) {
  let s = i;
  for (let r = 1; r < va; r++) s = s - e(s) / t(s);
  return s;
}
var Ki = 1e-3;
function xa({ duration: e = N.duration, bounce: t = N.bounce, velocity: i = N.velocity, mass: s = N.mass }) {
  let r, n;
...
function nt(e = N.visualDuration, t = N.bounce) {
  ...
  const n = i.keyframes[0], a = i.keyframes[i.keyframes.length - 1], o = {
    ...
    value: n
  }, { stiffness: l, damping: c, mass: h, duration: d, velocity: u, isResolvedFromDuration: y } = Ma({
    ...i,
...
function Aa(e, t, { clamp: i = !0, ease: s, mixer: r } = {}) {
  const n = e.length;
  ...
  const o = Ca(t, s, r), l = o.length, c = (h) => {
...
function Ve({ duration: e = 300, keyframes: t, times: i, ease: s = "easeInOut" }) {
  const r = ks(s) ? s.map(Oi) : Oi(s), n = {
    ...
    value: t[0]
  }, a = Aa(_a(i && i.length === t.length ? i : js(t), e), t, { ease: Array.isArray(r) ? r : Pa(t, r) });
  return {
...
function At(e, { repeat: t, repeatType: i = "loop" }, s, r = 1) {
  const n = e.filter(Ba), a = r < 0 || t && i !== "loop" && t % 2 === 1 ? 0 : n.length - 1;
...
function qs(e) {
  typeof e.type == "string" && (e.type = ka[e.type]);
}
var vi = class {
  constructor() {
    this.updateFinished();
...
}, Ea = (e) => e / 100, Mt = class extends vi {
  constructor(e) {
  ...
  initAnimation() {
    ...
    let { keyframes: a } = e;
    const o = t || Ve;
    process.env.NODE_ENV !== "production" && o !== Ve && de(a.length <= 2, `Only two keyframes currently supported with spring and inertia animations. Trying to animate ${a}`, "spring-two-frames"), o !== Ve && typeof a[0] != "number" && (this.mixKeyframes = li(Ea, Ls(a[0], a[1])), a = [0, 100]);
    const l = o({
      ...e,
      keyframes: a
    });
  ...
  play() {
    ...
    const { driver: e = ya, startTime: t } = this.options;
...
}, Ht = (e) => (e = e % 360, e < 0 && (e += 360), e), ji = Kt, qi = (e) => Math.sqrt(e[0] * e[0] + e[1] * e[1]), Xi = (e) => Math.sqrt(e[4] * e[4] + e[5] * e[5]), Da = {
  x: 12,
  y: 13,
  z: 14,
  translateX: 12,
...
function qt(e, t) {
  ...
  if (!r) return jt(t);
  const n = s[t], a = r[1].split(",").map(Fa);
...
var $e = [
  ...
  "skewX",
  "skewY"
], Ke = /* @__PURE__ */ new Set([...$e, "pathRotation"]), Yi = (e) => e === We || e === P, Ia = /* @__PURE__ */ new Set([
  "x",
  "y",
  "z"
]), Na = $e.filter((e) => !Ia.has(e));
function Oa(e) {
  const t = [];
  return Na.forEach((i) => {
...
function Qs(e, t, i) {
  La(t) ? e.style.setProperty(t, i) : e.style[t] = i;
}
var Wa = {};
function Zs(e, t) {
...
var Ga = /* @__PURE__ */ Zs(() => window.ScrollTimeline !== void 0, "scrollTimeline"), Js = /* @__PURE__ */ Zs(() => {
  try {
...
function $a(e, t, i, { delay: s = 0, duration: r = 300, repeat: n = 0, repeatType: a = "loop", ease: o = "easeOut", times: l } = {}, c = void 0) {
  const h = { [t]: i };
  l && (h.offset = l);
  const d = er(o, r);
...
var tr = class extends vi {
  constructor(e) {
    ...
    const l = Ka(e);
    this.animation = $a(t, i, s, l, r), l.autoplay === !1 && this.animation.pause(), this.animation.onfinish = () => {
  ...
  attachTimeline({ timeline: e, rangeStart: t, rangeEnd: i, observe: s }) {
    return this.allowFlatten && this.animation.effect?.updateTiming({ easing: "linear" }), this.animation.onfinish = null, e && Ga() ? (this.animation.timeline = e, t && (this.animation.rangeStart = t), i && (this.animation.rangeEnd = i), Le) : s(this);
  }
}, ir = {
  anticipate: _s,
  backInOut: As,
...
function ja(e) {
  typeof e.ease == "string" && Ha(e.ease) && (e.ease = ir[e.ease]);
}
var Et = 10, qa = class extends tr {
  constructor(e) {
    ja(e), qs(e), super(e), e.startTime !== void 0 && e.autoplay !== !1 && (this.startTime = e.startTime), this.options = e;
  }
  updateMotionValue(e) {
...
function Ya(e, t, i, s) {
  ...
  return Ue(a === o, `You are trying to animate ${t} from "${r}" to "${n}". "${a ? n : r}" is not an animatable value.`, "value-not-animatable"), !a || !o ? !1 : Xa(e) || (i === "spring" || xi(i)) && s;
}
function Zt(e) {
...
var sr = /* @__PURE__ */ new Set([
  ...
  "transform",
  "backgroundColor"
]), Qa = /^(?:oklch|oklab|lab|lch|color|color-mix|light-dark)\(/;
function Za(e) {
  for (let t = 0; t < e.length; t++) if (typeof e[t] == "string" && Qa.test(e[t])) return !0;
  return !1;
}
var Ja = /* @__PURE__ */ new Set([
  ...
  "borderBottomColor",
  "borderLeftColor"
]), eo = /* @__PURE__ */ bs(() => Object.hasOwnProperty.call(Element.prototype, "animate"));
function to(e) {
  ...
  return eo() && i && (sr.has(i) || Ja.has(i) && Za(o)) && (i !== "transform" || !h) && !c && !s && r !== "mirror" && n !== 0 && a !== "inertia";
}
var io = 40, so = class extends vi {
  ...
  onKeyframesResolved(e, t, i, s) {
    ...
    let h = !0;
    Ya(e, r, n, a) || (h = !1, (xe.instantAnimations || !o) && c?.(At(e, i, t)), e[0] = e[e.length - 1], Zt(i), i.repeat = 0);
    const d = {
      startTime: s ? this.resolvedAt ? this.resolvedAt - this.createdAt > io ? this.resolvedAt : this.createdAt : this.createdAt : void 0,
      finalKeyframe: t,
      ...i,
      keyframes: e
    }, u = h && !l && to(d), y = d.motionValue?.owner?.current;
    let p;
    if (u) try {
      p = new qa({
        ...d,
  ...
  get animation() {
    return this._animation || (this.keyframeResolver?.resume(), Ua()), this._animation;
  }
  get duration() {
...
var no = class extends ro {
...
}, es = 30, ao = (e) => !isNaN(parseFloat(e)), ts = { current: void 0 }, oo = class {
  constructor(e, t = {}) {
  ...
  setCurrent(e) {
    this.current = e, this.updatedAt = J.now(), this.canTrackVelocity === null && e !== void 0 && (this.canTrackVelocity = ao(this.current));
  }
...
var lo = {
  ...
  duration: 0.3
}, po = (e, { keyframes: t }) => t.length > 2 ? ho : Ke.has(e) ? e.startsWith("scale") ? co(t[1]) : lo : uo, fo = /* @__PURE__ */ new Set([
  "when",
  "delay",
  "delayChildren",
  "staggerChildren",
...
function mo(e) {
  for (const t in e) if (!fo.has(t)) return !0;
  return !1;
}
var ar = (e, t, i, s = {}, r, n) => (a) => {
  ...
  mo(o) || Object.assign(h, po(e, h)), h.duration && (h.duration = ee(h.duration)), h.repeatDelay && (h.repeatDelay = ee(h.repeatDelay)), h.from !== void 0 && (h.keyframes[0] = h.from);
  let d = !1;
  ...
  return o.isSync ? new Mt(h) : new so(h);
...
var vo = 4;
function or(e, t, i = 1) {
  de(i <= vo, `Max CSS variable fallback depth detected in property "${e}". This may indicate a circular fallback dependency.`, "max-css-var-depth");
  const [s, r] = yo(e);
  if (!s) return;
...
function Mo(e, t) {
  let { transitionEnd: i = {}, transition: s = {}, ...r } = bo(e, t) || {};
  r = {
    ...r,
    ...i
  };
  for (const n in r) wo(e, n, So(r[n]));
}
...
var Ao = "framerAppearId", _o = "data-" + wi(Ao);
function Po(e) {
  return e.props[_o];
}
function Bo({ protectedKeys: e, needsAnimating: t }, i) {
  const s = e.hasOwnProperty(i) && t[i] !== !0;
  return t[i] = !1, s;
}
function ko(e, t, { delay: i = 0, transitionOverride: s, type: r } = {}) {
...
var Ro = /\b([a-z-]*)\(.*?\)/gu, Jt = {
  ...
  mask: ei,
  WebkitMask: ei
}, dr = (e) => Io[e], No = /* @__PURE__ */ new Set([Jt, ei]);
function pr(e, t) {
  let i = dr(e);
  return No.has(i) || (i = ae), i.getAnimatableNone ? i.getAnimatableNone(t) : void 0;
}
...
function Uo(e, t, i) {
  ...
  for (; s < e.length && !r; ) {
    const n = e[s];
    typeof n == "string" && !Oo.has(n) && Ie(n).values.length && (r = e[s]), s++;
  }
  if (r && i) for (const n of t) e[n] = pr(i, r);
}
var Lo = class extends bi {
  ...
  resolveNoneKeyframes() {
    ...
    for (let s = 0; s < e.length; s++) (e[s] === null || zo(e[s])) && i.push(s);
    i.length && Uo(e, i, t);
  }
  measureInitialState() {
...
var ti = (e, t) => t && typeof e == "number" ? t.transform(e) : e, { schedule: $o, cancel: Ac } = /* @__PURE__ */ Vs(queueMicrotask, !1);
function fr(e) {
  return Vn(e) && "ownerSVGElement" in e;
}
function Ko(e) {
...
function mr(e) {
  return qo(e.animate) || Qo.some((t) => Xo(e[t]));
}
function Zo(e) {
...
var ii = { current: null }, gr = { current: !1 }, el = typeof window < "u";
function tl() {
  if (gr.current = !0, !!el)
...
var as = [
  ...
  constructor({ parent: e, props: t, presenceContext: i, reducedMotionConfig: s, skipAnimations: r, blockInitialAnimation: n, visualState: a }, o = {}) {
    ...
    this.latestValues = l, this.baseTarget = { ...l }, this.initialValues = t.initial ? { ...l } : {}, this.renderState = c, this.parent = e, this.props = t, this.presenceContext = i, this.depth = e ? e.depth + 1 : 0, this.reducedMotionConfig = s, this.skipAnimationsConfig = r, this.options = o, this.blockInitialAnimation = !!n, this.isControllingVariants = mr(t), this.isVariantNode = Zo(t), this.isVariantNode && (this.variantChildren = /* @__PURE__ */ new Set()), this.manuallyAnimateOnMount = !!(e && e.current);
  ...
  readValue(e, t) {
    ...
    return i != null && (typeof i == "string" && (ys(i) || vs(i)) ? i = parseFloat(i) : !jo(i) && ae.test(t) && (i = pr(e, t)), this.setBaseTarget(e, H(i) ? i.get() : i)), H(i) ? i.get() : i;
  }
  setBaseTarget(e, t) {
    this.baseTarget[e] = t;
  }
...
function il({ top: e, left: t, right: i, bottom: s }) {
  return {
    x: {
      min: t,
      max: i
...
function rl(e, t) {
  return il(sl(e.getBoundingClientRect(), t));
}
var nl = {
  x: "translateX",
  y: "translateY",
...
function br(e, t, i) {
  ...
  if (t.transform || (a || i ? s.transform = ol(t, e.transform, i) : s.transform && (s.transform = "none")), o) {
...
} }, ll = { correct: (e, { treeScale: t, projectionDelta: i }) => {
...
function hl(e, { layout: t, layoutId: i }) {
  return Ke.has(e) || e.startsWith("origin") || (t || i !== void 0) && (!!cl[e] || e === "opacity");
}
function wr(e, t, i) {
  const s = e.style, r = t?.style, n = {};
  if (!s) return n;
  for (const a in s) (H(s[a]) || r && H(r[a]) || hl(a, e) || i?.getValue(a)?.liveStyle !== void 0) && (n[a] = s[a]);
  return n;
}
function ul(e) {
  return window.getComputedStyle(e);
}
var dl = class extends vr {
  constructor() {
  ...
  readValueFromInstance(e, t) {
    if (Ke.has(t)) return this.projection?.isProjecting ? jt(t) : Ra(e, t);
    {
      const i = ul(e), s = (Rs(t) ? i.getPropertyValue(t) : i[t]) || 0;
...
function bl(e, { attrX: t, attrY: i, attrScale: s, pathLength: r, pathSpacing: n = 1, pathOffset: a = 0, ...o }, l, c, h) {
  if (br(e, o, c), l) {
  ...
  for (const y of vl) d[y] !== void 0 && (u[y] = d[y], delete d[y]);
  t !== void 0 && (d.x = t), i !== void 0 && (d.y = i), s !== void 0 && (d.scale = s), r !== void 0 && yl(d, r, n, a, !1);
}
var Sr = /* @__PURE__ */ new Set([
  "baseFrequency",
  "diffuseConstant",
...
var Ml = class extends vr {
  ...
  build(e, t, i) {
    bl(e, t, this.isSVGTag, i.transformTemplate, i.style);
  }
...
function Mr(e, t, i, s) {
  return e == null ? [] : typeof e == "string" && Mi(t) ? Go(e, i, s) : e instanceof NodeList ? Array.from(e) : Array.isArray(e) ? e.filter((r) => r != null) : [e];
}
function Cl(e, t, i) {
  return e * (t + 1) + i * t;
}
...
var kl = "easeInOut", zt = 20;
function El(e, { defaultTransition: t = {}, ...i } = {}, s, r) {
  ...
  for (let y = 0; y < e.length; y++) {
    ...
    const S = (w, A, b, x = 0, C = 0) => {
      const M = zl(w), { delay: B = 0, times: T = js(M), type: V = t.type || "keyframes", repeat: z, repeatType: D, repeatDelay: L = 0, ...E } = A;
      ...
      const me = Pe + R;
      _l(b, M, W, T, Pe, me), _ = Math.max(j + R, _), u = Math.max(me, u);
    };
    if (H(g)) {
      const w = hs(g, o);
      S(m, v, us("default", w));
      ...
      for (let b = 0; b < A; b++) {
        ...
        for (const M in m) S(m[M], Vl(v, M), us(M, C), b, A);
      }
    }
    h = d, d += _;
  }
  return o.forEach((y, p) => {
    for (const g in y) {
      ...
      _[0] !== 0 && (_.unshift(0), v.unshift(v[0]), S.unshift(kl)), _[_.length - 1] !== 1 && (_.push(1), v.push(null)), a.has(p) || a.set(p, {
        keyframes: {},
        transition: {}
      });
      const w = a.get(p);
...
var Dl = (e) => typeof e == "number", Rl = (e) => e.every(Dl);
function Fl(e) {
  const t = {
...
function Tr(e, t, i, s) {
  const r = [];
  if (Nl(e, t)) r.push(Tl(e, Mi(t) && t.default || t, i && (i.default || i)));
  else {
    if (e == null) return r;
    const n = Mr(e, t, s), a = n.length;
    de(!!a, "No valid elements provided.", "no-valid-elements");
    for (let o = 0; o < a; o++) {
      const l = n[o], c = l instanceof Element ? Fl : Il;
      at.has(l) || c(l);
      const h = at.get(l), d = { ...i };
      "delay" in d && typeof d.delay == "function" && (d.delay = d.delay(o, a)), r.push(...ko(h, {
        ...t,
        transition: d
      }, {}));
    }
...
function Ll(e = {}) {
  ...
  function r(n, a, o) {
    let l = [], c;
    const h = {};
    if (i !== void 0 && (h.reduceMotion = i), s !== void 0 && (h.skipAnimations = s), Ul(n)) {
      const { onComplete: u, ...y } = a || {};
      typeof u == "function" && (c = u), l = Ol(n, {
        ...h,
        ...y
      }, t);
    } else {
...
var Wl = Ll(), _c = class {
  ...
  sceneObstacles = [];
  constructor(e = {}) {
    this.config = e, this.save = new Pn(e.gameId || "default"), this.scenes = new Bn(this), this.cutscene = new En(this), this.videoTimeline = new Fi(this), this.debugRenderer = new _n(this), this.engine = new Xr(), this.physics = new Yr(), this.physics.gravity = e.gravity ? new k(...e.gravity) : new k(0, -9.81, 0), this.scene = new f.Scene();
    ...
    this.cameraController = new Jr(this.camera), this.pipeline = new fn(this.renderer, this.scene, this.camera), e.shadows !== !1 && this.pipeline.setupLighting({}), window.addEventListener("resize", () => {
...
export {
  ...
  Lc as BlendTree1D,
  fs as BoundingBox,
  Jr as CameraController,
  Pc as CellularAutomata,
  xn as CinematicOverlayManager,
  Qe as Collider,
  K as ColliderType,
  F as Color,
  Ee as CustomShaderMaterial,
  et as CutsceneAbortError,
  kn as CutsceneContext,
  En as CutsceneManager,
  Tn as DebugInspector,
  _n as DebugRenderer,
  wn as DefaultTheme,
  kc as EasyScript,
  Xr as Engine,
  Tc as EngineCompiler,
  ye as EngineState,
  ...
  Kc as EventPriority,
  Rc as FastSoAWorld,
  lc as FrustumCulling,
  bn as GlobalAudio,
  je as GlobalCinematicOverlay,
  Cn as GlobalDebugInspector,
  Ql as GlobalEventBus,
  Cr as GlobalEvents,
  yn as GlobalInput,
  Mn as GlobalUI,
  gn as InputManager,
  ...
  Zl as ObjectPool,
  ct as PRNG,
  oc as ParticleSystem,
  Oc as PathfindingGrid,
  Yr as PhysicsWorld,
  pn as PostProcessManager,
  si as Quaternion,
  Vc as Query,
  Ei as Ray,
  ec as RaycastVehicle,
  fn as RenderPipeline,
  ic as RenderQueue,
  ft as RigidBody,
  $ as RigidBodyType,
  tc as SHADER_PRESETS,
  Pn as SaveSystem,
  qr as Scene,
  Bn as SceneManager,
  zi as SceneNode,
  An as ScreenRecorder,
  $l as ScriptBehavior,
  Bc as ScriptRunner,
  Ic as SelectorNode,
  Fc as SequenceNode,
  Fe as Serializer,
  rc as ShaderGraphCompiler,
  Zr as ShaderPresets,
  Kl as SharedEntityContext,
  Hl as SharedEntityContextManager,
  Gl as SimplexNoise,
  ac as SkyboxSettings,
  Jl as SpatialHashGrid3D,
  ...
  Sc as createCloud,
  pc as createCone,
  dc as createCylinder,
  yc as createDodecahedron,
  bc as createGrassField,
  gc as createIcosahedron,
  uc as createPlane,
  wc as createRock,
  hc as createSphere,
  vc as createTerrain,
