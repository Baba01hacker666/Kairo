...
import { ACESFilmicToneMapping as _r, AdditiveBlending as ds, AgXToneMapping as Pr, BufferGeometry as Br, CineonToneMapping as kr, Color as he, ColorManagement as Er, CustomToneMapping as zr, DepthTexture as Vr, DoubleSide as Pi, Float32BufferAttribute as Bi, HalfFloatType as se, LinearToneMapping as Dr, Matrix4 as Rr, Mesh as Fr, MeshBasicMaterial as Ir, MeshDepthMaterial as Nr, MeshNormalMaterial as Or, NearestFilter as dt, NeutralToneMapping as Ur, NoBlending as Dt, OrthographicCamera as Lr, RGBADepthPacking as Wr, RawShaderMaterial as Gr, ReinhardToneMapping as $r, SRGBTransfer as Kr, ShaderMaterial as Z, Timer as Hr, UniformsUtils as Re, Vector2 as U, Vector3 as Te, Vector4 as jr, WebGLRenderTarget as Q } from "three";
...
var pt = class Rt {
  ...
  slerp(t, i) {
    ...
    if (r < 0 && (s = new Ft(-t.x, -t.y, -t.z, -t.w), r = -r), r >= 1) return this;
  ...
  compose(t, i, s) {
    const r = i.x, n = i.y, a = i.z, o = i.w, l = r + r, c = n + n, h = a + a, d = r * l, u = r * c, y = r * h, p = n * c, g = n * h, m = a * h, v = o * l, _ = o * c, S = o * h, w = s.x, A = s.y, b = s.z, x = this.elements;
    return x[0] = (1 - (p + m)) * w, x[1] = (u + S) * w, x[2] = (y - _) * w, x[3] = 0, x[4] = (u - S) * A, x[5] = (1 - (d + m)) * A, x[6] = (g + v) * A, x[7] = 0, x[8] = (y + _) * b, x[9] = (g - v) * b, x[10] = (1 - (d + p)) * b, x[11] = 0, x[12] = t.x, x[13] = t.y, x[14] = t.z, x[15] = 1, this;
  }
  multiplyMatrices(t, i) {
    const s = t.elements, r = i.elements, n = this.elements, a = s[0], o = s[4], l = s[8], c = s[12], h = s[1], d = s[5], u = s[9], y = s[13], p = s[2], g = s[6], m = s[10], v = s[14], _ = s[3], S = s[7], w = s[11], A = s[15], b = r[0], x = r[4], C = r[8], M = r[12], B = r[1], T = r[5], V = r[9], z = r[13], D = r[2], L = r[6], E = r[10], W = r[14], R = r[3], j = r[7], q = r[11], X = r[15];
    return n[0] = a * b + o * B + l * D + c * R, n[4] = a * x + o * T + l * L + c * j, n[8] = a * C + o * V + l * E + c * q, n[12] = a * M + o * z + l * W + c * X, n[1] = h * b + d * B + u * D + y * R, n[5] = h * x + d * T + u * L + y * j, n[9] = h * C + d * V + u * E + y * q, n[13] = h * M + d * z + u * W + y * X, n[2] = p * b + g * B + m * D + v * R, n[6] = p * x + g * T + m * L + v * j, n[10] = p * C + g * V + m * E + v * q, n[14] = p * M + g * z + m * W + v * X, n[3] = _ * b + S * B + w * D + A * R, n[7] = _ * x + S * T + w * L + A * j, n[11] = _ * C + S * V + w * E + A * q, n[15] = _ * M + S * z + w * W + A * X, this;
  }
  multiply(t) {
  ...
  intersectBox(t) {
    ...
    if (o > l && ([o, l] = [l, o]), n > l || o > a) return Ye._missResult;
    o > n && (n = o), l < a && (a = l);
    let c = (t.min.z - this.origin.z) / r, h = (t.max.z - this.origin.z) / r;
    if (c > h && ([c, h] = [h, c]), n > h || c > a) return Ye._missResult;
    c > n && (n = c);
    const d = new k(this.origin.x + this.direction.x * n, this.origin.y + this.direction.y * n, this.origin.z + this.direction.z * n), u = new k(), y = 0.01;
    return Math.abs(d.x - t.max.x) < y ? u.x = 1 : Math.abs(d.x - t.min.x) < y ? u.x = -1 : Math.abs(d.y - t.max.y) < y ? u.y = 1 : Math.abs(d.y - t.min.y) < y ? u.y = -1 : Math.abs(d.z - t.max.z) < y ? u.z = 1 : Math.abs(d.z - t.min.z) < y ? u.z = -1 : u.z = 1, {
      hasHit: n >= 0,
      distance: n,
      point: d,
      normal: u
  ...
  intersectSphere(t, i) {
    ...
    if (d > u) return Ye._missResult;
    const y = Math.sqrt(u - d);
    let p = h - y, g = h + y;
    if (p < 0 && (p = g), p < 0) return Ye._missResult;
  ...
  static deserialize(t) {
    ...
    for (const s of t.children || []) i.addChild(It.deserialize(s));
    return i;
  }
}, qr = class ms {
  ...
  static deserialize(t) {
    const i = Fe.deserialize(t), s = new ms(i.name);
  ...
  constructor() {
    this.activeScene = new qr("Main Scene");
  }
  start() {
  ...
  loop = (e) => {
    if (this.state === ye.Running) {
      for (Be.update(e), this.fixedUpdateAccumulator += Be.deltaTime; this.fixedUpdateAccumulator >= Be.fixedDeltaTime; )
        this.fixedUpdate(Be.fixedDeltaTime), this.fixedUpdateAccumulator -= Be.fixedDeltaTime;
      this.update(Be.deltaTime), this.render(), typeof requestAnimationFrame < "u" && (this.animationFrameId = requestAnimationFrame(this.loop));
    }
  };
  fixedUpdate(e) {
    ...
    try {
      ...
      for (const n of r) try {
        ...
        if (a.ok) {
          ...
          return G.wasmExports = l.instance.exports, G.isWasmLoaded = !0, console.log(`⚡ [FastSoAWorld] WASM Physics Kernel loaded successfully from ${n}`), !0;
        }
      } catch {
      }
    } catch (i) {
  ...
  static initSyncWasm(t) {
    try {
      ...
      return G.wasmExports = r.exports, G.isWasmLoaded = !0, !0;
    } catch (i) {
      return console.warn("[FastSoAWorld] WASM sync init failed:", i), !1;
    }
  }
  constructor(t = 5e4, i = 12) {
    if (this.maxEntities = t, this.gridCellSize = i, this.invCellSize = 1 / i, G.wasmExports) {
      const s = G.wasmExports, r = s.memory.buffer;
  ...
  spawnEntity(t, i, s, r, n, a, o = 0.5) {
    ...
    return this.posX[l] = t, this.posY[l] = i, this.posZ[l] = s, this.velX[l] = r, this.velY[l] = n, this.velZ[l] = a, this.radius[l] = o, this.active[l] = 1, this.isWasmMode && G.wasmExports && G.wasmExports.spawn_entity(l, t, i, s, r, n, a, o), l;
  }
  update(t, i = 60) {
    const s = this.activeCount;
    if (this.isWasmMode && G.wasmExports) return G.wasmExports.update(s, t, i);
    ...
    const y = this.invCellSize, p = this.gridTableMask, g = this.gridHead, m = this.gridTag, v = this.gridNext;
    for (let b = 0; b < s; b++) {
      if (d[b] === 0) continue;
      let x = r[b] + o[b] * t, C = n[b] + l[b] * t, M = a[b] + c[b] * t;
      x < -i ? (x = -i, o[b] = -o[b]) : x > i && (x = i, o[b] = -o[b]), C < -i ? (C = -i, l[b] = -l[b]) : C > i && (C = i, l[b] = -l[b]), M < -i ? (M = -i, c[b] = -c[b]) : M > i && (M = i, c[b] = -c[b]), r[b] = x, n[b] = C, a[b] = M;
      const B = x * y | 0, T = C * y | 0, V = M * y | 0, z = (B * 73856093 ^ T * 19349663 ^ V * 83492791) & p;
      m[z] !== u && (m[z] = u, g[z] = -1), v[b] = g[z], g[z] = b;
    }
    let _ = 0;
    const S = [
      0,
    ...
    for (let b = 0; b < s; b++) {
      if (d[b] === 0) continue;
      const x = r[b], C = n[b], M = a[b], B = h[b], T = x * y | 0, V = C * y | 0, z = M * y | 0;
      for (let D = 0; D < 14; D++) {
        const L = ((T + S[D]) * 73856093 ^ (V + w[D]) * 19349663 ^ (z + A[D]) * 83492791) & p;
        if (m[L] !== u) continue;
        let E = g[L];
        const W = D === 0;
        for (; E !== -1; ) {
          if ((!W || E > b) && d[E] !== 0) {
            ...
            const Pe = j * j + q * q + X * X;
            if (Pe < R * R && Pe > 1e-4) {
              _++;
              const we = Math.sqrt(Pe), me = j / we, te = q / we, ie = X / we, re = 0.5 * (R - we);
              r[b] -= me * re, n[b] -= te * re, a[b] -= ie * re, r[E] += me * re, n[E] += te * re, a[E] += ie * re;
              const Se = o[b] - o[E], ht = l[b] - l[E], ut = c[b] - c[E], le = me * Se + te * ht + ie * ut;
  ...
  getMemoryFootprintBytes() {
    if (this.isWasmMode && G.wasmExports) return G.wasmExports.memory.buffer.byteLength;
  ...
  clear() {
    this.activeCount = 0, this.active.fill(0), this.isWasmMode && G.wasmExports && G.wasmExports.clear_entities();
  }
}, $ = {
  Dynamic: "DYNAMIC",
  Static: "STATIC",
  ...
  getBoundingBox(e, t) {
    ...
    return t ? (t.min.set(e.x - i, e.y - s, e.z - r), t.max.set(e.x + i, e.y + s, e.z + r), t) : new fs(new k(e.x - i, e.y - s, e.z - r), new k(e.x + i, e.y + s, e.z + r));
  }
}, ft = class {
  type = $.Dynamic;
  mass = 1;
  ...
  get velocity() {
    return this.cannonBody ? xt(this.cannonBody.velocity) : new k();
  }
  set velocity(e) {
    this.cannonBody && this.cannonBody.velocity.set(e.x, e.y, e.z);
  }
  get angularVelocity() {
    return this.cannonBody ? xt(this.cannonBody.angularVelocity) : new k();
  }
  ...
  registerBody(t, i, s = new k()) {
    const r = t.type === $.Dynamic, n = t.type === $.Kinematic, a = new Y.Body({
  ...
  cancelGravityForNonGravityBodies() {
    ...
    for (const i of this.bodies) {
      ...
      s && i.body.type === $.Dynamic && !i.body.useGravity && (s.force.x -= i.body.mass * t.x, s.force.y -= i.body.mass * t.y, s.force.z -= i.body.mass * t.z);
    }
  }
  onCollision(t) {
  ...
  raycast(t, i, s = 100) {
    ...
    for (let o = 0; o < this.bodies.length; o++) {
      ...
      if (c.type === K.Sphere) {
        ...
        const u = c.getBoundingBox(h, ke._raycastTempBox);
        d = r.intersectBox(u);
      }
  ...
  overlapSphere(t, i) {
    ...
    for (let r = 0; r < this.bodies.length; r++) {
      ...
      if (a.type === K.Sphere) {
        ...
        const l = a.size.x * 0.5, c = a.size.y * 0.5, h = a.size.z * 0.5, d = _t(t.x, o.x - l, o.x + l), u = _t(t.y, o.y - c, o.y + c), y = _t(t.z, o.z - h, o.z + h), p = t.x - d, g = t.y - u, m = t.z - y;
        p * p + g * g + m * m <= i * i && s.push(n);
      }
    }
    return s;
  }
  overlapBox(t, i, s = !0) {
    const r = s ? i.x : i.x * 0.5, n = s ? i.y : i.y * 0.5, a = s ? i.z : i.z * 0.5, o = t.x - r, l = t.x + r, c = t.y - n, h = t.y + n, d = t.z - a, u = t.z + a, y = [];
    for (let p = 0; p < this.bodies.length; p++) {
      const { body: g, collider: m, position: v } = this.bodies[p];
      if (!g.cannonBody) continue;
      const _ = m.size.x * 0.5, S = m.size.y * 0.5, w = m.size.z * 0.5;
      l >= v.x - _ && o <= v.x + _ && h >= v.y - S && c <= v.y + S && u >= v.z - w && d <= v.z + w && y.push(g);
    }
    return y;
  }
  createShape(t) {
  ...
  syncKinematicAndStaticBodies() {
    for (const t of this.bodies) t.body.cannonBody && t.body.type !== $.Dynamic && t.body.cannonBody.position.set(t.position.x, t.position.y, t.position.z);
  }
  syncDynamicBodies() {
    for (const t of this.bodies) t.body.cannonBody && t.body.type === $.Dynamic && t.position.set(t.body.cannonBody.position.x, t.body.cannonBody.position.y, t.body.cannonBody.position.z);
  }
  ...
  toRaycastHit(t) {
    ...
    return {
      ...
      point: xt(t.hitPointWorld),
      normal: xt(t.hitNormalWorld),
      distance: t.distance
    };
  }
};
...
var nc = class {
  ...
  setShaderPreset(t) {
    return this.customShaderMaterial = tn.getPreset(t), this.isShaderMaterial = !0, this.name = `${this.customShaderMaterial.name}`, this.transparent = this.customShaderMaterial.transparent, this.wireframe = this.customShaderMaterial.wireframe, this.customShaderMaterial;
  }
  setCustomShader(t) {
  ...
  static compile(e) {
    ...
    let s = "", r = !1;
    const n = /* @__PURE__ */ new Map(), a = /* @__PURE__ */ new Set(), o = (d, u) => e.connections.find((y) => y.toNodeId === d && y.toPortId === u), l = (d) => {
      if (a.has(d)) return;
      a.add(d);
      ...
      const y = (p, g = "0.0") => {
        ...
        if (u.properties && u.properties[p] !== void 0) {
          ...
          return typeof v == "number" ? v.toFixed(3) : g;
        }
        return g;
      };
      switch (u.type) {
        ...
        case "space_conversion": {
          const p = u.properties?.mode || "localToWorld", g = y("in", "vLocalPosition"), m = `space_${u.id.replace(/[^a-zA-Z0-9_]/g, "_")}`;
...
`;
        ...
        case "matrix_transform": {
          const p = u.properties?.matrix || "modelMatrix", g = y("in", "vec4(vLocalPosition, 1.0)"), m = `matTx_${u.id.replace(/[^a-zA-Z0-9_]/g, "_")}`;
...
`;
        ...
        case "input_color": {
          const p = u.properties?.color || "#38bdf8", g = `u_color_${u.id.replace(/[^a-zA-Z0-9_]/g, "_")}`;
          t[g] = {
        ...
        case "input_float": {
          const p = u.properties?.value ?? 1, g = `u_float_${u.id.replace(/[^a-zA-Z0-9_]/g, "_")}`;
          t[g] = {
            value: p,
            type: "float"
          };
        ...
        case "input_noise": {
          r || (r = !0);
          const p = y("uv", "vUv"), g = y("scale", "8.0"), m = `noise_${u.id.replace(/[^a-zA-Z0-9_]/g, "_")}`;
          s += `  float ${m} = noise(${p} * ${g});
`;
          const v = u.outputs[0]?.id || "out";
          n.set(`${u.id}_${v}`, m);
        ...
        case "fresnel": {
          const p = y("power", "2.0"), g = `fresnel_${u.id.replace(/[^a-zA-Z0-9_]/g, "_")}`;
          s += `  vec3 V_${u.id} = normalize(cameraPosition - vWorldPosition);
`, s += `  float ${g} = pow(1.0 - max(dot(V_${u.id}, vWorldNormal), 0.0), ${p});
`;
          const m = u.outputs[0]?.id || "out";
          n.set(`${u.id}_${m}`, g);
          break;
        ...
        case "math_add": {
          const p = y("a", "0.0"), g = y("b", "0.0"), m = `add_${u.id.replace(/[^a-zA-Z0-9_]/g, "_")}`;
          s += `  vec4 ${m} = vec4(${p}) + vec4(${g});
`;
          const v = u.outputs[0]?.id || "out";
          n.set(`${u.id}_${v}`, `${m}`);
          break;
        ...
        case "math_multiply": {
          const p = y("a", "1.0"), g = y("b", "1.0"), m = `mul_${u.id.replace(/[^a-zA-Z0-9_]/g, "_")}`;
          s += `  vec4 ${m} = vec4(${p}) * vec4(${g});
`;
          const v = u.outputs[0]?.id || "out";
          n.set(`${u.id}_${v}`, `${m}`);
        ...
        case "math_sin": {
          const p = y("in", "u_time"), g = `sin_${u.id.replace(/[^a-zA-Z0-9_]/g, "_")}`;
          s += `  float ${g} = sin(${p}) * 0.5 + 0.5;
`;
          const m = u.outputs[0]?.id || "out";
          n.set(`${u.id}_${m}`, g);
          break;
        ...
        case "math_step": {
          const p = y("edge", "0.5"), g = y("in", "0.0"), m = `step_${u.id.replace(/[^a-zA-Z0-9_]/g, "_")}`;
          s += `  float ${m} = step(${p}, ${g});
`;
          const v = u.outputs[0]?.id || "out";
          n.set(`${u.id}_${v}`, m);
        ...
        case "master_output": {
          const p = y("color", "vec4(0.2, 0.6, 1.0, 1.0)"), g = y("alpha", "1.0");
...
${s}
  ...
  update(e, t = []) {
    if (this.activeShot) {
      this.shotTimer += e;
      const l = Math.min(1, this.shotTimer / (this.activeShot.duration || 1)), c = 0.5 - Math.cos(l * Math.PI) / 2;
      if (this.activeShot.type === "pan" && this.activeShot.fromPos && this.activeShot.toPos)
        this.currentPosition.lerpVectors(this.activeShot.fromPos, this.activeShot.toPos, c), this.activeShot.targetPos && (this.target.copy(this.activeShot.targetPos), this.currentTarget.copy(this.activeShot.targetPos));
      else if (this.activeShot.type === "orbit" && this.activeShot.targetPos) {
        const h = this.shotTimer * (this.activeShot.speed || 1), d = this.activeShot.radius || 8;
        this.currentPosition.x = this.activeShot.targetPos.x + Math.sin(h) * d, this.currentPosition.y = this.activeShot.targetPos.y + 3, this.currentPosition.z = this.activeShot.targetPos.z + Math.cos(h) * d, this.target.copy(this.activeShot.targetPos), this.currentTarget.copy(this.activeShot.targetPos);
      } else if (this.activeShot.type === "dolly" && this.camera.isPerspectiveCamera) {
        const h = this.camera;
        h.fov += ((this.activeShot.fov || 30) - h.fov) * Math.min(1, 4 * e), h.updateProjectionMatrix();
      }
      l >= 1 && (this.activeShot = null), this.camera.position.copy(this.currentPosition), this.camera.lookAt(this.currentTarget);
      return;
    }
    if (this.trackingTarget) {
      const l = "position" in this.trackingTarget ? this.trackingTarget.position : this.trackingTarget;
      this.setTargetPosition(l);
    }
    const i = Math.min(0.1, Math.max(1e-3, e)), s = 1 - Math.exp(-this.lerpSpeed * i);
    this.currentTarget.lerp(this.target, s);
    const r = this.currentTarget.x + this.distance * Math.sin(this.yaw) * Math.cos(this.pitch), n = this.currentTarget.y + this.distance * Math.sin(this.pitch), a = this.currentTarget.z + this.distance * Math.cos(this.yaw) * Math.cos(this.pitch);
    let o = new f.Vector3(r, n, a);
    if (this.enableCollisionAvoidance && t.length > 0) {
      const l = o.clone().sub(this.currentTarget).normalize(), c = new f.Raycaster(this.currentTarget, l, 0.1, this.distance).intersectObjects(t, !0);
      if (c.length > 0) {
        const h = c[0].distance - 0.3;
        h < this.distance && o.copy(this.currentTarget).add(l.multiplyScalar(Math.max(this.minDistance, h)));
      }
    }
    if (this.currentPosition.lerp(o, s), this.shakeTimeRemaining > 0) {
      this.shakeTimeRemaining -= e;
      const l = this.shakeIntensity * (this.shakeTimeRemaining > 0 ? this.shakeTimeRemaining * this.shakeDecay : 0);
      this.shakeOffset.set((Math.random() - 0.5) * 2 * l, (Math.random() - 0.5) * 2 * l, (Math.random() - 0.5) * 2 * l);
...
}, rn = new Lr(-1, 1, 1, -1, 0, 1), nn = class extends Br {
  constructor() {
  ...
  constructor(e) {
    this._mesh = new Fr(an, e);
  }
  dispose() {
    this._mesh.geometry.dispose();
  }
  render(e) {
    e.render(this._mesh, rn);
  }
  get material() {
  ...
  constructor(e, t = "tDiffuse") {
    super(), this.textureID = t, this.uniforms = null, this.material = null, e instanceof Z ? (this.uniforms = e.uniforms, this.material = e) : e && (this.uniforms = Re.clone(e.uniforms), this.material = new Z({
      name: e.name !== void 0 ? e.name : "unspecified",
      defines: Object.assign({}, e.defines),
      uniforms: this.uniforms,
      vertexShader: e.vertexShader,
      fragmentShader: e.fragmentShader
    })), this._fsQuad = new Oe(this.material);
  }
  render(e, t, i) {
  ...
  constructor(e, t) {
    if (this.renderer = e, this._pixelRatio = e.getPixelRatio(), t === void 0) {
      const i = e.getSize(new U());
      this._width = i.width, this._height = i.height, t = new Q(this._width * this._pixelRatio, this._height * this._pixelRatio, { type: se }), t.texture.name = "EffectComposer.rt1";
    } else
      this._width = t.width, this._height = t.height;
    this.renderTarget1 = t, this.renderTarget2 = t.clone(), this.renderTarget2.texture.name = "EffectComposer.rt2", this.writeBuffer = this.renderTarget1, this.readBuffer = this.renderTarget2, this.renderToScreen = !0, this.passes = [], this.copyPass = new on(it), this.copyPass.material.blending = Dt, this.timer = new Hr();
  }
  swapBuffers() {
  ...
  render(e) {
    ...
    for (let s = 0, r = this.passes.length; s < r; s++) {
      ...
      if (n.enabled !== !1) {
        ...
        Di !== void 0 && (n instanceof Di ? i = !0 : n instanceof ln && (i = !1));
      }
    }
...
}, ni = class Nt extends pe {
  constructor(t, i = 1, s, r) {
    super(), this.strength = i, this.radius = s, this.threshold = r, this.resolution = t !== void 0 ? new U(t.x, t.y) : new U(256, 256), this.clearColor = new he(0, 0, 0), this.needsSwap = !1, this.renderTargetsHorizontal = [], this.renderTargetsVertical = [], this.nMips = 5;
    let n = Math.round(this.resolution.x / 2), a = Math.round(this.resolution.y / 2);
    this.renderTargetBright = new Q(n, a, { type: se }), this.renderTargetBright.texture.name = "UnrealBloomPass.bright", this.renderTargetBright.texture.generateMipmaps = !1;
    for (let h = 0; h < this.nMips; h++) {
      const d = new Q(n, a, { type: se });
      d.texture.name = "UnrealBloomPass.h" + h, d.texture.generateMipmaps = !1, this.renderTargetsHorizontal.push(d);
      const u = new Q(n, a, { type: se });
    ...
    const o = un;
    this.highPassUniforms = Re.clone(o.uniforms), this.highPassUniforms.luminosityThreshold.value = r, this.highPassUniforms.smoothWidth.value = 0.01, this.materialHighPassFilter = new Z({
    ...
    for (let h = 0; h < this.nMips; h++)
      this.separableBlurMaterials.push(this._getSeparableBlurMaterial(l[h])), this.separableBlurMaterials[h].uniforms.invSize.value = new U(1 / n, 1 / a), n = Math.round(n / 2), a = Math.round(a / 2);
    ...
    this.compositeMaterial.uniforms.bloomFactors.value = c, this.bloomTintColors = [
      ...
      new Te(1, 1, 1),
      new Te(1, 1, 1)
    ], this.compositeMaterial.uniforms.bloomTintColors.value = this.bloomTintColors, this.copyUniforms = Re.clone(it.uniforms), this.blendMaterial = new Z({
      ...
      depthWrite: !1,
      transparent: !0
    }), this._oldClearColor = new he(), this._oldClearAlpha = 1, this._basic = new Ir(), this._fsQuad = new Oe(null);
  }
  dispose() {
  ...
  setSize(t, i) {
    ...
    for (let n = 0; n < this.nMips; n++)
      this.renderTargetsHorizontal[n].setSize(s, r), this.renderTargetsVertical[n].setSize(s, r), this.separableBlurMaterials[n].uniforms.invSize.value = new U(1 / s, 1 / r), s = Math.round(s / 2), r = Math.round(r / 2);
  }
  render(t, i, s, r, n) {
...
ni.BlurDirectionX = new U(1, 0);
ni.BlurDirectionY = new U(0, 1);
var ai = class Je extends pe {
  constructor(t, i, s, r) {
    super(), this.renderScene = i, this.renderCamera = s, this.selectedObjects = r !== void 0 ? r : [], this.visibleEdgeColor = new he(1, 1, 1), this.hiddenEdgeColor = new he(0.1, 0.04, 0.02), this.edgeGlow = 0, this.usePatternTexture = !1, this.patternTexture = null, this.edgeThickness = 1, this.edgeStrength = 3, this.downSampleRatio = 2, this.pulsePeriod = 0, this._visibilityCache = /* @__PURE__ */ new Map(), this._selectionCache = /* @__PURE__ */ new Set(), this.resolution = t !== void 0 ? new U(t.x, t.y) : new U(256, 256);
    const n = Math.round(this.resolution.x / this.downSampleRatio), a = Math.round(this.resolution.y / this.downSampleRatio);
    this.renderTargetMaskBuffer = new Q(this.resolution.x, this.resolution.y), this.renderTargetMaskBuffer.texture.name = "OutlinePass.mask", this.renderTargetMaskBuffer.texture.generateMipmaps = !1, this.depthMaterial = new Nr(), this.depthMaterial.side = Pi, this.depthMaterial.depthPacking = Wr, this.depthMaterial.blending = Dt, this.prepareMaskMaterial = this._getPrepareMaskMaterial(), this.prepareMaskMaterial.side = Pi, this.prepareMaskMaterial.fragmentShader = h(this.prepareMaskMaterial.fragmentShader, this.renderCamera), this.renderTargetDepthBuffer = new Q(this.resolution.x, this.resolution.y, { type: se }), this.renderTargetDepthBuffer.texture.name = "OutlinePass.depth", this.renderTargetDepthBuffer.texture.generateMipmaps = !1, this.renderTargetMaskDownSampleBuffer = new Q(n, a, { type: se }), this.renderTargetMaskDownSampleBuffer.texture.name = "OutlinePass.depthDownSample", this.renderTargetMaskDownSampleBuffer.texture.generateMipmaps = !1, this.renderTargetBlurBuffer1 = new Q(n, a, { type: se }), this.renderTargetBlurBuffer1.texture.name = "OutlinePass.blur1", this.renderTargetBlurBuffer1.texture.generateMipmaps = !1, this.renderTargetBlurBuffer2 = new Q(Math.round(n / 2), Math.round(a / 2), { type: se }), this.renderTargetBlurBuffer2.texture.name = "OutlinePass.blur2", this.renderTargetBlurBuffer2.texture.generateMipmaps = !1, this.edgeDetectionMaterial = this._getEdgeDetectionMaterial(), this.renderTargetEdgeBuffer1 = new Q(n, a, { type: se }), this.renderTargetEdgeBuffer1.texture.name = "OutlinePass.edge1", this.renderTargetEdgeBuffer1.texture.generateMipmaps = !1, this.renderTargetEdgeBuffer2 = new Q(Math.round(n / 2), Math.round(a / 2), { type: se }), this.renderTargetEdgeBuffer2.texture.name = "OutlinePass.edge2", this.renderTargetEdgeBuffer2.texture.generateMipmaps = !1;
    const o = 4, l = 4;
    ...
    const c = it;
    this.copyUniforms = Re.clone(c.uniforms), this.materialCopy = new Z({
      uniforms: this.copyUniforms,
      ...
      depthTest: !1,
      depthWrite: !1
    }), this.enabled = !0, this.needsSwap = !1, this._oldClearColor = new he(), this.oldClearAlpha = 1, this._fsQuad = new Oe(null), this.tempPulseColor1 = new he(), this.tempPulseColor2 = new he(), this.textureMatrix = new Rr();
    function h(d, u) {
      const y = u.isPerspectiveCamera ? "perspective" : "orthographic";
      return d.replace(/DEPTH_TO_VIEW_Z/g, y + "DepthToViewZ");
    }
  }
  dispose() {
  ...
  _getPrepareMaskMaterial() {
    return new Z({
      uniforms: {
        ...
        cameraNearFar: { value: new U(0.5, 0.5) },
  ...
  _getEdgeDetectionMaterial() {
    return new Z({
      uniforms: {
        ...
        texSize: { value: new U(0.5, 0.5) },
        visibleEdgeColor: { value: new Te(1, 1, 1) },
        hiddenEdgeColor: { value: new Te(1, 1, 1) }
      },
...
ai.BlurDirectionX = new U(1, 0);
ai.BlurDirectionY = new U(0, 1);
var dn = {
  name: "FilmShader",
  uniforms: {
    tDiffuse: { value: null },
  ...
  constructor(e = 0.5, t = !1) {
    super();
    const i = dn;
    this.uniforms = Re.clone(i.uniforms), this.material = new Z({
      name: i.name,
      uniforms: this.uniforms,
      vertexShader: i.vertexShader,
      fragmentShader: i.fragmentShader
    }), this.uniforms.intensity.value = e, this.uniforms.grayscale.value = t, this._fsQuad = new Oe(this.material);
  }
  render(e, t, i, s) {
  ...
  constructor(e, t, i, s = {}) {
    super(), this.pixelSize = e, this.scene = t, this.camera = i, this.normalEdgeStrength = s.normalEdgeStrength || 0.3, this.depthEdgeStrength = s.depthEdgeStrength || 0.4, this.pixelatedMaterial = this._createPixelatedMaterial(), this._resolution = new U(), this._renderResolution = new U(), this._normalMaterial = new Or(), this._beautyRenderTarget = new Q(), this._beautyRenderTarget.texture.minFilter = dt, this._beautyRenderTarget.texture.magFilter = dt, this._beautyRenderTarget.texture.type = se, this._beautyRenderTarget.depthTexture = new Vr(), this._normalRenderTarget = new Q(), this._normalRenderTarget.texture.minFilter = dt, this._normalRenderTarget.texture.magFilter = dt, this._normalRenderTarget.texture.type = se, this._fsQuad = new Oe(this.pixelatedMaterial);
  }
  dispose() {
  ...
  enabled = !1;
  constructor(e, t, i) {
    this.renderer = e, this.scene = t, this.camera = i, this.composer = new cn(e), this.renderPass = new hn(t, i), this.composer.addPass(this.renderPass), this.pixelatedPass = new fn(6, t, i), this.pixelatedPass.enabled = !1, this.composer.addPass(this.pixelatedPass), this.outlinePass = new ai(new f.Vector2(window.innerWidth, window.innerHeight), t, i), this.outlinePass.edgeStrength = 3, this.outlinePass.edgeGlow = 0.5, this.outlinePass.edgeThickness = 1, this.outlinePass.visibleEdgeColor.set("#ffffff"), this.outlinePass.hiddenEdgeColor.set("#222222"), this.outlinePass.enabled = !1, this.composer.addPass(this.outlinePass), this.bloomPass = new ni(new f.Vector2(window.innerWidth, window.innerHeight), 1.5, 0.4, 0.85), this.bloomPass.enabled = !1, this.composer.addPass(this.bloomPass), this.filmPass = new pn(), this.filmPass.enabled = !1, this.composer.addPass(this.filmPass), this.outputPass = new mn(), this.composer.addPass(this.outputPass), window.addEventListener("resize", () => {
  ...
  fpsTimer = 0;
  constructor(e, t, i) {
    this.renderer = e, this.scene = t, this.camera = i, this.postProcessing = new gn(this.renderer, this.scene, this.camera), this.setupRendererDefaults();
  }
...
function Mc(e = {}) {
  const t = e.size ?? 100, i = e.segments ?? 128, s = e.seed ?? 1337, r = e.amplitude ?? 6, n = e.frequency ?? 0.08, a = e.octaves ?? 5, o = e.persistence ?? 0.5, l = e.position ?? [
    ...
    0,
    0
  ], c = new Hl(s), h = new f.PlaneGeometry(t, t, i, i);
  h.rotateX(-Math.PI / 2);
  const d = h.attributes.position, u = [], y = new Float32Array(d.count * 3), p = new f.Color(e.color ?? 4881471), g = new f.Color(e.highColor ?? 9416299);
  for (let S = 0; S < d.count; S++) {
    const w = d.getX(S), A = d.getZ(S), b = Ri(c, w * n, A * n, a, o);
    d.setY(S, b * r);
    const x = Math.floor((A + t / 2) / t * i);
    u[x] || (u[x] = []), u[x][Math.floor((w + t / 2) / t * i)] = b;
    const C = p.clone().lerp(g, b);
    y[S * 3] = C.r, y[S * 3 + 1] = C.g, y[S * 3 + 2] = C.b;
  }
  d.needsUpdate = !0, h.setAttribute("color", new f.BufferAttribute(y, 3)), h.computeVertexNormals();
...
function Tc(e = {}) {
  const t = e.count ?? 2e3, i = e.area ?? 40, [s, r] = e.height ?? [0.5, 1.2], n = e.width ?? 0.12, a = e.seed ?? 1, o = e.position ?? [
    ...
    0,
    0
  ], l = e.heightAt ?? null, c = new ct(a), h = new f.PlaneGeometry(n, 1, 1, 1);
  h.translate(0, 0.5, 0);
  const d = new f.Color(e.color ?? 5020223), u = new f.Color(e.tipColor ?? 9426016), y = new Float32Array(h.attributes.position.count * 3);
  for (let _ = 0; _ < h.attributes.position.count; _++) {
    const S = h.attributes.position.getY(_), w = d.clone().lerp(u, S);
    y[_ * 3] = w.r, y[_ * 3 + 1] = w.g, y[_ * 3 + 2] = w.b;
  }
  h.setAttribute("color", new f.BufferAttribute(y, 3));
  const p = new f.MeshStandardMaterial({
    vertexColors: !0,
    side: f.DoubleSide,
    roughness: 1
  }), g = new f.InstancedMesh(h, p, t);
  g.position.set(...o), g.castShadow = e.castShadow ?? !1;
  const m = i / 2, v = new f.Object3D();
  for (let _ = 0; _ < t; _++) {
    const S = c.nextFloat(-m, m), w = c.nextFloat(-m, m), A = c.nextFloat(s, r), b = l ? l(S + o[0], w + o[2]) - o[1] : 0;
    v.position.set(S, b - 0.03, w), v.rotation.set(0, c.nextFloat(0, Math.PI), c.nextFloat(-0.2, 0.2)), v.scale.set(c.nextFloat(0.7, 1.3), A, 1), v.updateMatrix(), g.setMatrixAt(_, v.matrix);
  }
...
function Cc(e = {}) {
  const t = e.position ?? [
    ...
    0,
    0
  ], i = e.scale ?? 1, s = (e.trunkHeight ?? 2.2) * i, r = (e.trunkRadius ?? 0.25) * i, n = (e.canopyRadius ?? 1.5) * i, a = new ct(e.seed ?? Math.floor(Math.random() * 99999)), o = new f.Group();
  o.position.set(...t);
...
function Ac(e = {}) {
  const t = e.position ?? [
    ...
    0,
    0
  ], i = e.scale ?? 1, s = (e.radius ?? 0.6) * i, r = new ct(e.seed ?? Math.floor(Math.random() * 99999)), n = new f.DodecahedronGeometry(s, 1), a = n.attributes.position;
...
function vn(e) {
  const t = new Qe(), i = e.geometry, s = e.getWorldScale(new f.Vector3()), r = (o, l, c) => {
...
var Pc = /* @__PURE__ */ (function(e) {
  ...
  showImageOverlay(e, t) {
    return je.showImageOverlay(e, t);
  }
  removeImageOverlay(e) {
    je.removeImageOverlay(e);
  }
  setLetterbox(e, t) {
    je.setLetterbox(e, t);
  }
  async transitionCut(e, t) {
    await je.transitionCut(e, t);
  }
  setColorGrading(e) {
    je.setColorGrading(e);
  }
}, An = new Cn(), _n = class {
  overlay = null;
  metricsElement = null;
  ...
  static compileGame(e, t = {}) {
    ...
    e.forEach((h) => {
      ...
      if (i.prebakeSpatialHash && h.elements) {
        ...
        h.elements.forEach((w, A) => {
          const b = w.id || `elem_${A}`, x = `${w.pos[0]},${w.pos[1]}`;
      ...
      const p = JSON.stringify(h), g = Fe.createSaveEnvelope(JSON.parse(p)), m = JSON.stringify(g), v = i.compressBinaryLevels ? Fe.compressToBase64(m) : m, _ = new TextEncoder().encode(v).length;
      n += _, a.push({
        id: h.id,
        name: h.name,
        world: h.world,
        ...
        spatialHashBake: y,
        checksum: g.checksum
      }), s.push(`[Level ${h.id}] '${h.name}' compiled (${u}B -> ${_}B)`);
    });
...
<body>
  ...
  load() {
    try {
      ...
      if (e) {
        const t = JSON.parse(e), i = Fe.verifyAndUnwrapSave(t);
  ...
  save() {
    try {
      if (typeof localStorage > "u") return;
      const e = Fe.createSaveEnvelope(this.data);
  ...
  async wait(e) {
    return this.checkAbort(), new Promise((t, i) => {
      ...
      const r = (n) => {
        if (this.aborted)
          return this.app.engine.events.off("update", r), i(new et());
  ...
  async moveCamera(e, t = 1) {
    return this.checkAbort(), new Promise((i, s) => {
      ...
      const n = this.app.camera.position.clone(), a = new f.Vector3(...e), o = (l) => {
        if (this.aborted)
          return this.app.engine.events.off("update", o), s(new et());
        r += l;
  ...
  async lookAt(e, t = 1) {
    return this.checkAbort(), new Promise((i, s) => {
      ...
      const o = a.quaternion.clone(), l = (c) => {
        if (this.aborted)
          return this.app.engine.events.off("update", l), s(new et());
        r += c;
  ...
  async play(e) {
    this.stop(), this.activeContext = new Vn(this.app);
    try {
      await e(this.activeContext);
    } catch (t) {
      if (t instanceof et) console.log("[CutsceneManager] Cutscene skipped.");
      else throw t;
    } finally {
...
typeof process < "u" && process.env.NODE_ENV !== "production" && (Ue = (e, t, i) => {
  !e && typeof console < "u" && console.warn(Ot(t, i));
}, de = (e, t, i) => {
  if (!e) throw new Error(Ot(t, i));
});
var xe = {}, ys = (e) => /^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(e), Fn = (e) => typeof e == "object" && e !== null, vs = (e) => /^0[^.\s]+$/u.test(e);
// @__NO_SIDE_EFFECTS__
function bs(e) {
  let t;
  return () => (t === void 0 && (t = e()), t);
}
var Le = /* @__NO_SIDE_EFFECTS__ */ (e) => e, li = (...e) => e.reduce((t, i) => (s) => i(t(s))), ci = /* @__NO_SIDE_EFFECTS__ */ (e, t, i) => {
  const s = t - e;
  return s ? (i - e) / s : 1;
}, xs = class {
  constructor() {
  ...
  add(e) {
    return Rn(this.subscriptions, e), () => oi(this.subscriptions, e);
  }
  notify(e, t, i) {
...
}, ee = /* @__NO_SIDE_EFFECTS__ */ (e) => e * 1e3, ne = /* @__NO_SIDE_EFFECTS__ */ (e) => e / 1e3, ws = /* @__NO_SIDE_EFFECTS__ */ (e, t) => t ? e * (1e3 / t) : 0, Ii = /* @__PURE__ */ new Set();
function Ss(e, t, i) {
  e || Ii.has(t) || (console.warn(Ot(t, i)), Ii.add(t));
}
var In = (e, t, i) => {
  const s = t - e;
  return ((i - e) % s + s) % s + e;
}, Ms = (e, t, i) => (((1 - 3 * i + 3 * t) * e + (3 * i - 6 * t)) * e + 3 * t) * e, Nn = 1e-7, On = 12;
function Un(e, t, i, s, r) {
  let n, a, o = 0;
  do
    a = t + (i - t) / 2, n = Ms(a, s, r) - e, n > 0 ? i = a : t = a;
  while (Math.abs(n) > Nn && ++o < On);
  return a;
}
// @__NO_SIDE_EFFECTS__
function ot(e, t, i, s) {
  if (e === t && i === s) return Le;
  const r = (n) => Un(n, 0, 1, e, i);
  return (n) => n === 0 || n === 1 ? n : Ms(r(n), t, s);
}
var Ts = /* @__NO_SIDE_EFFECTS__ */ (e) => (t) => t <= 0.5 ? e(2 * t) / 2 : (2 - e(2 * (1 - t))) / 2, hi = /* @__NO_SIDE_EFFECTS__ */ (e) => (t) => 1 - e(1 - t), Cs = /* @__PURE__ */ ot(0.33, 1.53, 0.69, 0.99), ui = /* @__PURE__ */ hi(Cs), As = /* @__PURE__ */ Ts(ui), _s = (e) => e >= 1 ? 1 : (e *= 2) < 1 ? 0.5 * ui(e) : 0.5 * (2 - Math.pow(2, -10 * (e - 1))), di = (e) => 1 - Math.sin(Math.acos(e)), Ln = hi(di), Ps = Ts(di), Wn = /* @__PURE__ */ ot(0.42, 0, 1, 1), Gn = /* @__PURE__ */ ot(0, 0, 0.58, 1), Bs = /* @__PURE__ */ ot(0.42, 0, 0.58, 1), ks = /* @__NO_SIDE_EFFECTS__ */ (e) => Array.isArray(e) && typeof e[0] != "number";
// @__NO_SIDE_EFFECTS__
function Es(e, t) {
  return ks(e) ? e[In(0, e.length, t)] : e;
}
var zs = /* @__NO_SIDE_EFFECTS__ */ (e) => Array.isArray(e) && typeof e[0] == "number", Ni = {
  linear: Le,
  easeIn: Wn,
  easeInOut: Bs,
  easeOut: Gn,
...
function Vs(e, t) {
  ...
  const r = {
    ...
    timestamp: 0,
    isProcessing: !1
  }, n = () => i = !0, a = gt.reduce((S, w) => (S[w] = Kn(n), S), {}), { setup: o, read: l, resolveKeyframes: c, preUpdate: h, update: d, preRender: u, render: y, postRender: p } = a, g = () => {
    const S = xe.useManualTiming, w = S ? r.timestamp : performance.now();
    i = !1, S || (r.delta = s ? 1e3 / 60 : Math.max(Math.min(w - r.timestamp, Hn), 1)), r.timestamp = w, r.isProcessing = !0, o.process(r), l.process(r), c.process(r), h.process(r), d.process(r), u.process(r), y.process(r), p.process(r), r.isProcessing = !1, i && t && (s = !1, e(g));
  }, m = () => {
    i = !0, s = !0, r.isProcessing || e(g);
  };
  return {
    schedule: gt.reduce((S, w) => {
      const A = a[w];
      return S[w] = (b, x = !1, C = !1) => (i || m(), A.schedule(b, x, C)), S;
    }, {}),
    cancel: (S) => {
      for (let w = 0; w < gt.length; w++) a[gt[w]].cancel(S);
    },
    state: r,
    steps: a
  };
}
var { schedule: oe, cancel: Ut, state: wt, steps: kc } = /* @__PURE__ */ Vs(typeof requestAnimationFrame < "u" ? requestAnimationFrame : Le, !0), vt;
function jn() {
  vt = void 0;
}
var J = {
  now: () => (vt === void 0 && J.set(wt.isProcessing || xe.useManualTiming ? wt.timestamp : performance.now()), vt),
  set: (e) => {
    vt = e, queueMicrotask(jn);
  }
}, Ds = (e) => (t) => typeof t == "string" && t.startsWith(e), Rs = /* @__PURE__ */ Ds("--"), qn = /* @__PURE__ */ Ds("var(--"), pi = (e) => qn(e) ? Xn.test(e.split("/*")[0].trim()) : !1, Xn = /var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu;
function Ui(e) {
...
var We = {
  ...
  ...We,
  default: 1
}, st = (e) => Math.round(e * 1e5) / 1e5, fi = /-?(?:\d+(?:\.\d+)?|\.\d+)/gu;
function Yn(e) {
  return e == null;
}
var Qn = /^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu, mi = (e, t) => (i) => !!(typeof i == "string" && Qn.test(i) && i.startsWith(e) || t && !Yn(i) && Object.prototype.hasOwnProperty.call(i, t)), Fs = (e, t, i) => (s) => {
  ...
  transform: ({ red: e, green: t, blue: i, alpha: s = 1 }) => "rgba(" + Pt.transform(e) + ", " + Pt.transform(t) + ", " + Pt.transform(i) + ", " + st(rt.transform(s)) + ")"
};
function Jn(e) {
  let t = "", i = "", s = "", r = "";
...
var Lt = {
  ...
  parse: parseFloat,
  transform: (t) => `${t}${e}`
}), ce = /* @__PURE__ */ lt("deg"), De = /* @__PURE__ */ lt("%"), P = /* @__PURE__ */ lt("px"), ea = /* @__PURE__ */ lt("vh"), ta = /* @__PURE__ */ lt("vw"), Li = {
  ...De,
  ...
  transform: ({ hue: e, saturation: t, lightness: i, alpha: s = 1 }) => "hsla(" + Math.round(e) + ", " + De.transform(st(t)) + ", " + De.transform(st(i)) + ", " + st(rt.transform(s)) + ")"
}, O = {
  test: (e) => Ce.test(e) || Lt.test(e) || ze.test(e),
  parse: (e) => Ce.test(e) ? Ce.parse(e) : ze.test(e) ? ze.parse(e) : Lt.parse(e),
  transform: (e) => typeof e == "string" ? e : e.hasOwnProperty("red") ? Ce.transform(e) : ze.transform(e),
  getAnimatableNone: (e) => {
    const t = O.parse(e);
    return t.alpha = 0, O.transform(t);
  }
}, ia = /(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))/giu;
function sa(e) {
  return isNaN(e) && typeof e == "string" && (e.match(fi)?.length || 0) + (e.match(ia)?.length || 0) > 0;
}
var Is = "number", Ns = "color", ra = "var", na = "var(", Wi = "${}", aa = /var\s*\(\s*--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)|#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\)|-?(?:\d+(?:\.\d+)?|\.\d+)/giu;
function Ie(e) {
  ...
  return {
    values: i,
    split: t.replace(aa, (a) => (O.test(a) ? (s.color.push(n), r.push(Ns), i.push(O.parse(a))) : a.startsWith(na) ? (s.var.push(n), r.push(ra), i.push(a)) : (s.number.push(n), r.push(Is), i.push(parseFloat(a))), ++n, Wi)).split(Wi),
    indexes: s,
    types: r
  };
}
...
function Os({ split: e, types: t }) {
  ...
  return (s) => {
    ...
    for (let n = 0; n < i; n++)
      if (r += e[n], s[n] !== void 0) {
        const a = t[n];
        a === Is ? r += st(s[n]) : a === Ns ? r += O.transform(s[n]) : r += s[n];
      }
    return r;
  };
}
...
var ca = (e) => typeof e == "number" ? 0 : O.test(e) ? O.getAnimatableNone(e) : e, ha = (e, t) => typeof e == "number" ? t?.trim().endsWith("/") ? e : 0 : ca(e);
function ua(e) {
  const t = Ie(e);
  return Os(t)(t.values.map((i, s) => ha(i, t.split[s])));
}
var ae = {
  test: sa,
  parse: oa,
...
function da({ hue: e, saturation: t, lightness: i, alpha: s }) {
  e /= 360, t /= 100, i /= 100;
  let r = 0, n = 0, a = 0;
  if (!t) r = n = a = i;
  else {
    const o = i < 0.5 ? i * (1 + t) : i + t - i * t, l = 2 * i - o;
    r = Bt(l, o, e + 1 / 3), n = Bt(l, o, e), a = Bt(l, o, e - 1 / 3);
  }
  return {
...
function Gi(e) {
  ...
  let i = t.parse(e);
  return t === ze && (i = da(i)), i;
}
var $i = (e, t) => {
  const i = Gi(e), s = Gi(t);
  if (!i || !s) return St(e, t);
  const r = { ...i };
  return (n) => (r.red = kt(i.red, s.red, n), r.green = kt(i.green, s.green, n), r.blue = kt(i.blue, s.blue, n), r.alpha = Ge(i.alpha, s.alpha, n), Ce.transform(r));
}, Wt = /* @__PURE__ */ new Set(["none", "hidden"]);
function ma(e, t) {
  return Wt.has(e) ? (i) => i <= 0 ? e : t : (i) => i >= 1 ? t : e;
}
function ga(e, t) {
  return (i) => Ge(e, t, i);
}
function gi(e) {
  return typeof e == "number" ? ga : typeof e == "string" ? pi(e) ? St : O.test(e) ? $i : ba : Array.isArray(e) ? Us : typeof e == "object" ? O.test(e) ? $i : ya : St;
}
function Us(e, t) {
...
var ba = (e, t) => {
  const i = ae.createTransformer(t), s = Ie(e), r = Ie(t);
  return s.indexes.var.length === r.indexes.var.length && s.indexes.color.length === r.indexes.color.length && s.indexes.number.length >= r.indexes.number.length ? Wt.has(e) && !r.values.length || Wt.has(t) && !s.values.length ? ma(e, t) : li(Us(va(s, r), r.values), i) : (Ue(!0, `Complex values '${e}' and '${t}' too different to mix. Ensure all colors are of the same type, and that each contains the same quantity of number and color values. Falling back to instant transition.`, "complex-values-different"), St(e, t));
};
function Ls(e, t, i) {
  return typeof e == "number" && typeof t == "number" && typeof i == "number" ? Ge(e, t, i) : gi(e)(e, t);
}
var xa = (e) => {
  ...
  return {
    ...
    stop: () => Ut(t),
    now: () => wt.isProcessing ? wt.timestamp : J.now()
  };
}, Ws = (e, t, i = 10) => {
  let s = "";
...
function Sa(e, t, i) {
  let s = i;
  for (let r = 1; r < wa; r++) s = s - e(s) / t(s);
  return s;
}
var Ki = 1e-3;
function Ma({ duration: e = N.duration, bounce: t = N.bounce, velocity: i = N.velocity, mass: s = N.mass }) {
  let r, n;
  Ue(e <= ee(N.maxDuration), "Spring duration must be 10 seconds or less", "spring-duration-limit");
  let a = 1 - t;
  a = be(N.minDamping, N.maxDamping, a), e = be(N.minDuration, N.maxDuration, ne(e)), a < 1 ? (r = (c) => {
    const h = c * a, d = h * e, u = h - i, y = Gt(c, a), p = Math.exp(-d);
    return Ki - u / y * p;
  }, n = (c) => {
    const h = c * a * e, d = h * i + i, u = Math.pow(a, 2) * Math.pow(c, 2) * e, y = Math.exp(-h), p = Gt(Math.pow(c, 2), a);
    return (-r(c) + Ki > 0 ? -1 : 1) * ((d - u) * y) / p;
  }) : (r = (c) => -1e-3 + Math.exp(-c * e) * ((c - i) * e + 1), n = (c) => Math.exp(-c * e) * ((i - c) * (e * e)));
  const o = 5 / e, l = Sa(r, n, o);
...
function Aa(e) {
  ...
  if (!Hi(e, Ca) && Hi(e, Ta))
    if (t.velocity = 0, e.visualDuration) {
      const i = e.visualDuration, s = 2 * Math.PI / (i * 1.2), r = s * s, n = 2 * be(0.05, 1, 1 - (e.bounce || 0)) * Math.sqrt(r);
      t = {
        ...t,
        mass: N.mass,
        stiffness: r,
...
function nt(e = N.visualDuration, t = N.bounce) {
  ...
  const n = i.keyframes[0], a = i.keyframes[i.keyframes.length - 1], o = {
    ...
    value: n
  }, { stiffness: l, damping: c, mass: h, duration: d, velocity: u, isResolvedFromDuration: y } = Aa({
    ...i,
    velocity: -ne(i.velocity || 0)
  }), p = u || 0, g = c / (2 * Math.sqrt(l * h)), m = a - n, v = ne(Math.sqrt(l / h)), _ = Math.abs(m) < 5;
  s || (s = _ ? N.restSpeed.granular : N.restSpeed.default), r || (r = _ ? N.restDelta.granular : N.restDelta.default);
  let S, w, A, b, x, C;
  if (g < 1)
    A = Gt(v, g), b = (p + g * v * m) / A, S = (B) => {
      const T = Math.exp(-g * v * B);
      return a - T * (b * Math.sin(A * B) + m * Math.cos(A * B));
    }, x = g * v * b + m * A, C = g * v * m - b * A, w = (B) => Math.exp(-g * v * B) * (x * Math.sin(A * B) + C * Math.cos(A * B));
  else if (g === 1) {
    S = (T) => a - Math.exp(-v * T) * (m + (p + v * m) * T);
    const B = p + v * m;
    w = (T) => Math.exp(-v * T) * (v * B * T - p);
  } else {
    const B = v * Math.sqrt(g * g - 1);
    S = (D) => {
      const L = Math.exp(-g * v * D), E = Math.min(B * D, 300);
      return a - L * ((p + g * v * m) * Math.sinh(E) + B * m * Math.cosh(E)) / B;
    };
    const T = (p + g * v * m) / B, V = g * v * T - m * B, z = g * v * m - T * B;
    w = (D) => {
      const L = Math.exp(-g * v * D), E = Math.min(B * D, 300);
      return L * (V * Math.sinh(E) + z * Math.cosh(E));
    };
  }
  const M = {
    ...
    next: (B) => {
      if (!y && g < 1) {
        const V = Math.exp(-g * v * B), z = Math.sin(A * B), D = Math.cos(A * B), L = a - V * (b * z + m * D), E = ee(V * (x * z + C * D));
        return o.done = Math.abs(E) <= s && Math.abs(a - L) <= r, o.value = o.done ? a : L, o;
      }
      const T = S(B);
      if (y)
        o.done = B >= d;
        ...
        const V = ee(w(B));
        o.done = Math.abs(V) <= s && Math.abs(a - T) <= r;
      }
      return o.value = o.done ? a : T, o;
    },
    toString: () => {
      const B = Math.min(yi(M), Gs), T = Ws((V) => M.next(B * V).value, B, 30);
      return B + "ms " + T;
    },
    toTransition: () => {
    }
...
var _a = 5;
function Ks(e, t, i) {
  const s = Math.max(t - _a, 0);
  return ws(i - e(s), t - s);
}
function $t({ keyframes: e, velocity: t = 0, power: i = 0.8, timeConstant: s = 325, bounceDamping: r = 10, bounceStiffness: n = 500, modifyTarget: a, min: o, max: l, restDelta: c = 0.5, restSpeed: h }) {
  const d = e[0], u = {
    done: !1,
    value: d
  }, y = (C) => o !== void 0 && C < o || l !== void 0 && C > l, p = (C) => o === void 0 ? l : l === void 0 || Math.abs(o - C) < Math.abs(l - C) ? o : l;
  let g = i * t;
  const m = d + g, v = a === void 0 ? m : a(m);
  v !== m && (g = v - d);
  const _ = (C) => -g * Math.exp(-C / s), S = (C) => v + _(C), w = (C) => {
    const M = _(C), B = S(C);
  ...
  return x(0), {
    ...
    next: (C) => {
      let M = !1;
      return !b && A === void 0 && (M = !0, w(C), x(C)), A !== void 0 && C >= A ? b.next(C - A) : (!M && w(C), u);
    }
  };
}
function Pa(e, t, i) {
  const s = [], r = i || xe.mix || Ls, n = e.length - 1;
  for (let a = 0; a < n; a++) {
    let o = r(e[a], e[a + 1]);
    t && (o = li(Array.isArray(t) ? t[a] || Le : t, o)), s.push(o);
  }
  return s;
}
function Ba(e, t, { clamp: i = !0, ease: s, mixer: r } = {}) {
  const n = e.length;
  ...
  const o = Pa(t, s, r), l = o.length, c = (h) => {
...
function Ve({ duration: e = 300, keyframes: t, times: i, ease: s = "easeInOut" }) {
  const r = ks(s) ? s.map(Oi) : Oi(s), n = {
    done: !1,
    value: t[0]
  }, a = Ba(ka(i && i.length === t.length ? i : js(t), e), t, { ease: Array.isArray(r) ? r : Ea(t, r) });
  return {
...
function At(e, { repeat: t, repeatType: i = "loop" }, s, r = 1) {
  const n = e.filter(za), a = r < 0 || t && i !== "loop" && t % 2 === 1 ? 0 : n.length - 1;
...
function qs(e) {
  typeof e.type == "string" && (e.type = Va[e.type]);
}
var vi = class {
  constructor() {
    this.updateFinished();
...
}, Da = (e) => e / 100, Mt = class extends vi {
  constructor(e) {
  ...
  initAnimation() {
    ...
    qs(e);
    const { type: t = Ve, repeat: i = 0, repeatDelay: s = 0, repeatType: r, velocity: n = 0 } = e;
    let { keyframes: a } = e;
    const o = t || Ve;
    process.env.NODE_ENV !== "production" && o !== Ve && de(a.length <= 2, `Only two keyframes currently supported with spring and inertia animations. Trying to animate ${a}`, "spring-two-frames"), o !== Ve && typeof a[0] != "number" && (this.mixKeyframes = li(Da, Ls(a[0], a[1])), a = [0, 100]);
    const l = o({
      ...e,
      keyframes: a
    });
  ...
  tick(e, t = !1) {
    ...
    const { delay: l = 0, keyframes: c, repeat: h, repeatType: d, repeatDelay: u, type: y, onUpdate: p, finalKeyframe: g } = this.options;
    ...
    let _ = this.currentTime, S = i;
    if (h) {
      const x = Math.min(this.currentTime, s) / a;
      let C = Math.floor(x), M = x % 1;
      !M && x >= 1 && (M = 1), M === 1 && C--, C = Math.min(C, h + 1), C % 2 && (d === "reverse" ? (M = 1 - M, u && (M -= u / a)) : d === "mirror" && (S = n)), _ = be(0, 1, M) * a;
    }
    let w;
    v ? (this.delayState.value = c[0], w = this.delayState) : w = S.next(_), r && !v && (w.value = r(w.value));
    let { done: A } = w;
    !v && o !== null && (A = this.playbackSpeed >= 0 ? this.currentTime >= s : this.currentTime <= 0);
    const b = this.holdTime === null && (this.state === "finished" || this.state === "running" && A);
    return b && y !== $t && (w.value = At(c, this.options, g, this.speed)), p && p(w.value), b && this.finish(), w;
  }
  then(e, t) {
    return this.finished.then(e, t);
  }
  ...
  getGeneratorVelocity() {
    ...
    return Ks((i) => this.generator.next(i).value, e, t);
  }
  get speed() {
  ...
  play() {
    ...
    const { driver: e = xa, startTime: t } = this.options;
...
var Ae = (e) => e * 180 / Math.PI, Kt = (e) => {
...
}, Ht = (e) => (e = e % 360, e < 0 && (e += 360), e), ji = Kt, qi = (e) => Math.sqrt(e[0] * e[0] + e[1] * e[1]), Xi = (e) => Math.sqrt(e[4] * e[4] + e[5] * e[5]), Ia = {
  x: 12,
  y: 13,
  z: 14,
  translateX: 12,
  ...
  scaleY: Xi,
  scale: (e) => (qi(e) + Xi(e)) / 2,
  rotateX: (e) => Ht(Ae(Math.atan2(e[6], e[5]))),
  rotateY: (e) => Ht(Ae(Math.atan2(-e[2], e[0]))),
  rotateZ: ji,
  rotate: ji,
...
function qt(e, t) {
  ...
  if (!r) return jt(t);
  const n = s[t], a = r[1].split(",").map(Oa);
...
var $e = [
  ...
  "skewX",
  "skewY"
], Ke = /* @__PURE__ */ new Set([...$e, "pathRotation"]), Yi = (e) => e === We || e === P, Ua = /* @__PURE__ */ new Set([
  "x",
  "y",
  "z"
]), La = $e.filter((e) => !Ua.has(e));
function Wa(e) {
  const t = [];
  return La.forEach((i) => {
...
var ve = {
  ...
  x: (e, { transform: t }) => qt(t, "x"),
  y: (e, { transform: t }) => qt(t, "y")
};
ve.translateX = ve.x;
ve.translateY = ve.y;
var _e = /* @__PURE__ */ new Set(), Xt = !1, Yt = !1, Qt = !1;
function Xs() {
  if (Yt) {
    const e = Array.from(_e).filter((s) => s.needsMeasurement), t = new Set(e.map((s) => s.element)), i = /* @__PURE__ */ new Map();
    t.forEach((s) => {
      const r = Wa(s);
  ...
  Yt = !1, Xt = !1, _e.forEach((e) => e.complete(Qt)), _e.clear();
}
function Ys() {
  _e.forEach((e) => {
...
var bi = class {
  ...
  scheduleResolve() {
    this.state = "scheduled", this.isAsync ? (_e.add(this), Xt || (Xt = !0, oe.read(Ys), oe.resolveKeyframes(Xs))) : (this.readKeyframes(), this.complete());
  }
  readKeyframes() {
  ...
  complete(e = !1) {
    this.state = "complete", this.onComplete(this.unresolvedKeyframes, this.finalKeyframe, e), _e.delete(this);
  }
  cancel() {
    this.state === "scheduled" && (_e.delete(this), this.state = "pending");
  }
  resume() {
...
function Qs(e, t, i) {
  $a(t) ? e.style.setProperty(t, i) : e.style[t] = i;
}
var Ka = {};
function Zs(e, t) {
  const i = /* @__PURE__ */ bs(e);
  return () => Ka[t] ?? i();
}
var Ha = /* @__PURE__ */ Zs(() => window.ScrollTimeline !== void 0, "scrollTimeline"), Js = /* @__PURE__ */ Zs(() => {
  try {
  ...
  return !0;
}, "linearEasing"), tt = ([e, t, i, s]) => `cubic-bezier(${e}, ${t}, ${i}, ${s})`, Qi = {
  linear: "linear",
  ease: "ease",
  easeIn: "ease-in",
  easeOut: "ease-out",
...
function er(e, t) {
  if (e) return typeof e == "function" ? Js() ? Ws(e, t) : "ease-out" : zs(e) ? tt(e) : Array.isArray(e) ? e.map((i) => er(i, t) || Qi.easeOut) : Qi[e];
}
function ja(e, t, i, { delay: s = 0, duration: r = 300, repeat: n = 0, repeatType: a = "loop", ease: o = "easeOut", times: l } = {}, c = void 0) {
  const h = { [t]: i };
  l && (h.offset = l);
  const d = er(o, r);
...
function qa({ type: e, ...t }) {
  return xi(e) && Js() ? e.applyToOptions(t) : (t.duration ?? (t.duration = 300), t.ease ?? (t.ease = "easeOut"), t);
}
var tr = class extends vi {
  constructor(e) {
    ...
    const l = qa(e);
    this.animation = ja(t, i, s, l, r), l.autoplay === !1 && this.animation.pause(), this.animation.onfinish = () => {
      if (this.finishedTime = this.time, !r) {
        const c = At(s, this.options, a, this.speed);
        this.updateMotionValue && this.updateMotionValue(c), Qs(t, i, c), this.animation.cancel();
      }
  ...
  attachTimeline({ timeline: e, rangeStart: t, rangeEnd: i, observe: s }) {
    return this.allowFlatten && this.animation.effect?.updateTiming({ easing: "linear" }), this.animation.onfinish = null, e && Ha() ? (this.animation.timeline = e, t && (this.animation.rangeStart = t), i && (this.animation.rangeEnd = i), Le) : s(this);
  }
}, ir = {
  anticipate: _s,
  backInOut: As,
...
function Ya(e) {
  typeof e.ease == "string" && Xa(e.ease) && (e.ease = ir[e.ease]);
}
var Et = 10, Qa = class extends tr {
  constructor(e) {
    Ya(e), qs(e), super(e), e.startTime !== void 0 && e.autoplay !== !1 && (this.startTime = e.startTime), this.options = e;
  }
  updateMotionValue(e) {
    ...
    const a = new Mt({
      ...n,
      autoplay: !1
    }), o = Math.max(Et, J.now() - this.startTime), l = be(0, Et, o - Et), c = a.sample(o).value, { name: h } = this.options;
    r && h && Qs(r, h, c), t.setWithVelocity(a.sample(Math.max(0, o - l)).value, c, l), a.stop();
  }
}, Zi = (e, t) => t === "zIndex" ? !1 : !!(typeof e == "number" || Array.isArray(e) || typeof e == "string" && (ae.test(e) || e === "0") && !e.startsWith("url("));
function Za(e) {
  const t = e[0];
...
function Ja(e, t, i, s) {
  ...
  const n = e[e.length - 1], a = Zi(r, t), o = Zi(n, t);
  return Ue(a === o, `You are trying to animate ${t} from "${r}" to "${n}". "${a ? n : r}" is not an animatable value.`, "value-not-animatable"), !a || !o ? !1 : Za(e) || (i === "spring" || xi(i)) && s;
}
function Zt(e) {
...
var sr = /* @__PURE__ */ new Set([
  ...
  "transform",
  "backgroundColor"
]), eo = /^(?:oklch|oklab|lab|lch|color|color-mix|light-dark)\(/;
function to(e) {
  for (let t = 0; t < e.length; t++) if (typeof e[t] == "string" && eo.test(e[t])) return !0;
  return !1;
}
var io = /* @__PURE__ */ new Set([
  ...
  "borderBottomColor",
  "borderLeftColor"
]), so = /* @__PURE__ */ bs(() => Object.hasOwnProperty.call(Element.prototype, "animate"));
function ro(e) {
  ...
  return so() && i && (sr.has(i) || io.has(i) && to(o)) && (i !== "transform" || !h) && !c && !s && r !== "mirror" && n !== 0 && a !== "inertia";
}
var no = 40, ao = class extends vi {
  constructor({ autoplay: e = !0, delay: t = 0, type: i = "keyframes", repeat: s = 0, repeatDelay: r = 0, repeatType: n = "loop", keyframes: a, name: o, motionValue: l, element: c, ...h }) {
    ...
    this.keyframeResolver = new u(a, (y, p, g) => this.onKeyframesResolved(y, p, d, !g), o, l, c), this.keyframeResolver?.scheduleResolve();
  }
  onKeyframesResolved(e, t, i, s) {
    ...
    let h = !0;
    Ja(e, r, n, a) || (h = !1, (xe.instantAnimations || !o) && c?.(At(e, i, t)), e[0] = e[e.length - 1], Zt(i), i.repeat = 0);
    const d = {
      startTime: s ? this.resolvedAt ? this.resolvedAt - this.createdAt > no ? this.resolvedAt : this.createdAt : this.createdAt : void 0,
      finalKeyframe: t,
      ...i,
      keyframes: e
    }, u = h && !l && ro(d), y = d.motionValue?.owner?.current;
    let p;
    if (u) try {
      p = new Qa({
        ...d,
    ...
    p.finished.then(() => {
      this.notifyFinished();
    }).catch(Le), this.pendingTimeline && (this.stopTimeline = p.attachTimeline(this.pendingTimeline), this.pendingTimeline = void 0), this._animation = p;
  }
  get finished() {
...
var lo = class extends oo {
...
}, es = 30, co = (e) => !isNaN(parseFloat(e)), ts = { current: void 0 }, ho = class {
  constructor(e, t = {}) {
  ...
  setCurrent(e) {
    this.current = e, this.updatedAt = J.now(), this.canTrackVelocity === null && e !== void 0 && (this.canTrackVelocity = co(this.current));
  }
  setPrevFrameValue(e = this.current) {
    this.prevFrameValue = e, this.prevUpdatedAt = this.updatedAt;
  }
  onChange(e) {
    return process.env.NODE_ENV !== "production" && Ss(!1, 'value.onChange(callback) is deprecated. Switch to value.on("change", callback).'), this.on("change", e);
  }
  on(e, t) {
    this.events[e] || (this.events[e] = new xs());
...
var uo = {
  ...
  duration: 0.3
}, go = (e, { keyframes: t }) => t.length > 2 ? fo : Ke.has(e) ? e.startsWith("scale") ? po(t[1]) : uo : mo, yo = /* @__PURE__ */ new Set([
  "when",
  "delay",
  "delayChildren",
  "staggerChildren",
...
function vo(e) {
  for (const t in e) if (!yo.has(t)) return !0;
  return !1;
}
var ar = (e, t, i, s = {}, r, n) => (a) => {
  const o = nr(s, e) || {}, l = o.delay || s.delay || 0;
  let { elapsed: c = 0 } = s;
  c = c - ee(l);
  const h = {
  ...
  vo(o) || Object.assign(h, go(e, h)), h.duration && (h.duration = ee(h.duration)), h.repeatDelay && (h.repeatDelay = ee(h.repeatDelay)), h.from !== void 0 && (h.keyframes[0] = h.from);
  let d = !1;
  if ((h.type === !1 || h.duration === 0 && !h.repeatDelay) && (Zt(h), h.delay === 0 && (d = !0)), (xe.instantAnimations || xe.skipAnimations || r?.shouldSkipAnimations || o.skipAnimations) && (d = !0, Zt(h), h.delay = 0), h.allowFlatten = !o.type && !o.ease, d && !n && t.get() !== void 0) {
  ...
  return o.isSync ? new Mt(h) : new ao(h);
}, bo = /^var\(--(?:([\w-]+)|([\w-]+), ?([a-zA-Z\d ()%#.,-]+))\)/u;
function xo(e) {
  const t = bo.exec(e);
  if (!t) return [,];
  const [, i, s, r] = t;
...
var wo = 4;
function or(e, t, i = 1) {
  de(i <= wo, `Max CSS variable fallback depth detected in property "${e}". This may indicate a circular fallback dependency.`, "max-css-var-depth");
  const [s, r] = xo(e);
  if (!s) return;
  const n = window.getComputedStyle(t).getPropertyValue(s);
  if (n) {
    const a = n.trim();
    return ys(a) ? parseFloat(a) : a;
  }
  return pi(r) ? or(r, t, i + 1) : r;
}
function is(e) {
  const t = [{}, {}];
...
function So(e, t, i) {
  const s = e.getProps();
  return lr(s, t, i !== void 0 ? i : s.custom, e);
}
...
function To(e, t, i) {
  e.hasValue(t) ? e.getValue(t).set(i) : e.addValue(t, Ne(i));
}
function Co(e) {
  return Mo(e) ? e[e.length - 1] || 0 : e;
}
function Ao(e, t) {
  let { transitionEnd: i = {}, transition: s = {}, ...r } = So(e, t) || {};
  r = {
    ...r,
    ...i
  };
  for (const n in r) To(e, n, Co(r[n]));
}
...
function Po(e, t) {
  ...
  if (_o(i)) return i.add(t);
  if (!i && xe.WillChange) {
    const s = new xe.WillChange("auto");
...
var Bo = "framerAppearId", ko = "data-" + wi(Bo);
function Eo(e) {
  return e.props[ko];
}
function zo({ protectedKeys: e, needsAnimating: t }, i) {
  const s = e.hasOwnProperty(i) && t[i] !== !0;
  return t[i] = !1, s;
}
function Vo(e, t, { delay: i = 0, transitionOverride: s, type: r } = {}) {
  let { transition: n, transitionEnd: a, ...o } = t;
  const l = e.getDefaultTransition();
  n = n ? rr(n, l) : l;
  const c = n?.reduceMotion, h = n?.skipAnimations;
  s && (n = s);
  const d = [], u = r && e.animationState && e.animationState.getState()[r], y = n?.path;
  y && y.animateVisualElement(e, o, n, i, d);
  for (const p in o) {
    const g = e.getValue(p, e.latestValues[p] ?? null), m = o[p];
    if (m === void 0 || u && zo(u, p)) continue;
    const v = {
      delay: i,
      ...nr(n || {}, p)
    };
    ...
    const _ = g.get();
    if (_ !== void 0 && !g.isAnimating() && !Array.isArray(m) && m === _ && !v.velocity) {
      oe.update(() => g.set(m));
      continue;
    }
    let S = !1;
    ...
    g.start(ar(p, g, m, w && cr.has(p) ? { type: !1 } : v, e, S));
    const A = g.animation;
    A && d.push(A);
  }
  if (a) {
...
function Ro(e) {
  return typeof e == "number" ? e === 0 : e !== null ? e === "none" || e === "0" || vs(e) : !0;
}
...
var No = /\b([a-z-]*)\(.*?\)/gu, Jt = {
  ...
  mask: ei,
  WebkitMask: ei
}, dr = (e) => Uo[e], Lo = /* @__PURE__ */ new Set([Jt, ei]);
function pr(e, t) {
  let i = dr(e);
  return Lo.has(i) || (i = ae), i.getAnimatableNone ? i.getAnimatableNone(t) : void 0;
}
...
function Go(e, t, i) {
  ...
  for (; s < e.length && !r; ) {
    const n = e[s];
    typeof n == "string" && !Wo.has(n) && Ie(n).values.length && (r = e[s]), s++;
  }
  if (r && i) for (const n of t) e[n] = pr(i, r);
}
var $o = class extends bi {
  ...
  readKeyframes() {
    ...
    for (let o = 0; o < e.length; o++) {
      ...
      if (typeof l == "string" && (l = l.trim(), pi(l))) {
        const c = or(l, t.current);
        c !== void 0 && (e[o] = c), o === e.length - 1 && (this.finalKeyframe = l);
      }
    }
    if (this.resolveNoneKeyframes(), !cr.has(i) || e.length !== 2) return;
    ...
    if (n !== a)
      ...
      else ve[i] && (this.needsMeasurement = !0);
  }
  resolveNoneKeyframes() {
    const { unresolvedKeyframes: e, name: t } = this, i = [];
    for (let s = 0; s < e.length; s++) (e[s] === null || Ro(e[s])) && i.push(s);
    i.length && Go(e, i, t);
  }
  measureInitialState() {
    const { element: e, unresolvedKeyframes: t, name: i } = this;
    if (!e || !e.current) return;
    i === "height" && (this.suspendedScrollY = window.pageYOffset), this.measuredOrigin = ve[i](e.measureViewportBox(), window.getComputedStyle(e.current)), t[0] = this.measuredOrigin;
  ...
  measureEndState() {
    ...
    i[r] = ve[t](e.measureViewportBox(), window.getComputedStyle(e.current)), n !== null && this.finalKeyframe === void 0 && (this.finalKeyframe = n), this.removedTransforms?.length && this.removedTransforms.forEach(([a, o]) => {
      e.getValue(a).set(o);
...
var ti = (e, t) => t && typeof e == "number" ? t.transform(e) : e, { schedule: jo, cancel: Ec } = /* @__PURE__ */ Vs(queueMicrotask, !1);
function fr(e) {
  return Fn(e) && "ownerSVGElement" in e;
}
function qo(e) {
  return fr(e) && e.tagName === "svg";
}
var Xo = [
  ...ur,
  O,
  ae
], Yo = (e) => Xo.find(hr(e)), ns = () => ({
  min: 0,
  max: 0
}), Si = () => ({
  x: ns(),
...
function mr(e) {
  return Qo(e.animate) || el.some((t) => Zo(e[t]));
}
function tl(e) {
...
function il(e, t, i) {
  for (const s in t) {
    ...
    else if (H(n)) e.addValue(s, Ne(r, { owner: e }));
    else if (n !== r) if (e.hasValue(s)) {
      const a = e.getValue(s);
      a.liveStyle === !0 ? a.jump(r) : a.hasAnimated || a.set(r);
    } else {
      const a = e.getStaticValue(s);
      e.addValue(s, Ne(a !== void 0 ? a : r, { owner: e }));
    }
  }
  for (const s in i) t[s] === void 0 && e.removeValue(s);
  return t;
}
var ii = { current: null }, gr = { current: !1 }, sl = typeof window < "u";
function rl() {
  if (gr.current = !0, !!sl)
    if (window.matchMedia) {
      const e = window.matchMedia("(prefers-reduced-motion)"), t = () => ii.current = e.matches;
...
var as = [
  ...
  constructor({ parent: e, props: t, presenceContext: i, reducedMotionConfig: s, skipAnimations: r, blockInitialAnimation: n, visualState: a }, o = {}) {
    ...
    this.latestValues = l, this.baseTarget = { ...l }, this.initialValues = t.initial ? { ...l } : {}, this.renderState = c, this.parent = e, this.props = t, this.presenceContext = i, this.depth = e ? e.depth + 1 : 0, this.reducedMotionConfig = s, this.skipAnimationsConfig = r, this.options = o, this.blockInitialAnimation = !!n, this.isControllingVariants = mr(t), this.isVariantNode = tl(t), this.isVariantNode && (this.variantChildren = /* @__PURE__ */ new Set()), this.manuallyAnimateOnMount = !!(e && e.current);
    const { willChange: h, ...d } = this.scrapeMotionValuesFromProps(t, {}, this);
    for (const u in d) {
      const y = d[u];
      l[u] !== void 0 && H(y) && y.set(l[u]);
    }
  }
  mount(e) {
    ...
    this.current = e, at.set(e, this), this.projection && !this.projection.instance && this.projection.mount(e), this.parent && this.isVariantNode && !this.isControllingVariants && (this.removeFromVariantTree = this.parent.addVariantChild(this)), this.values.forEach((t, i) => this.bindToMotionValue(i, t)), this.reducedMotionConfig === "never" ? this.shouldReduceMotion = !1 : this.reducedMotionConfig === "always" ? this.shouldReduceMotion = !0 : (gr.current || rl(), this.shouldReduceMotion = ii.current), process.env.NODE_ENV !== "production" && Ss(this.shouldReduceMotion !== !0, "You have Reduced Motion enabled on your device. Animations may not appear as expected.", "reduced-motion-disabled"), this.shouldSkipAnimations = this.skipAnimationsConfig ?? !1, this.parent?.addChild(this), this.update(this.props, this.presenceContext), this.hasBeenMounted = !0;
  }
  unmount() {
  ...
  bindToMotionValue(e, t) {
    if (this.valueSubscriptions.has(e) && this.valueSubscriptions.get(e)(), t.accelerate && sr.has(e) && this.current instanceof HTMLElement) {
      const { factory: n, keyframes: a, times: o, ease: l, duration: c } = t.accelerate, h = new tr({
  ...
  getValue(e, t) {
    ...
    return i === void 0 && t !== void 0 && (i = Ne(t === null ? void 0 : t, { owner: this }), this.addValue(e, i)), i;
  }
  readValue(e, t) {
    ...
    return i != null && (typeof i == "string" && (ys(i) || vs(i)) ? i = parseFloat(i) : !Yo(i) && ae.test(t) && (i = pr(e, t)), this.setBaseTarget(e, H(i) ? i.get() : i)), H(i) ? i.get() : i;
  }
  setBaseTarget(e, t) {
    this.baseTarget[e] = t;
  }
  getBaseTarget(e) {
    ...
    if (typeof t == "string" || typeof t == "object") {
      const r = lr(this.props, t, this.presenceContext?.custom);
      r && (i = r[e]);
    }
  ...
  on(e, t) {
    return this.events[e] || (this.events[e] = new xs()), this.events[e].add(t);
  }
  notify(e, ...t) {
...
function nl({ top: e, left: t, right: i, bottom: s }) {
  return {
    x: {
      min: t,
      max: i
...
function ol(e, t) {
  return nl(al(e.getBoundingClientRect(), t));
}
var ll = {
  x: "translateX",
  y: "translateY",
...
function hl(e, t, i) {
  ...
  return n && (r = !1, s += `rotate(${ti(n, Tt.pathRotation)}) `), s = s.trim(), i ? s = i(t, r ? "" : s) : r && (s = "none"), s;
}
function br(e, t, i) {
  ...
  if (t.transform || (a || i ? s.transform = hl(t, e.transform, i) : s.transform && (s.transform = "none")), o) {
    const { originX: l = "50%", originY: c = "50%", originZ: h = 0 } = n;
    s.transformOrigin = `${l} ${c} ${h}`;
  }
}
function xr(e, { style: t, vars: i }, s, r) {
  const n = e.style;
  let a;
  for (a in t) n[a] = t[a];
...
} }, ul = { correct: (e, { treeScale: t, projectionDelta: i }) => {
...
function pl(e, { layout: t, layoutId: i }) {
  return Ke.has(e) || e.startsWith("origin") || (t || i !== void 0) && (!!dl[e] || e === "opacity");
}
function wr(e, t, i) {
  const s = e.style, r = t?.style, n = {};
  if (!s) return n;
  for (const a in s) (H(s[a]) || r && H(r[a]) || pl(a, e) || i?.getValue(a)?.liveStyle !== void 0) && (n[a] = s[a]);
  return n;
}
function fl(e) {
  return window.getComputedStyle(e);
}
var ml = class extends vr {
  constructor() {
  ...
  readValueFromInstance(e, t) {
    if (Ke.has(t)) return this.projection?.isProjecting ? jt(t) : Na(e, t);
    {
      const i = fl(e), s = (Rs(t) ? i.getPropertyValue(t) : i[t]) || 0;
...
function Sl(e, { attrX: t, attrY: i, attrScale: s, pathLength: r, pathSpacing: n = 1, pathOffset: a = 0, ...o }, l, c, h) {
  if (br(e, o, c), l) {
  ...
  for (const y of wl) d[y] !== void 0 && (u[y] = d[y], delete d[y]);
  t !== void 0 && (d.x = t), i !== void 0 && (d.y = i), s !== void 0 && (d.scale = s), r !== void 0 && xl(d, r, n, a, !1);
}
var Sr = /* @__PURE__ */ new Set([
  "baseFrequency",
  "diffuseConstant",
...
function Tl(e, t, i, s) {
  xr(e, t, void 0, s);
  for (const r in t.attrs) e.setAttribute(Sr.has(r) ? r : wi(r), t.attrs[r]);
}
function Cl(e, t, i) {
  const s = wr(e, t, i);
  for (const r in e) if (H(e[r]) || H(t[r])) {
    const n = $e.indexOf(r) !== -1 ? "attr" + r.charAt(0).toUpperCase() + r.substring(1) : r;
    s[n] = e[r];
  }
  return s;
}
var Al = class extends vr {
  constructor() {
  ...
  readValueFromInstance(e, t) {
    ...
    return t = Sr.has(t) ? t : wi(t), e.getAttribute(t);
  }
  scrapeMotionValuesFromProps(e, t, i) {
    return Cl(e, t, i);
  }
  build(e, t, i) {
    Sl(e, t, this.isSVGTag, i.transformTemplate, i.style);
  }
...
function _l(e, t, i) {
  const s = H(e) ? e : Ne(e);
  return s.start(ar("", s, t, i)), s.animation;
}
function Mi(e) {
  return typeof e == "object" && !Array.isArray(e);
}
function Mr(e, t, i, s) {
  return e == null ? [] : typeof e == "string" && Mi(t) ? Ho(e, i, s) : e instanceof NodeList ? Array.from(e) : Array.isArray(e) ? e.filter((r) => r != null) : [e];
}
function Pl(e, t, i) {
  return e * (t + 1) + i * t;
}
...
function kl(e, t, i, s, r, n) {
  Bl(e, r, n);
  for (let a = 0; a < t.length; a++) e.push({
    value: t[a],
    at: Ge(r, n, s[a]),
    easing: /* @__PURE__ */ Es(i, a)
  });
}
function El(e, t, i = 0) {
  const s = t + 1 + t * i;
...
var Vl = "easeInOut", zt = 20;
function Dl(e, { defaultTransition: t = {}, ...i } = {}, s, r) {
  ...
  for (let y = 0; y < e.length; y++) {
    ...
    let _ = 0;
    const S = (w, A, b, x = 0, C = 0) => {
      const M = Rl(w), { delay: B = 0, times: T = js(M), type: V = t.type || "keyframes", repeat: z, repeatType: D, repeatDelay: L = 0, ...E } = A;
      let { ease: W = t.ease || "easeOut", duration: R } = A;
      const j = typeof B == "function" ? B(x, C) : B, q = M.length, X = xi(V) ? V : r?.[V || "keyframes"];
      if (q <= 2 && X) {
        let te = 100;
        if (q === 2 && Nl(M)) {
          const Se = M[1] - M[0];
        ...
        const re = $s(ie, te, X);
        W = re.ease, R = re.duration;
      }
      R ?? (R = n);
      const Pe = d + j;
      T.length === 1 && T[0] === 0 && (T[1] = 1);
      const we = T.length - M.length;
      if (we > 0 && Hs(T, we), M.length === 1 && M.unshift(null), z && Ue(z < zt, `Sequence segments can't repeat ${z} times — ignoring repeat option. Use a value below ${zt} or apply repeat at the sequence level instead.`), z && z < zt) {
        const te = R > 0 ? L / R : 0;
        R = Pl(R, z, L);
        const ie = [...M], re = [...T];
        W = Array.isArray(W) ? [...W] : [W];
        const Se = [...W], ht = D === "reverse" || D === "mirror";
        let ut = ie, le = Se;
        ht && (ut = [...ie].reverse(), D === "reverse" && (le = [...Se].reverse().map((ge) => typeof ge == "function" ? hi(ge) : ge)));
        for (let ge = 0; ge < z; ge++) {
          const Ci = ht && ge % 2 === 0, Ai = Ci ? ut : ie, Ar = Ci ? le : Se, _i = (ge + 1) * (1 + te);
          te > 0 && (M.push(M[M.length - 1]), T.push(_i), W.push("linear")), M.push(...Ai);
          for (let He = 0; He < Ai.length; He++)
            T.push(re[He] + _i), W.push(He === 0 ? "linear" : /* @__PURE__ */ Es(Ar, He - 1));
        }
        El(T, z, te);
      }
      const me = Pe + R;
      kl(b, M, W, T, Pe, me), _ = Math.max(j + R, _), u = Math.max(me, u);
    };
    if (H(g)) {
      const w = hs(g, o);
      S(m, v, us("default", w));
    } else {
      const w = Mr(g, m, s, l), A = w.length;
      for (let b = 0; b < A; b++) {
        m = m, v = v;
        const x = w[b], C = hs(x, o);
        for (const M in m) S(m[M], Fl(v, M), us(M, C), b, A);
      }
    }
    h = d, d += _;
  }
  return o.forEach((y, p) => {
    for (const g in y) {
      ...
      for (let x = 0; x < m.length; x++) {
        const { at: C, value: M, easing: B } = m[x];
        v.push(M), _.push(ci(0, u, C)), S.push(B || "easeOut");
      }
      _[0] !== 0 && (_.unshift(0), v.unshift(v[0]), S.unshift(Vl)), _[_.length - 1] !== 1 && (_.push(1), v.push(null)), a.has(p) || a.set(p, {
        keyframes: {},
        transition: {}
      });
      const w = a.get(p);
...
var Il = (e) => typeof e == "number", Nl = (e) => e.every(Il);
function Ol(e) {
  const t = {
  ...
  }, i = fr(e) && !qo(e) ? new Al(t) : new ml(t);
  i.mount(e), at.set(e, i);
}
function Ul(e) {
  const t = new yl({
    presenceContext: null,
...
function Tr(e, t, i, s) {
  const r = [];
  if (Ll(e, t)) r.push(_l(e, Mi(t) && t.default || t, i && (i.default || i)));
  else {
    if (e == null) return r;
    const n = Mr(e, t, s), a = n.length;
    de(!!a, "No valid elements provided.", "no-valid-elements");
    for (let o = 0; o < a; o++) {
      const l = n[o], c = l instanceof Element ? Ol : Ul;
      at.has(l) || c(l);
      const h = at.get(l), d = { ...i };
      "delay" in d && typeof d.delay == "function" && (d.delay = d.delay(o, a)), r.push(...Vo(h, {
        ...t,
        transition: d
      }, {}));
    }
...
function Wl(e, t, i) {
  ...
  return Dl(e.map((r) => {
    ...
    return r;
  }), t, i, { spring: nt }).forEach(({ keyframes: r, transition: n }, a) => {
    s.push(...Tr(a, r, n));
  }), s;
}
function Gl(e) {
...
function $l(e = {}) {
  ...
  function r(n, a, o) {
    let l = [], c;
    const h = {};
    if (i !== void 0 && (h.reduceMotion = i), s !== void 0 && (h.skipAnimations = s), Gl(n)) {
      const { onComplete: u, ...y } = a || {};
      typeof u == "function" && (c = u), l = Wl(n, {
        ...h,
        ...y
      }, t);
    } else {
      const { onComplete: u, ...y } = o || {};
      typeof u == "function" && (c = u), l = Tr(n, a, {
        ...h,
        ...y
      }, t);
    }
...
var Kl = $l(), zc = class {
  ...
  sceneObstacles = [];
  constructor(e = {}) {
    this.config = e, this.save = new En(e.gameId || "default"), this.scenes = new zn(this), this.cutscene = new Dn(this), this.videoTimeline = new Fi(this), this.debugRenderer = new kn(this), this.engine = new Xr(), this.world = new Zr(), this.physics = new Jr(), this.physics.gravity = e.gravity ? new k(...e.gravity) : new k(0, -9.81, 0), this.scene = new f.Scene();
    ...
    this.cameraController = new sn(this.camera), this.pipeline = new yn(this.renderer, this.scene, this.camera), e.shadows !== !1 && this.pipeline.setupLighting({}), window.addEventListener("resize", () => {
  ...
  createEntity(e) {
    return this.world.createEntity(e);
  }
  createSharedContext(e, t) {
    return this.world.createSharedContext(e, t);
  }
  createEntityWithSharedContext(e, t) {
    return this.world.createEntityWithSharedContext(e, t);
  }
  query(e) {
  ...
  createBox(e) {
    ...
    if (i.position.set(...e.position ?? [
      ...
      const s = new ft();
      s.type = e.physics === "static" ? $.Static : $.Dynamic, s.mass = e.mass ?? (e.physics === "static" ? 0 : 1);
      const r = new Qe();
  ...
  attachPhysics(e, t = {}) {
    const i = new ft();
    i.type = t.type === "static" ? $.Static : $.Dynamic, i.mass = t.mass ?? (i.type === $.Dynamic ? 1 : 0);
  ...
  createBlock2D(e) {
    ...
    if (e.billboard && r.push(this.engine.events.on("update", () => {
      ...
      const n = new ft();
      n.type = e.physics === "static" ? $.Static : $.Dynamic, n.mass = e.mass ?? (e.physics === "static" ? 0 : 1), e.fixedRotation && (n.fixedRotation = !0), e.lockZAxis && (n.lockLinearAxis = [
        !1,
        !1,
        !0
      ], n.lockAngularAxis = [
  ...
  createText3D(e) {
    ...
    n.fillText(t, d, u);
    const y = new f.CanvasTexture(r);
    y.minFilter = f.LinearFilter, y.colorSpace = f.SRGBColorSpace;
    const p = new f.MeshBasicMaterial({
      map: y,
      transparent: !0,
      side: f.DoubleSide
    }), g = r.width / r.height, m = e.size ?? 1, v = m * g, _ = m, S = new f.Mesh(new f.PlaneGeometry(v, _), p);
    S.position.set(...e.position ?? [
      0,
      0,
      0
    ...
    return e.billboard && (w = this.engine.events.on("update", () => {
      ...
      setText: (A) => {
        ...
        const b = n.measureText(A), x = Math.ceil(b.width) + 20;
        let C = !1;
        x > r.width && (r.width = x, C = !0), n.font = i, n.fillStyle = s, n.textAlign = e.align || "center", n.textBaseline = "middle";
        const M = n.textAlign === "center" ? r.width / 2 : n.textAlign === "right" ? r.width - 10 : 10;
        if (n.fillText(A, M, r.height / 2), y.needsUpdate = !0, C) {
          const B = r.width / r.height;
          S.geometry.dispose(), S.geometry = new f.PlaneGeometry(m * B, m);
        }
      },
      dispose: () => {
        w && w(), this.scene.remove(S), S.geometry.dispose(), p.dispose(), y.dispose();
      }
    };
  }
  captureScreenshot(e) {
  ...
  getMemoryMapDump() {
    ...
    const n = typeof performance < "u" ? performance.memory : null, a = n ? n.usedJSHeapSize : 0, o = n ? n.totalJSHeapSize : 0, l = n ? n.jsHeapSizeLimit : 0, c = e.memory.geometries * 45e3, h = e.memory.textures * 1024 * 1024, d = c + h, u = this.getCpuProfileMap(), y = [
      {
  ...
  noise2D(e, t) {
    ...
    let u, y;
    h > d ? (u = 1, y = 0) : (u = 0, y = 1);
    const p = h - u + s, g = d - y + s, m = h - 1 + 2 * s, v = d - 1 + 2 * s, _ = n & 255, S = a & 255, w = this.permMod12[_ + this.perm[S]], A = this.permMod12[_ + u + this.perm[S + y]], b = this.permMod12[_ + 1 + this.perm[S + 1]];
    let x = 0.5 - h * h - d * d, C = 0;
    x >= 0 && (x *= x, C = x * x * this.dot(Vt[w], h, d));
    let M = 0.5 - p * p - g * g, B = 0;
    M >= 0 && (M *= M, B = M * M * this.dot(Vt[A], p, g));
    let T = 0.5 - m * m - v * v, V = 0;
    return T >= 0 && (T *= T, V = T * T * this.dot(Vt[b], m, v)), 70 * (C + B + V);
  }
}, Vt = [
  [
    1,
  ...
  constructor(e, t, i = 0.45, s) {
    this.width = e, this.height = t, this.map = [], this.prng = new ct(s ?? Date.now());
    for (let r = 0; r < e; r++) {
      this.map[r] = [];
  ...
  findPathAStarInternal(e, t, i, s) {
    ...
    const u = (p) => {
      if (i === 0) return 0;
      const g = Math.abs(p.x - a.x), m = Math.abs(p.z - a.z);
      return s ? (Math.max(g, m) + (Math.SQRT2 - 1) * Math.min(g, m)) * i : (g + m) * i;
    }, y = (p) => (o.get(p) ?? 1 / 0) + u(p);
    for (; c.length > 0; ) {
      c.sort((m, v) => y(m) - y(v));
      const p = c.shift();
      ...
      d.add(p);
      const g = this.getNeighbors(p, s);
      for (const { node: m, moveCost: v } of g) {
        if (!m.walkable || d.has(m)) continue;
        const _ = (o.get(p) ?? 0) + v;
        _ < (o.get(m) ?? 1 / 0) && (o.set(m, _), l.set(m, p), h.has(m) || (c.push(m), h.add(m)));
      }
    }
    return [e, t];
  }
  findPathBidirectionalInternal(e, t, i, s) {
    ...
    if (!n.walkable || !a.walkable) return [e, t];
    if (n === a) return [this.nodeToVector3(n)];
    const o = /* @__PURE__ */ new Map(), l = /* @__PURE__ */ new Map(), c = [n], h = /* @__PURE__ */ new Set([n]), d = /* @__PURE__ */ new Set(), u = /* @__PURE__ */ new Map(), y = /* @__PURE__ */ new Map(), p = [a], g = /* @__PURE__ */ new Set([a]), m = /* @__PURE__ */ new Set();
    o.set(n, 0), l.set(n, null), u.set(a, 0), y.set(a, null);
    const v = (x) => {
      if (i === 0) return 0;
      const C = Math.abs(x.x - a.x), M = Math.abs(x.z - a.z);
      return s ? (Math.max(C, M) + (Math.SQRT2 - 1) * Math.min(C, M)) * i : (C + M) * i;
    }, _ = (x) => {
      if (i === 0) return 0;
      const C = Math.abs(x.x - n.x), M = Math.abs(x.z - n.z);
      return s ? (Math.max(C, M) + (Math.SQRT2 - 1) * Math.min(C, M)) * i : (C + M) * i;
    }, S = (x) => (o.get(x) ?? 1 / 0) + v(x), w = (x) => (u.get(x) ?? 1 / 0) + _(x);
    let A = 1 / 0, b = null;
    for (; c.length > 0 && p.length > 0; ) {
      c.sort((T, V) => S(T) - S(V));
      const x = c.shift();
      if (h.delete(x), d.add(x), m.has(x)) {
        const T = (o.get(x) ?? 0) + (u.get(x) ?? 0);
        if (T < A) {
          A = T, b = x;
          break;
        }
      }
      const C = this.getNeighbors(x, s);
      for (const { node: T, moveCost: V } of C) {
        if (!T.walkable || d.has(T)) continue;
        const z = (o.get(x) ?? 0) + V;
        if (z < (o.get(T) ?? 1 / 0) && (o.set(T, z), l.set(T, x), h.has(T) || (c.push(T), h.add(T)), u.has(T))) {
          const D = z + u.get(T);
          D < A && (A = D, b = T);
        }
      }
      p.sort((T, V) => w(T) - w(V));
      const M = p.shift();
      if (g.delete(M), m.add(M), d.has(M)) {
        const T = (o.get(M) ?? 0) + (u.get(M) ?? 0);
        if (T < A) {
          A = T, b = M;
          break;
        }
      ...
      for (const { node: T, moveCost: V } of B) {
        if (!T.walkable || m.has(T)) continue;
        const z = (u.get(M) ?? 0) + V;
        if (z < (u.get(T) ?? 1 / 0) && (u.set(T, z), y.set(T, M), g.has(T) || (p.push(T), g.add(T)), o.has(T))) {
          const D = z + o.get(T);
          D < A && (A = D, b = T);
        }
      }
      if (b && c.length > 0 && p.length > 0 && S(c[0]) + w(p[0]) >= A)
        break;
    }
    return b ? this.reconstructBidirectionalPath(b, l, y) : [e, t];
  }
  ...
  samplePosition(e) {
    if (this.positionKeys.length === 0) return new k(0, 0, 0);
    e = bt.clamp(e % this.duration, 0, this.duration);
    for (let t = 0; t < this.positionKeys.length - 1; t++) {
      const i = this.positionKeys[t], s = this.positionKeys[t + 1];
      if (e >= i.time && e <= s.time) {
        const r = (e - i.time) / (s.time - i.time);
        return i.value.clone().lerp(s.value, r);
      }
    }
    return this.positionKeys[this.positionKeys.length - 1].value.clone();
  }
  sampleRotation(e) {
    if (this.rotationKeys.length === 0) return new si(0, 0, 0, 1);
    e = bt.clamp(e % this.duration, 0, this.duration);
    for (let t = 0; t < this.rotationKeys.length - 1; t++) {
      const i = this.rotationKeys[t], s = this.rotationKeys[t + 1];
      if (e >= i.time && e <= s.time) {
        const r = (e - i.time) / (s.time - i.time);
        return i.value.clone().slerp(s.value, r);
      }
    }
  ...
  evaluate(e, t) {
    ...
    for (let s = 0; s < this.clips.length - 1; s++) {
      const r = this.clips[s], n = this.clips[s + 1];
      if (e >= r.threshold && e <= n.threshold) {
        const a = (e - r.threshold) / (n.threshold - r.threshold), o = r.clip.samplePosition(t), l = n.clip.samplePosition(t), c = r.clip.sampleRotation(t), h = n.clip.sampleRotation(t);
        return {
          position: o.lerp(l, a),
          rotation: c.slerp(h, a)
        };
      }
    }
    const i = this.clips[this.clips.length - 1];
    return {
      position: i.clip.samplePosition(t),
      rotation: i.clip.sampleRotation(t)
    };
  }
}, Wc = class {
  mixer;
  ...
  static solveTwoBone(e, t, i, s, r) {
    const n = i.clone().sub(e), a = bt.clamp(n.length(), 1e-3, s + r - 1e-3), o = (s * s + a * a - r * r) / (2 * s * a), l = Math.acos(bt.clamp(o, -1, 1)), c = new k(0, 1, 0), h = n.clone().normalize();
    let d = h.cross(c).cross(h).normalize();
    return d.lengthSq() < 1e-6 && (d = h.clone().cross(new k(1, 0, 0)), d.lengthSq() < 1e-6 && (d = h.clone().cross(new k(0, 0, 1))), d.normalize()), {
      jointPos: e.clone().add(h.clone().scale(Math.cos(l) * s)).add(d.clone().scale(Math.sin(l) * s)),
      endPos: i.clone()
    };
  }
}, ql = class {
...
export {
  Nc as ActionNode,
  Uc as AnimationClip,
  Wc as AnimationStateMachine,
  wn as AudioManager,
  Ti as BTNode,
  Lc as BlendTree1D,
  fs as BoundingBox,
  sn as CameraController,
  Vc as CellularAutomata,
  Mn as CinematicOverlayManager,
  Qe as Collider,
  K as ColliderType,
  F as Color,
  Ee as CustomShaderMaterial,
  et as CutsceneAbortError,
  Vn as CutsceneContext,
  Dn as CutsceneManager,
  _n as DebugInspector,
  kn as DebugRenderer,
  Tn as DefaultTheme,
  Rc as EasyScript,
  Xr as Engine,
  Bc as EngineCompiler,
  ye as EngineState,
  jc as EventActionDispatcher,
  Xl as EventBus,
  ri as EventEmitter,
  Kc as EventPriority,
  sc as FastSoAWorld,
  pc as FrustumCulling,
  Sn as GlobalAudio,
  je as GlobalCinematicOverlay,
  Pn as GlobalDebugInspector,
  Zl as GlobalEventBus,
  Cr as GlobalEvents,
  xn as GlobalInput,
  An as GlobalUI,
  bn as InputManager,
  Gc as InverseKinematicsSolver,
  zc as KairoApp,
  Hc as KeyEventTrigger,
  hc as Light,
  Vi as LightType,
  lc as Material,
  bt as MathUtils,
  ...
  Jl as ObjectPool,
  ct as PRNG,
  dc as ParticleSystem,
  Oc as PathfindingGrid,
  Jr as PhysicsWorld,
  gn as PostProcessManager,
  si as Quaternion,
  ic as Query,
  Ei as Ray,
  nc as RaycastVehicle,
  yn as RenderPipeline,
  oc as RenderQueue,
  ft as RigidBody,
  $ as RigidBodyType,
  ac as SHADER_PRESETS,
  En as SaveSystem,
  qr as Scene,
  zn as SceneManager,
  zi as SceneNode,
  Bn as ScreenRecorder,
  jl as ScriptBehavior,
  Dc as ScriptRunner,
  Ic as SelectorNode,
  Fc as SequenceNode,
  Fe as Serializer,
  cc as ShaderGraphCompiler,
  tn as ShaderPresets,
  Yr as SharedEntityContext,
  Qr as SharedEntityContextManager,
  Hl as SimplexNoise,
  uc as SkyboxSettings,
  rc as SpatialHashGrid3D,
  $c as StickmanAnimator,
  ql as StickmanPose,
  tc as System,
  ec as SystemStage,
  Be as Time,
  ...
  _c as createCloud,
  vc as createCone,
  yc as createCylinder,
  Sc as createDodecahedron,
  Tc as createGrassField,
  wc as createIcosahedron,
  gc as createPlane,
  Ac as createRock,
  mc as createSphere,
  Mc as createTerrain,
